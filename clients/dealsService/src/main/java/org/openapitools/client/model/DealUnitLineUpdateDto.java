 ...
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-05-30T19:48:01.323180500-05:00[America/Bogota]", comments = "Generator version: 7.9.0")
public class DealUnitLineUpdateDto {
  ...
  public DealUnitLineUpdateDto() {
  }

  public DealUnitLineUpdateDto closed(Boolean closed) {
    this.closed = closed;
    return this;
  }
  ...
  public DealUnitLineUpdateDto title(String title) {
    this.title = title;
    return this;
  }
  ...
  public DealUnitLineUpdateDto userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public DealUnitLineUpdateDto priceListId(String priceListId) {
  ...
  public DealUnitLineUpdateDto description(String description) {
  ...
  public DealUnitLineUpdateDto individualId(String individualId) {
  ...
  public DealUnitLineUpdateDto paymentTermId(String paymentTermId) {
  ...
  public DealUnitLineUpdateDto organizationId(String organizationId) {
  ...
  public DealUnitLineUpdateDto receiverTenantId(String receiverTenantId) {
  ...
  public DealUnitLineUpdateDto firstName(String firstName) {
  ...
  public DealUnitLineUpdateDto lastName(String lastName) {
  ...
  public DealUnitLineUpdateDto companyName(String companyName) {
  ...
  public DealUnitLineUpdateDto billingEmail(String billingEmail) {
  ...
  public DealUnitLineUpdateDto addressLine1(String addressLine1) {
  ...
  public DealUnitLineUpdateDto addressLine2(String addressLine2) {
  ...
  public DealUnitLineUpdateDto postalCode(String postalCode) {
  ...
  public DealUnitLineUpdateDto countryId(String countryId) {
  ...
  public DealUnitLineUpdateDto stateId(String stateId) {
  ...
  public DealUnitLineUpdateDto cityId(String cityId) {
    this.cityId = cityId;
    return this;
  }
  ...
  public DealUnitLineUpdateDto billingLocationId(String billingLocationId) {
  ...
  public DealUnitLineUpdateDto shippingLocationId(String shippingLocationId) {
  ...
  public DealUnitLineUpdateDto shippingMethodId(String shippingMethodId) {
  ...
  public DealUnitLineUpdateDto forexRate(Double forexRate) {
  ...
  public DealUnitLineUpdateDto currencyId(String currencyId) {
  ...
  public DealUnitLineUpdateDto totalDetail(Double totalDetail) {
  ...
  public DealUnitLineUpdateDto totalDetailCurrencyId(String totalDetailCurrencyId) {
  ...
  public DealUnitLineUpdateDto totalProfit(Double totalProfit) {
  ...
  public DealUnitLineUpdateDto totalProfitCurrencyId(String totalProfitCurrencyId) {
  ...
  public DealUnitLineUpdateDto totalDiscounts(Double totalDiscounts) {
  ...
  public DealUnitLineUpdateDto totalDiscountsCurrencyId(String totalDiscountsCurrencyId) {
  ...
  public DealUnitLineUpdateDto totalSurcharges(Double totalSurcharges) {
  ...
  public DealUnitLineUpdateDto totalSurchargesCurrencyId(String totalSurchargesCurrencyId) {
  ...
  public DealUnitLineUpdateDto totalShippingTax(Double totalShippingTax) {
  ...
  public DealUnitLineUpdateDto totalShippingTaxCurrencyId(String totalShippingTaxCurrencyId) {
  ...
  public DealUnitLineUpdateDto totalShippingCost(Double totalShippingCost) {
  ...
  public DealUnitLineUpdateDto totalShippingCostCurrencyId(String totalShippingCostCurrencyId) {
  ...
  public DealUnitLineUpdateDto totalGlobalDiscounts(Double totalGlobalDiscounts) {
  ...
  public DealUnitLineUpdateDto totalGlobalDiscountsCurrencyId(String totalGlobalDiscountsCurrencyId) {
  ...
  public DealUnitLineUpdateDto totalGlobalSurcharges(Double totalGlobalSurcharges) {
  ...
  public DealUnitLineUpdateDto totalGlobalSurchargesCurrencyId(String totalGlobalSurchargesCurrencyId) {
  ...
  public DealUnitLineUpdateDto totalWithheldTax(Double totalWithheldTax) {
  ...
  public DealUnitLineUpdateDto totalWithheldTaxCurrencyId(String totalWithheldTaxCurrencyId) {
  ...
  public DealUnitLineUpdateDto totalTaxBase(Double totalTaxBase) {
  ...
  public DealUnitLineUpdateDto totalTaxBaseCurrencyId(String totalTaxBaseCurrencyId) {
  ...
  public DealUnitLineUpdateDto totalTaxes(Double totalTaxes) {
  ...
  public DealUnitLineUpdateDto totalTaxesCurrencyId(String totalTaxesCurrencyId) {
  ...
  public DealUnitLineUpdateDto total(Double total) {
    this.total = total;
    return this;
  }
  ...
  public DealUnitLineUpdateDto totalCurrencyId(String totalCurrencyId) {
  ...
  public DealUnitLineUpdateDto costCalculationMethod(CostCalculationMethodEnum costCalculationMethod) {
  ...
  public DealUnitLineUpdateDto taxCalculationMethod(TaxCalculationMethodEnum taxCalculationMethod) {
  ...
  public DealUnitLineUpdateDto itemId(String itemId) {
    this.itemId = itemId;
    return this;
  }
  ...
  public DealUnitLineUpdateDto itemTitle(String itemTitle) {
  ...
  public DealUnitLineUpdateDto itemShortDescription(String itemShortDescription) {
  ...
  public DealUnitLineUpdateDto itemPrimaryImageUrl(String itemPrimaryImageUrl) {
  ...
  public DealUnitLineUpdateDto shippingPolicyId(String shippingPolicyId) {
  ...
  public DealUnitLineUpdateDto quantity(Double quantity) {
  ...
  public DealUnitLineUpdateDto free(Boolean free) {
    this.free = free;
    return this;
  }
  ...
  public DealUnitLineUpdateDto freeReason(String freeReason) {
  ...
  public DealUnitLineUpdateDto freeReasonCode(String freeReasonCode) {
  ...
  public DealUnitLineUpdateDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public DealUnitLineUpdateDto dataLabel(String dataLabel) {
  ...
  public DealUnitLineUpdateDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public DealUnitLineUpdateDto data1Label(String data1Label) {
  ...
  public DealUnitLineUpdateDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public DealUnitLineUpdateDto data2Label(String data2Label) {
  ...
  public DealUnitLineUpdateDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public DealUnitLineUpdateDto data3Label(String data3Label) {
  ...
  public DealUnitLineUpdateDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public DealUnitLineUpdateDto data4Label(String data4Label) {
  ...
  public DealUnitLineUpdateDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public DealUnitLineUpdateDto data5Label(String data5Label) {
  ...
  public DealUnitLineUpdateDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public DealUnitLineUpdateDto data6Label(String data6Label) {
  ...
  public DealUnitLineUpdateDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public DealUnitLineUpdateDto data7Label(String data7Label) {
  ...
  public DealUnitLineUpdateDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public DealUnitLineUpdateDto data8Label(String data8Label) {
  ...
  public DealUnitLineUpdateDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public DealUnitLineUpdateDto data9Label(String data9Label) {
  ...
  public DealUnitLineUpdateDto itemPriceId(String itemPriceId) {
  ...
  public DealUnitLineUpdateDto priceListItemId(String priceListItemId) {
  ...
  public DealUnitLineUpdateDto unitId(String unitId) {
    this.unitId = unitId;
    return this;
  }
  ...
  public DealUnitLineUpdateDto unitGroupId(String unitGroupId) {
  ...
  public DealUnitLineUpdateDto forexRatesSnapshot(String forexRatesSnapshot) {
  ...
  public DealUnitLineUpdateDto totalBaseAmountInUsd(Double totalBaseAmountInUsd) {
  ...
  public DealUnitLineUpdateDto totalProfitInUsd(Double totalProfitInUsd) {
  ...
  public DealUnitLineUpdateDto totalDetailAmountInUsd(Double totalDetailAmountInUsd) {
  ...
  public DealUnitLineUpdateDto totalTaxBaseInUsd(Double totalTaxBaseInUsd) {
  ...
  public DealUnitLineUpdateDto totalDiscountsInUsd(Double totalDiscountsInUsd) {
  ...
  public DealUnitLineUpdateDto totalTaxesInUsd(Double totalTaxesInUsd) {
  ...
  public DealUnitLineUpdateDto totalWithheldTaxesInUsd(Double totalWithheldTaxesInUsd) {
  ...
  public DealUnitLineUpdateDto totalShippingCostInUsd(Double totalShippingCostInUsd) {
  ...
  public DealUnitLineUpdateDto totalShippingTaxesInUsd(Double totalShippingTaxesInUsd) {
  ...
  public DealUnitLineUpdateDto totalWarrantyCostInUsd(Double totalWarrantyCostInUsd) {
  ...
  public DealUnitLineUpdateDto totalReturnCostInUsd(Double totalReturnCostInUsd) {
  ...
  public DealUnitLineUpdateDto totalRefundCostInUsd(Double totalRefundCostInUsd) {
  ...
  public DealUnitLineUpdateDto totalSurchargesInUsd(Double totalSurchargesInUsd) {
  ...
  public DealUnitLineUpdateDto totalAmountInUsd(Double totalAmountInUsd) {
  ...
  public DealUnitLineUpdateDto totalGlobalDiscountsInUsd(Double totalGlobalDiscountsInUsd) {
  ...
  public DealUnitLineUpdateDto totalGlobalSurchargesInUsd(Double totalGlobalSurchargesInUsd) {
  ...
  public DealUnitLineUpdateDto customGlobalSurchargesAmount(Double customGlobalSurchargesAmount) {
  ...
  public DealUnitLineUpdateDto customGlobalSurchargesAmountCurrencyId(String customGlobalSurchargesAmountCurrencyId) {
  ...
  public DealUnitLineUpdateDto customGlobalDiscountsAmount(Double customGlobalDiscountsAmount) {
  ...
  public DealUnitLineUpdateDto customGlobalDiscountsAmountCurrencyId(String customGlobalDiscountsAmountCurrencyId) {
  ...
  public DealUnitLineUpdateDto returnPolicyId(String returnPolicyId) {
  ...
  public DealUnitLineUpdateDto refundPolicyId(String refundPolicyId) {
  ...
  public DealUnitLineUpdateDto warrantyPolicyId(String warrantyPolicyId) {
  ...
  public DealUnitLineUpdateDto shipmentPolicyId(String shipmentPolicyId) {
  ...
  public DealUnitLineUpdateDto locationId(String locationId) {
  ...
  public DealUnitLineUpdateDto quoteItemRecordId(String quoteItemRecordId) {
  ...
  public DealUnitLineUpdateDto parentBillingItemRecordId(String parentBillingItemRecordId) {
  ...
  public boolean equals(Object o) {
    ...
    DealUnitLineUpdateDto dealUnitLineUpdateDto = (DealUnitLineUpdateDto) o;
    return Objects.equals(this.closed, dealUnitLineUpdateDto.closed) &&
        Objects.equals(this.title, dealUnitLineUpdateDto.title) &&
        Objects.equals(this.userId, dealUnitLineUpdateDto.userId) &&
        Objects.equals(this.priceListId, dealUnitLineUpdateDto.priceListId) &&
        Objects.equals(this.description, dealUnitLineUpdateDto.description) &&
        Objects.equals(this.individualId, dealUnitLineUpdateDto.individualId) &&
        Objects.equals(this.paymentTermId, dealUnitLineUpdateDto.paymentTermId) &&
        Objects.equals(this.organizationId, dealUnitLineUpdateDto.organizationId) &&
        Objects.equals(this.receiverTenantId, dealUnitLineUpdateDto.receiverTenantId) &&
        Objects.equals(this.firstName, dealUnitLineUpdateDto.firstName) &&
        Objects.equals(this.lastName, dealUnitLineUpdateDto.lastName) &&
        Objects.equals(this.companyName, dealUnitLineUpdateDto.companyName) &&
        Objects.equals(this.billingEmail, dealUnitLineUpdateDto.billingEmail) &&
        Objects.equals(this.addressLine1, dealUnitLineUpdateDto.addressLine1) &&
        Objects.equals(this.addressLine2, dealUnitLineUpdateDto.addressLine2) &&
        Objects.equals(this.postalCode, dealUnitLineUpdateDto.postalCode) &&
        Objects.equals(this.countryId, dealUnitLineUpdateDto.countryId) &&
        Objects.equals(this.stateId, dealUnitLineUpdateDto.stateId) &&
        Objects.equals(this.cityId, dealUnitLineUpdateDto.cityId) &&
        Objects.equals(this.billingLocationId, dealUnitLineUpdateDto.billingLocationId) &&
        Objects.equals(this.shippingLocationId, dealUnitLineUpdateDto.shippingLocationId) &&
        Objects.equals(this.shippingMethodId, dealUnitLineUpdateDto.shippingMethodId) &&
        Objects.equals(this.forexRate, dealUnitLineUpdateDto.forexRate) &&
        Objects.equals(this.currencyId, dealUnitLineUpdateDto.currencyId) &&
        Objects.equals(this.totalDetail, dealUnitLineUpdateDto.totalDetail) &&
        Objects.equals(this.totalDetailCurrencyId, dealUnitLineUpdateDto.totalDetailCurrencyId) &&
        Objects.equals(this.totalProfit, dealUnitLineUpdateDto.totalProfit) &&
        Objects.equals(this.totalProfitCurrencyId, dealUnitLineUpdateDto.totalProfitCurrencyId) &&
        Objects.equals(this.totalDiscounts, dealUnitLineUpdateDto.totalDiscounts) &&
        Objects.equals(this.totalDiscountsCurrencyId, dealUnitLineUpdateDto.totalDiscountsCurrencyId) &&
        Objects.equals(this.totalSurcharges, dealUnitLineUpdateDto.totalSurcharges) &&
        Objects.equals(this.totalSurchargesCurrencyId, dealUnitLineUpdateDto.totalSurchargesCurrencyId) &&
        Objects.equals(this.totalShippingTax, dealUnitLineUpdateDto.totalShippingTax) &&
        Objects.equals(this.totalShippingTaxCurrencyId, dealUnitLineUpdateDto.totalShippingTaxCurrencyId) &&
        Objects.equals(this.totalShippingCost, dealUnitLineUpdateDto.totalShippingCost) &&
        Objects.equals(this.totalShippingCostCurrencyId, dealUnitLineUpdateDto.totalShippingCostCurrencyId) &&
        Objects.equals(this.totalGlobalDiscounts, dealUnitLineUpdateDto.totalGlobalDiscounts) &&
        Objects.equals(this.totalGlobalDiscountsCurrencyId, dealUnitLineUpdateDto.totalGlobalDiscountsCurrencyId) &&
        Objects.equals(this.totalGlobalSurcharges, dealUnitLineUpdateDto.totalGlobalSurcharges) &&
        Objects.equals(this.totalGlobalSurchargesCurrencyId, dealUnitLineUpdateDto.totalGlobalSurchargesCurrencyId) &&
        Objects.equals(this.totalWithheldTax, dealUnitLineUpdateDto.totalWithheldTax) &&
        Objects.equals(this.totalWithheldTaxCurrencyId, dealUnitLineUpdateDto.totalWithheldTaxCurrencyId) &&
        Objects.equals(this.totalTaxBase, dealUnitLineUpdateDto.totalTaxBase) &&
        Objects.equals(this.totalTaxBaseCurrencyId, dealUnitLineUpdateDto.totalTaxBaseCurrencyId) &&
        Objects.equals(this.totalTaxes, dealUnitLineUpdateDto.totalTaxes) &&
        Objects.equals(this.totalTaxesCurrencyId, dealUnitLineUpdateDto.totalTaxesCurrencyId) &&
        Objects.equals(this.total, dealUnitLineUpdateDto.total) &&
        Objects.equals(this.totalCurrencyId, dealUnitLineUpdateDto.totalCurrencyId) &&
        Objects.equals(this.costCalculationMethod, dealUnitLineUpdateDto.costCalculationMethod) &&
        Objects.equals(this.taxCalculationMethod, dealUnitLineUpdateDto.taxCalculationMethod) &&
        Objects.equals(this.itemId, dealUnitLineUpdateDto.itemId) &&
        Objects.equals(this.itemTitle, dealUnitLineUpdateDto.itemTitle) &&
        Objects.equals(this.itemShortDescription, dealUnitLineUpdateDto.itemShortDescription) &&
        Objects.equals(this.itemPrimaryImageUrl, dealUnitLineUpdateDto.itemPrimaryImageUrl) &&
        Objects.equals(this.shippingPolicyId, dealUnitLineUpdateDto.shippingPolicyId) &&
        Objects.equals(this.quantity, dealUnitLineUpdateDto.quantity) &&
        Objects.equals(this.free, dealUnitLineUpdateDto.free) &&
        Objects.equals(this.freeReason, dealUnitLineUpdateDto.freeReason) &&
        Objects.equals(this.freeReasonCode, dealUnitLineUpdateDto.freeReasonCode) &&
        Objects.equals(this.data, dealUnitLineUpdateDto.data) &&
        Objects.equals(this.dataLabel, dealUnitLineUpdateDto.dataLabel) &&
        Objects.equals(this.data1, dealUnitLineUpdateDto.data1) &&
        Objects.equals(this.data1Label, dealUnitLineUpdateDto.data1Label) &&
        Objects.equals(this.data2, dealUnitLineUpdateDto.data2) &&
        Objects.equals(this.data2Label, dealUnitLineUpdateDto.data2Label) &&
        Objects.equals(this.data3, dealUnitLineUpdateDto.data3) &&
        Objects.equals(this.data3Label, dealUnitLineUpdateDto.data3Label) &&
        Objects.equals(this.data4, dealUnitLineUpdateDto.data4) &&
        Objects.equals(this.data4Label, dealUnitLineUpdateDto.data4Label) &&
        Objects.equals(this.data5, dealUnitLineUpdateDto.data5) &&
        Objects.equals(this.data5Label, dealUnitLineUpdateDto.data5Label) &&
        Objects.equals(this.data6, dealUnitLineUpdateDto.data6) &&
        Objects.equals(this.data6Label, dealUnitLineUpdateDto.data6Label) &&
        Objects.equals(this.data7, dealUnitLineUpdateDto.data7) &&
        Objects.equals(this.data7Label, dealUnitLineUpdateDto.data7Label) &&
        Objects.equals(this.data8, dealUnitLineUpdateDto.data8) &&
        Objects.equals(this.data8Label, dealUnitLineUpdateDto.data8Label) &&
        Objects.equals(this.data9, dealUnitLineUpdateDto.data9) &&
        Objects.equals(this.data9Label, dealUnitLineUpdateDto.data9Label) &&
        Objects.equals(this.itemPriceId, dealUnitLineUpdateDto.itemPriceId) &&
        Objects.equals(this.priceListItemId, dealUnitLineUpdateDto.priceListItemId) &&
        Objects.equals(this.unitId, dealUnitLineUpdateDto.unitId) &&
        Objects.equals(this.unitGroupId, dealUnitLineUpdateDto.unitGroupId) &&
        Objects.equals(this.forexRatesSnapshot, dealUnitLineUpdateDto.forexRatesSnapshot) &&
        Objects.equals(this.totalBaseAmountInUsd, dealUnitLineUpdateDto.totalBaseAmountInUsd) &&
        Objects.equals(this.totalProfitInUsd, dealUnitLineUpdateDto.totalProfitInUsd) &&
        Objects.equals(this.totalDetailAmountInUsd, dealUnitLineUpdateDto.totalDetailAmountInUsd) &&
        Objects.equals(this.totalTaxBaseInUsd, dealUnitLineUpdateDto.totalTaxBaseInUsd) &&
        Objects.equals(this.totalDiscountsInUsd, dealUnitLineUpdateDto.totalDiscountsInUsd) &&
        Objects.equals(this.totalTaxesInUsd, dealUnitLineUpdateDto.totalTaxesInUsd) &&
        Objects.equals(this.totalWithheldTaxesInUsd, dealUnitLineUpdateDto.totalWithheldTaxesInUsd) &&
        Objects.equals(this.totalShippingCostInUsd, dealUnitLineUpdateDto.totalShippingCostInUsd) &&
        Objects.equals(this.totalShippingTaxesInUsd, dealUnitLineUpdateDto.totalShippingTaxesInUsd) &&
        Objects.equals(this.totalWarrantyCostInUsd, dealUnitLineUpdateDto.totalWarrantyCostInUsd) &&
        Objects.equals(this.totalReturnCostInUsd, dealUnitLineUpdateDto.totalReturnCostInUsd) &&
        Objects.equals(this.totalRefundCostInUsd, dealUnitLineUpdateDto.totalRefundCostInUsd) &&
        Objects.equals(this.totalSurchargesInUsd, dealUnitLineUpdateDto.totalSurchargesInUsd) &&
        Objects.equals(this.totalAmountInUsd, dealUnitLineUpdateDto.totalAmountInUsd) &&
        Objects.equals(this.totalGlobalDiscountsInUsd, dealUnitLineUpdateDto.totalGlobalDiscountsInUsd) &&
        Objects.equals(this.totalGlobalSurchargesInUsd, dealUnitLineUpdateDto.totalGlobalSurchargesInUsd) &&
        Objects.equals(this.customGlobalSurchargesAmount, dealUnitLineUpdateDto.customGlobalSurchargesAmount) &&
        Objects.equals(this.customGlobalSurchargesAmountCurrencyId, dealUnitLineUpdateDto.customGlobalSurchargesAmountCurrencyId) &&
        Objects.equals(this.customGlobalDiscountsAmount, dealUnitLineUpdateDto.customGlobalDiscountsAmount) &&
        Objects.equals(this.customGlobalDiscountsAmountCurrencyId, dealUnitLineUpdateDto.customGlobalDiscountsAmountCurrencyId) &&
        Objects.equals(this.returnPolicyId, dealUnitLineUpdateDto.returnPolicyId) &&
        Objects.equals(this.refundPolicyId, dealUnitLineUpdateDto.refundPolicyId) &&
        Objects.equals(this.warrantyPolicyId, dealUnitLineUpdateDto.warrantyPolicyId) &&
        Objects.equals(this.shipmentPolicyId, dealUnitLineUpdateDto.shipmentPolicyId) &&
        Objects.equals(this.locationId, dealUnitLineUpdateDto.locationId) &&
        Objects.equals(this.quoteItemRecordId, dealUnitLineUpdateDto.quoteItemRecordId) &&
        Objects.equals(this.parentBillingItemRecordId, dealUnitLineUpdateDto.parentBillingItemRecordId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DealUnitLineUpdateDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DealUnitLineUpdateDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DealUnitLineUpdateDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DealUnitLineUpdateDto is not found in the empty JSON string", DealUnitLineUpdateDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DealUnitLineUpdateDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DealUnitLineUpdateDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DealUnitLineUpdateDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DealUnitLineUpdateDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DealUnitLineUpdateDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DealUnitLineUpdateDto.class));

       return (TypeAdapter<T>) new TypeAdapter<DealUnitLineUpdateDto>() {
           @Override
           public void write(JsonWriter out, DealUnitLineUpdateDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DealUnitLineUpdateDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DealUnitLineUpdateDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DealUnitLineUpdateDto
   * @throws IOException if the JSON string is invalid with respect to DealUnitLineUpdateDto
   */
  public static DealUnitLineUpdateDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DealUnitLineUpdateDto.class);
  }

  /**
   * Convert an instance of DealUnitLineUpdateDto to an JSON string
   *
   * @return JSON string
   */
