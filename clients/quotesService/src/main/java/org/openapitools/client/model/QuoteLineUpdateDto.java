 ...
 * QuoteLineUpdateDto
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-05-30T19:52:13.349662400-05:00[America/Bogota]", comments = "Generator version: 7.9.0")
public class QuoteLineUpdateDto {
  ...
  public QuoteLineUpdateDto() {
  }

  public QuoteLineUpdateDto closed(Boolean closed) {
    this.closed = closed;
    return this;
  }
  ...
  public QuoteLineUpdateDto title(String title) {
    this.title = title;
    return this;
  }
  ...
  public QuoteLineUpdateDto userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public QuoteLineUpdateDto priceListId(String priceListId) {
  ...
  public QuoteLineUpdateDto description(String description) {
  ...
  public QuoteLineUpdateDto individualId(String individualId) {
  ...
  public QuoteLineUpdateDto paymentTermId(String paymentTermId) {
  ...
  public QuoteLineUpdateDto organizationId(String organizationId) {
  ...
  public QuoteLineUpdateDto receiverTenantId(String receiverTenantId) {
  ...
  public QuoteLineUpdateDto firstName(String firstName) {
  ...
  public QuoteLineUpdateDto lastName(String lastName) {
  ...
  public QuoteLineUpdateDto companyName(String companyName) {
  ...
  public QuoteLineUpdateDto billingEmail(String billingEmail) {
  ...
  public QuoteLineUpdateDto addressLine1(String addressLine1) {
  ...
  public QuoteLineUpdateDto addressLine2(String addressLine2) {
  ...
  public QuoteLineUpdateDto postalCode(String postalCode) {
  ...
  public QuoteLineUpdateDto countryId(String countryId) {
  ...
  public QuoteLineUpdateDto stateId(String stateId) {
  ...
  public QuoteLineUpdateDto cityId(String cityId) {
    this.cityId = cityId;
    return this;
  }
  ...
  public QuoteLineUpdateDto billingLocationId(String billingLocationId) {
  ...
  public QuoteLineUpdateDto shippingLocationId(String shippingLocationId) {
  ...
  public QuoteLineUpdateDto shippingMethodId(String shippingMethodId) {
  ...
  public QuoteLineUpdateDto forexRate(Double forexRate) {
  ...
  public QuoteLineUpdateDto currencyId(String currencyId) {
  ...
  public QuoteLineUpdateDto totalDetail(Double totalDetail) {
  ...
  public QuoteLineUpdateDto totalDetailCurrencyId(String totalDetailCurrencyId) {
  ...
  public QuoteLineUpdateDto totalProfit(Double totalProfit) {
  ...
  public QuoteLineUpdateDto totalProfitCurrencyId(String totalProfitCurrencyId) {
  ...
  public QuoteLineUpdateDto totalDiscounts(Double totalDiscounts) {
  ...
  public QuoteLineUpdateDto totalDiscountsCurrencyId(String totalDiscountsCurrencyId) {
  ...
  public QuoteLineUpdateDto totalSurcharges(Double totalSurcharges) {
  ...
  public QuoteLineUpdateDto totalSurchargesCurrencyId(String totalSurchargesCurrencyId) {
  ...
  public QuoteLineUpdateDto totalShippingTax(Double totalShippingTax) {
  ...
  public QuoteLineUpdateDto totalShippingTaxCurrencyId(String totalShippingTaxCurrencyId) {
  ...
  public QuoteLineUpdateDto totalShippingCost(Double totalShippingCost) {
  ...
  public QuoteLineUpdateDto totalShippingCostCurrencyId(String totalShippingCostCurrencyId) {
  ...
  public QuoteLineUpdateDto totalGlobalDiscounts(Double totalGlobalDiscounts) {
  ...
  public QuoteLineUpdateDto totalGlobalDiscountsCurrencyId(String totalGlobalDiscountsCurrencyId) {
  ...
  public QuoteLineUpdateDto totalGlobalSurcharges(Double totalGlobalSurcharges) {
  ...
  public QuoteLineUpdateDto totalGlobalSurchargesCurrencyId(String totalGlobalSurchargesCurrencyId) {
  ...
  public QuoteLineUpdateDto totalWithheldTax(Double totalWithheldTax) {
  ...
  public QuoteLineUpdateDto totalWithheldTaxCurrencyId(String totalWithheldTaxCurrencyId) {
  ...
  public QuoteLineUpdateDto totalTaxBase(Double totalTaxBase) {
  ...
  public QuoteLineUpdateDto totalTaxBaseCurrencyId(String totalTaxBaseCurrencyId) {
  ...
  public QuoteLineUpdateDto totalTaxes(Double totalTaxes) {
  ...
  public QuoteLineUpdateDto totalTaxesCurrencyId(String totalTaxesCurrencyId) {
  ...
  public QuoteLineUpdateDto total(Double total) {
    this.total = total;
    return this;
  }
  ...
  public QuoteLineUpdateDto totalCurrencyId(String totalCurrencyId) {
  ...
  public QuoteLineUpdateDto costCalculationMethod(CostCalculationMethodEnum costCalculationMethod) {
  ...
  public QuoteLineUpdateDto taxCalculationMethod(TaxCalculationMethodEnum taxCalculationMethod) {
  ...
  public QuoteLineUpdateDto itemId(String itemId) {
    this.itemId = itemId;
    return this;
  }
  ...
  public QuoteLineUpdateDto itemTitle(String itemTitle) {
  ...
  public QuoteLineUpdateDto itemShortDescription(String itemShortDescription) {
  ...
  public QuoteLineUpdateDto itemPrimaryImageUrl(String itemPrimaryImageUrl) {
  ...
  public QuoteLineUpdateDto shippingPolicyId(String shippingPolicyId) {
  ...
  public QuoteLineUpdateDto quantity(Double quantity) {
  ...
  public QuoteLineUpdateDto free(Boolean free) {
    this.free = free;
    return this;
  }
  ...
  public QuoteLineUpdateDto freeReason(String freeReason) {
  ...
  public QuoteLineUpdateDto freeReasonCode(String freeReasonCode) {
  ...
  public QuoteLineUpdateDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public QuoteLineUpdateDto dataLabel(String dataLabel) {
  ...
  public QuoteLineUpdateDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public QuoteLineUpdateDto data1Label(String data1Label) {
  ...
  public QuoteLineUpdateDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public QuoteLineUpdateDto data2Label(String data2Label) {
  ...
  public QuoteLineUpdateDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public QuoteLineUpdateDto data3Label(String data3Label) {
  ...
  public QuoteLineUpdateDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public QuoteLineUpdateDto data4Label(String data4Label) {
  ...
  public QuoteLineUpdateDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public QuoteLineUpdateDto data5Label(String data5Label) {
  ...
  public QuoteLineUpdateDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public QuoteLineUpdateDto data6Label(String data6Label) {
  ...
  public QuoteLineUpdateDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public QuoteLineUpdateDto data7Label(String data7Label) {
  ...
  public QuoteLineUpdateDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public QuoteLineUpdateDto data8Label(String data8Label) {
  ...
  public QuoteLineUpdateDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public QuoteLineUpdateDto data9Label(String data9Label) {
  ...
  public QuoteLineUpdateDto itemPriceId(String itemPriceId) {
  ...
  public QuoteLineUpdateDto priceListItemId(String priceListItemId) {
  ...
  public QuoteLineUpdateDto unitId(String unitId) {
    this.unitId = unitId;
    return this;
  }
  ...
  public QuoteLineUpdateDto unitGroupId(String unitGroupId) {
  ...
  public QuoteLineUpdateDto forexRatesSnapshot(String forexRatesSnapshot) {
  ...
  public QuoteLineUpdateDto totalBaseAmountInUsd(Double totalBaseAmountInUsd) {
  ...
  public QuoteLineUpdateDto totalProfitInUsd(Double totalProfitInUsd) {
  ...
  public QuoteLineUpdateDto totalDetailAmountInUsd(Double totalDetailAmountInUsd) {
  ...
  public QuoteLineUpdateDto totalTaxBaseInUsd(Double totalTaxBaseInUsd) {
  ...
  public QuoteLineUpdateDto totalDiscountsInUsd(Double totalDiscountsInUsd) {
  ...
  public QuoteLineUpdateDto totalTaxesInUsd(Double totalTaxesInUsd) {
  ...
  public QuoteLineUpdateDto totalWithheldTaxesInUsd(Double totalWithheldTaxesInUsd) {
  ...
  public QuoteLineUpdateDto totalShippingCostInUsd(Double totalShippingCostInUsd) {
  ...
  public QuoteLineUpdateDto totalShippingTaxesInUsd(Double totalShippingTaxesInUsd) {
  ...
  public QuoteLineUpdateDto totalWarrantyCostInUsd(Double totalWarrantyCostInUsd) {
  ...
  public QuoteLineUpdateDto totalReturnCostInUsd(Double totalReturnCostInUsd) {
  ...
  public QuoteLineUpdateDto totalRefundCostInUsd(Double totalRefundCostInUsd) {
  ...
  public QuoteLineUpdateDto totalSurchargesInUsd(Double totalSurchargesInUsd) {
  ...
  public QuoteLineUpdateDto totalAmountInUsd(Double totalAmountInUsd) {
  ...
  public QuoteLineUpdateDto totalGlobalDiscountsInUsd(Double totalGlobalDiscountsInUsd) {
  ...
  public QuoteLineUpdateDto totalGlobalSurchargesInUsd(Double totalGlobalSurchargesInUsd) {
  ...
  public QuoteLineUpdateDto customGlobalSurchargesAmount(Double customGlobalSurchargesAmount) {
  ...
  public QuoteLineUpdateDto customGlobalSurchargesAmountCurrencyId(String customGlobalSurchargesAmountCurrencyId) {
  ...
  public QuoteLineUpdateDto customGlobalDiscountsAmount(Double customGlobalDiscountsAmount) {
  ...
  public QuoteLineUpdateDto customGlobalDiscountsAmountCurrencyId(String customGlobalDiscountsAmountCurrencyId) {
  ...
  public QuoteLineUpdateDto returnPolicyId(String returnPolicyId) {
  ...
  public QuoteLineUpdateDto refundPolicyId(String refundPolicyId) {
  ...
  public QuoteLineUpdateDto warrantyPolicyId(String warrantyPolicyId) {
  ...
  public QuoteLineUpdateDto shipmentPolicyId(String shipmentPolicyId) {
  ...
  public QuoteLineUpdateDto locationId(String locationId) {
  ...
  public QuoteLineUpdateDto quoteItemRecordId(String quoteItemRecordId) {
  ...
  public QuoteLineUpdateDto parentBillingItemRecordId(String parentBillingItemRecordId) {
  ...
  public boolean equals(Object o) {
    ...
    QuoteLineUpdateDto quoteLineUpdateDto = (QuoteLineUpdateDto) o;
    return Objects.equals(this.closed, quoteLineUpdateDto.closed) &&
        Objects.equals(this.title, quoteLineUpdateDto.title) &&
        Objects.equals(this.userId, quoteLineUpdateDto.userId) &&
        Objects.equals(this.priceListId, quoteLineUpdateDto.priceListId) &&
        Objects.equals(this.description, quoteLineUpdateDto.description) &&
        Objects.equals(this.individualId, quoteLineUpdateDto.individualId) &&
        Objects.equals(this.paymentTermId, quoteLineUpdateDto.paymentTermId) &&
        Objects.equals(this.organizationId, quoteLineUpdateDto.organizationId) &&
        Objects.equals(this.receiverTenantId, quoteLineUpdateDto.receiverTenantId) &&
        Objects.equals(this.firstName, quoteLineUpdateDto.firstName) &&
        Objects.equals(this.lastName, quoteLineUpdateDto.lastName) &&
        Objects.equals(this.companyName, quoteLineUpdateDto.companyName) &&
        Objects.equals(this.billingEmail, quoteLineUpdateDto.billingEmail) &&
        Objects.equals(this.addressLine1, quoteLineUpdateDto.addressLine1) &&
        Objects.equals(this.addressLine2, quoteLineUpdateDto.addressLine2) &&
        Objects.equals(this.postalCode, quoteLineUpdateDto.postalCode) &&
        Objects.equals(this.countryId, quoteLineUpdateDto.countryId) &&
        Objects.equals(this.stateId, quoteLineUpdateDto.stateId) &&
        Objects.equals(this.cityId, quoteLineUpdateDto.cityId) &&
        Objects.equals(this.billingLocationId, quoteLineUpdateDto.billingLocationId) &&
        Objects.equals(this.shippingLocationId, quoteLineUpdateDto.shippingLocationId) &&
        Objects.equals(this.shippingMethodId, quoteLineUpdateDto.shippingMethodId) &&
        Objects.equals(this.forexRate, quoteLineUpdateDto.forexRate) &&
        Objects.equals(this.currencyId, quoteLineUpdateDto.currencyId) &&
        Objects.equals(this.totalDetail, quoteLineUpdateDto.totalDetail) &&
        Objects.equals(this.totalDetailCurrencyId, quoteLineUpdateDto.totalDetailCurrencyId) &&
        Objects.equals(this.totalProfit, quoteLineUpdateDto.totalProfit) &&
        Objects.equals(this.totalProfitCurrencyId, quoteLineUpdateDto.totalProfitCurrencyId) &&
        Objects.equals(this.totalDiscounts, quoteLineUpdateDto.totalDiscounts) &&
        Objects.equals(this.totalDiscountsCurrencyId, quoteLineUpdateDto.totalDiscountsCurrencyId) &&
        Objects.equals(this.totalSurcharges, quoteLineUpdateDto.totalSurcharges) &&
        Objects.equals(this.totalSurchargesCurrencyId, quoteLineUpdateDto.totalSurchargesCurrencyId) &&
        Objects.equals(this.totalShippingTax, quoteLineUpdateDto.totalShippingTax) &&
        Objects.equals(this.totalShippingTaxCurrencyId, quoteLineUpdateDto.totalShippingTaxCurrencyId) &&
        Objects.equals(this.totalShippingCost, quoteLineUpdateDto.totalShippingCost) &&
        Objects.equals(this.totalShippingCostCurrencyId, quoteLineUpdateDto.totalShippingCostCurrencyId) &&
        Objects.equals(this.totalGlobalDiscounts, quoteLineUpdateDto.totalGlobalDiscounts) &&
        Objects.equals(this.totalGlobalDiscountsCurrencyId, quoteLineUpdateDto.totalGlobalDiscountsCurrencyId) &&
        Objects.equals(this.totalGlobalSurcharges, quoteLineUpdateDto.totalGlobalSurcharges) &&
        Objects.equals(this.totalGlobalSurchargesCurrencyId, quoteLineUpdateDto.totalGlobalSurchargesCurrencyId) &&
        Objects.equals(this.totalWithheldTax, quoteLineUpdateDto.totalWithheldTax) &&
        Objects.equals(this.totalWithheldTaxCurrencyId, quoteLineUpdateDto.totalWithheldTaxCurrencyId) &&
        Objects.equals(this.totalTaxBase, quoteLineUpdateDto.totalTaxBase) &&
        Objects.equals(this.totalTaxBaseCurrencyId, quoteLineUpdateDto.totalTaxBaseCurrencyId) &&
        Objects.equals(this.totalTaxes, quoteLineUpdateDto.totalTaxes) &&
        Objects.equals(this.totalTaxesCurrencyId, quoteLineUpdateDto.totalTaxesCurrencyId) &&
        Objects.equals(this.total, quoteLineUpdateDto.total) &&
        Objects.equals(this.totalCurrencyId, quoteLineUpdateDto.totalCurrencyId) &&
        Objects.equals(this.costCalculationMethod, quoteLineUpdateDto.costCalculationMethod) &&
        Objects.equals(this.taxCalculationMethod, quoteLineUpdateDto.taxCalculationMethod) &&
        Objects.equals(this.itemId, quoteLineUpdateDto.itemId) &&
        Objects.equals(this.itemTitle, quoteLineUpdateDto.itemTitle) &&
        Objects.equals(this.itemShortDescription, quoteLineUpdateDto.itemShortDescription) &&
        Objects.equals(this.itemPrimaryImageUrl, quoteLineUpdateDto.itemPrimaryImageUrl) &&
        Objects.equals(this.shippingPolicyId, quoteLineUpdateDto.shippingPolicyId) &&
        Objects.equals(this.quantity, quoteLineUpdateDto.quantity) &&
        Objects.equals(this.free, quoteLineUpdateDto.free) &&
        Objects.equals(this.freeReason, quoteLineUpdateDto.freeReason) &&
        Objects.equals(this.freeReasonCode, quoteLineUpdateDto.freeReasonCode) &&
        Objects.equals(this.data, quoteLineUpdateDto.data) &&
        Objects.equals(this.dataLabel, quoteLineUpdateDto.dataLabel) &&
        Objects.equals(this.data1, quoteLineUpdateDto.data1) &&
        Objects.equals(this.data1Label, quoteLineUpdateDto.data1Label) &&
        Objects.equals(this.data2, quoteLineUpdateDto.data2) &&
        Objects.equals(this.data2Label, quoteLineUpdateDto.data2Label) &&
        Objects.equals(this.data3, quoteLineUpdateDto.data3) &&
        Objects.equals(this.data3Label, quoteLineUpdateDto.data3Label) &&
        Objects.equals(this.data4, quoteLineUpdateDto.data4) &&
        Objects.equals(this.data4Label, quoteLineUpdateDto.data4Label) &&
        Objects.equals(this.data5, quoteLineUpdateDto.data5) &&
        Objects.equals(this.data5Label, quoteLineUpdateDto.data5Label) &&
        Objects.equals(this.data6, quoteLineUpdateDto.data6) &&
        Objects.equals(this.data6Label, quoteLineUpdateDto.data6Label) &&
        Objects.equals(this.data7, quoteLineUpdateDto.data7) &&
        Objects.equals(this.data7Label, quoteLineUpdateDto.data7Label) &&
        Objects.equals(this.data8, quoteLineUpdateDto.data8) &&
        Objects.equals(this.data8Label, quoteLineUpdateDto.data8Label) &&
        Objects.equals(this.data9, quoteLineUpdateDto.data9) &&
        Objects.equals(this.data9Label, quoteLineUpdateDto.data9Label) &&
        Objects.equals(this.itemPriceId, quoteLineUpdateDto.itemPriceId) &&
        Objects.equals(this.priceListItemId, quoteLineUpdateDto.priceListItemId) &&
        Objects.equals(this.unitId, quoteLineUpdateDto.unitId) &&
        Objects.equals(this.unitGroupId, quoteLineUpdateDto.unitGroupId) &&
        Objects.equals(this.forexRatesSnapshot, quoteLineUpdateDto.forexRatesSnapshot) &&
        Objects.equals(this.totalBaseAmountInUsd, quoteLineUpdateDto.totalBaseAmountInUsd) &&
        Objects.equals(this.totalProfitInUsd, quoteLineUpdateDto.totalProfitInUsd) &&
        Objects.equals(this.totalDetailAmountInUsd, quoteLineUpdateDto.totalDetailAmountInUsd) &&
        Objects.equals(this.totalTaxBaseInUsd, quoteLineUpdateDto.totalTaxBaseInUsd) &&
        Objects.equals(this.totalDiscountsInUsd, quoteLineUpdateDto.totalDiscountsInUsd) &&
        Objects.equals(this.totalTaxesInUsd, quoteLineUpdateDto.totalTaxesInUsd) &&
        Objects.equals(this.totalWithheldTaxesInUsd, quoteLineUpdateDto.totalWithheldTaxesInUsd) &&
        Objects.equals(this.totalShippingCostInUsd, quoteLineUpdateDto.totalShippingCostInUsd) &&
        Objects.equals(this.totalShippingTaxesInUsd, quoteLineUpdateDto.totalShippingTaxesInUsd) &&
        Objects.equals(this.totalWarrantyCostInUsd, quoteLineUpdateDto.totalWarrantyCostInUsd) &&
        Objects.equals(this.totalReturnCostInUsd, quoteLineUpdateDto.totalReturnCostInUsd) &&
        Objects.equals(this.totalRefundCostInUsd, quoteLineUpdateDto.totalRefundCostInUsd) &&
        Objects.equals(this.totalSurchargesInUsd, quoteLineUpdateDto.totalSurchargesInUsd) &&
        Objects.equals(this.totalAmountInUsd, quoteLineUpdateDto.totalAmountInUsd) &&
        Objects.equals(this.totalGlobalDiscountsInUsd, quoteLineUpdateDto.totalGlobalDiscountsInUsd) &&
        Objects.equals(this.totalGlobalSurchargesInUsd, quoteLineUpdateDto.totalGlobalSurchargesInUsd) &&
        Objects.equals(this.customGlobalSurchargesAmount, quoteLineUpdateDto.customGlobalSurchargesAmount) &&
        Objects.equals(this.customGlobalSurchargesAmountCurrencyId, quoteLineUpdateDto.customGlobalSurchargesAmountCurrencyId) &&
        Objects.equals(this.customGlobalDiscountsAmount, quoteLineUpdateDto.customGlobalDiscountsAmount) &&
        Objects.equals(this.customGlobalDiscountsAmountCurrencyId, quoteLineUpdateDto.customGlobalDiscountsAmountCurrencyId) &&
        Objects.equals(this.returnPolicyId, quoteLineUpdateDto.returnPolicyId) &&
        Objects.equals(this.refundPolicyId, quoteLineUpdateDto.refundPolicyId) &&
        Objects.equals(this.warrantyPolicyId, quoteLineUpdateDto.warrantyPolicyId) &&
        Objects.equals(this.shipmentPolicyId, quoteLineUpdateDto.shipmentPolicyId) &&
        Objects.equals(this.locationId, quoteLineUpdateDto.locationId) &&
        Objects.equals(this.quoteItemRecordId, quoteLineUpdateDto.quoteItemRecordId) &&
        Objects.equals(this.parentBillingItemRecordId, quoteLineUpdateDto.parentBillingItemRecordId);
  }
  ...
  public String toString() {
    ...
    sb.append("class QuoteLineUpdateDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to QuoteLineUpdateDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QuoteLineUpdateDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in QuoteLineUpdateDto is not found in the empty JSON string", QuoteLineUpdateDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!QuoteLineUpdateDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `QuoteLineUpdateDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QuoteLineUpdateDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QuoteLineUpdateDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QuoteLineUpdateDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QuoteLineUpdateDto.class));

       return (TypeAdapter<T>) new TypeAdapter<QuoteLineUpdateDto>() {
           @Override
           public void write(JsonWriter out, QuoteLineUpdateDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public QuoteLineUpdateDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of QuoteLineUpdateDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of QuoteLineUpdateDto
   * @throws IOException if the JSON string is invalid with respect to QuoteLineUpdateDto
   */
  public static QuoteLineUpdateDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QuoteLineUpdateDto.class);
  }

  /**
   * Convert an instance of QuoteLineUpdateDto to an JSON string
   *
   * @return JSON string
   */
