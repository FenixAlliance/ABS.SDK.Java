...
public class QuoteLineUpsertDto {
  ...
  public QuoteLineUpsertDto() {
  }

  public QuoteLineUpsertDto closed(Boolean closed) {
    this.closed = closed;
    return this;
  }
  ...
  public QuoteLineUpsertDto title(String title) {
    this.title = title;
    return this;
  }
  ...
  public QuoteLineUpsertDto userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public QuoteLineUpsertDto priceListId(String priceListId) {
  ...
  public QuoteLineUpsertDto description(String description) {
  ...
  public QuoteLineUpsertDto individualId(String individualId) {
  ...
  public QuoteLineUpsertDto paymentTermId(String paymentTermId) {
  ...
  public QuoteLineUpsertDto organizationId(String organizationId) {
  ...
  public QuoteLineUpsertDto receiverTenantId(String receiverTenantId) {
  ...
  public QuoteLineUpsertDto firstName(String firstName) {
  ...
  public QuoteLineUpsertDto lastName(String lastName) {
  ...
  public QuoteLineUpsertDto companyName(String companyName) {
  ...
  public QuoteLineUpsertDto billingEmail(String billingEmail) {
  ...
  public QuoteLineUpsertDto addressLine1(String addressLine1) {
  ...
  public QuoteLineUpsertDto addressLine2(String addressLine2) {
  ...
  public QuoteLineUpsertDto postalCode(String postalCode) {
  ...
  public QuoteLineUpsertDto countryId(String countryId) {
  ...
  public QuoteLineUpsertDto stateId(String stateId) {
  ...
  public QuoteLineUpsertDto cityId(String cityId) {
    this.cityId = cityId;
    return this;
  }
  ...
  public QuoteLineUpsertDto billingLocationId(String billingLocationId) {
  ...
  public QuoteLineUpsertDto shippingLocationId(String shippingLocationId) {
  ...
  public QuoteLineUpsertDto shippingMethodId(String shippingMethodId) {
  ...
  public QuoteLineUpsertDto forexRate(Double forexRate) {
  ...
  public QuoteLineUpsertDto currencyId(String currencyId) {
  ...
  public QuoteLineUpsertDto totalDetail(Double totalDetail) {
  ...
  public QuoteLineUpsertDto totalDetailCurrencyId(String totalDetailCurrencyId) {
  ...
  public QuoteLineUpsertDto totalProfit(Double totalProfit) {
  ...
  public QuoteLineUpsertDto totalProfitCurrencyId(String totalProfitCurrencyId) {
  ...
  public QuoteLineUpsertDto totalDiscounts(Double totalDiscounts) {
  ...
  public QuoteLineUpsertDto totalDiscountsCurrencyId(String totalDiscountsCurrencyId) {
  ...
  public QuoteLineUpsertDto totalSurcharges(Double totalSurcharges) {
  ...
  public QuoteLineUpsertDto totalSurchargesCurrencyId(String totalSurchargesCurrencyId) {
  ...
  public QuoteLineUpsertDto totalShippingTax(Double totalShippingTax) {
  ...
  public QuoteLineUpsertDto totalShippingTaxCurrencyId(String totalShippingTaxCurrencyId) {
  ...
  public QuoteLineUpsertDto totalShippingCost(Double totalShippingCost) {
  ...
  public QuoteLineUpsertDto totalShippingCostCurrencyId(String totalShippingCostCurrencyId) {
  ...
  public QuoteLineUpsertDto totalGlobalDiscounts(Double totalGlobalDiscounts) {
  ...
  public QuoteLineUpsertDto totalGlobalDiscountsCurrencyId(String totalGlobalDiscountsCurrencyId) {
  ...
  public QuoteLineUpsertDto totalGlobalSurcharges(Double totalGlobalSurcharges) {
  ...
  public QuoteLineUpsertDto totalGlobalSurchargesCurrencyId(String totalGlobalSurchargesCurrencyId) {
  ...
  public QuoteLineUpsertDto totalWithheldTax(Double totalWithheldTax) {
  ...
  public QuoteLineUpsertDto totalWithheldTaxCurrencyId(String totalWithheldTaxCurrencyId) {
  ...
  public QuoteLineUpsertDto totalTaxBase(Double totalTaxBase) {
  ...
  public QuoteLineUpsertDto totalTaxBaseCurrencyId(String totalTaxBaseCurrencyId) {
  ...
  public QuoteLineUpsertDto totalTaxes(Double totalTaxes) {
  ...
  public QuoteLineUpsertDto totalTaxesCurrencyId(String totalTaxesCurrencyId) {
  ...
  public QuoteLineUpsertDto total(Double total) {
    this.total = total;
    return this;
  }
  ...
  public QuoteLineUpsertDto totalCurrencyId(String totalCurrencyId) {
  ...
  public QuoteLineUpsertDto costCalculationMethod(CostCalculationMethodEnum costCalculationMethod) {
  ...
  public QuoteLineUpsertDto taxCalculationMethod(TaxCalculationMethodEnum taxCalculationMethod) {
  ...
  public QuoteLineUpsertDto itemId(String itemId) {
    this.itemId = itemId;
    return this;
  }
  ...
  public QuoteLineUpsertDto itemTitle(String itemTitle) {
  ...
  public QuoteLineUpsertDto itemShortDescription(String itemShortDescription) {
  ...
  public QuoteLineUpsertDto itemPrimaryImageUrl(String itemPrimaryImageUrl) {
  ...
  public QuoteLineUpsertDto shippingPolicyId(String shippingPolicyId) {
  ...
  public QuoteLineUpsertDto quantity(Double quantity) {
  ...
  public QuoteLineUpsertDto free(Boolean free) {
    this.free = free;
    return this;
  }
  ...
  public QuoteLineUpsertDto freeReason(String freeReason) {
  ...
  public QuoteLineUpsertDto freeReasonCode(String freeReasonCode) {
  ...
  public QuoteLineUpsertDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public QuoteLineUpsertDto dataLabel(String dataLabel) {
  ...
  public QuoteLineUpsertDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public QuoteLineUpsertDto data1Label(String data1Label) {
  ...
  public QuoteLineUpsertDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public QuoteLineUpsertDto data2Label(String data2Label) {
  ...
  public QuoteLineUpsertDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public QuoteLineUpsertDto data3Label(String data3Label) {
  ...
  public QuoteLineUpsertDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public QuoteLineUpsertDto data4Label(String data4Label) {
  ...
  public QuoteLineUpsertDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public QuoteLineUpsertDto data5Label(String data5Label) {
  ...
  public QuoteLineUpsertDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public QuoteLineUpsertDto data6Label(String data6Label) {
  ...
  public QuoteLineUpsertDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public QuoteLineUpsertDto data7Label(String data7Label) {
  ...
  public QuoteLineUpsertDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public QuoteLineUpsertDto data8Label(String data8Label) {
  ...
  public QuoteLineUpsertDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public QuoteLineUpsertDto data9Label(String data9Label) {
  ...
  public QuoteLineUpsertDto itemPriceId(String itemPriceId) {
  ...
  public QuoteLineUpsertDto priceListItemId(String priceListItemId) {
  ...
  public QuoteLineUpsertDto unitId(String unitId) {
    this.unitId = unitId;
    return this;
  }
  ...
  public QuoteLineUpsertDto unitGroupId(String unitGroupId) {
  ...
  public QuoteLineUpsertDto forexRatesSnapshot(String forexRatesSnapshot) {
  ...
  public QuoteLineUpsertDto totalBaseAmountInUsd(Double totalBaseAmountInUsd) {
  ...
  public QuoteLineUpsertDto totalProfitInUsd(Double totalProfitInUsd) {
  ...
  public QuoteLineUpsertDto totalDetailAmountInUsd(Double totalDetailAmountInUsd) {
  ...
  public QuoteLineUpsertDto totalTaxBaseInUsd(Double totalTaxBaseInUsd) {
  ...
  public QuoteLineUpsertDto totalDiscountsInUsd(Double totalDiscountsInUsd) {
  ...
  public QuoteLineUpsertDto totalTaxesInUsd(Double totalTaxesInUsd) {
  ...
  public QuoteLineUpsertDto totalWithheldTaxesInUsd(Double totalWithheldTaxesInUsd) {
  ...
  public QuoteLineUpsertDto totalShippingCostInUsd(Double totalShippingCostInUsd) {
  ...
  public QuoteLineUpsertDto totalShippingTaxesInUsd(Double totalShippingTaxesInUsd) {
  ...
  public QuoteLineUpsertDto totalWarrantyCostInUsd(Double totalWarrantyCostInUsd) {
  ...
  public QuoteLineUpsertDto totalReturnCostInUsd(Double totalReturnCostInUsd) {
  ...
  public QuoteLineUpsertDto totalRefundCostInUsd(Double totalRefundCostInUsd) {
  ...
  public QuoteLineUpsertDto totalSurchargesInUsd(Double totalSurchargesInUsd) {
  ...
  public QuoteLineUpsertDto totalAmountInUsd(Double totalAmountInUsd) {
  ...
  public QuoteLineUpsertDto totalGlobalDiscountsInUsd(Double totalGlobalDiscountsInUsd) {
  ...
  public QuoteLineUpsertDto totalGlobalSurchargesInUsd(Double totalGlobalSurchargesInUsd) {
  ...
  public QuoteLineUpsertDto customGlobalSurchargesAmount(Double customGlobalSurchargesAmount) {
  ...
  public QuoteLineUpsertDto customGlobalSurchargesAmountCurrencyId(String customGlobalSurchargesAmountCurrencyId) {
  ...
  public QuoteLineUpsertDto customGlobalDiscountsAmount(Double customGlobalDiscountsAmount) {
  ...
  public QuoteLineUpsertDto customGlobalDiscountsAmountCurrencyId(String customGlobalDiscountsAmountCurrencyId) {
  ...
  public QuoteLineUpsertDto returnPolicyId(String returnPolicyId) {
  ...
  public QuoteLineUpsertDto refundPolicyId(String refundPolicyId) {
  ...
  public QuoteLineUpsertDto warrantyPolicyId(String warrantyPolicyId) {
  ...
  public QuoteLineUpsertDto shipmentPolicyId(String shipmentPolicyId) {
  ...
  public QuoteLineUpsertDto locationId(String locationId) {
  ...
  public QuoteLineUpsertDto quoteItemRecordId(String quoteItemRecordId) {
  ...
  public QuoteLineUpsertDto id(String id) {
    this.id = id;
    return this;
  }
  ...
  public QuoteLineUpsertDto quoteId(String quoteId) {
  ...
  public boolean equals(Object o) {
    ...
    QuoteLineUpsertDto quoteLineUpsertDto = (QuoteLineUpsertDto) o;
    return Objects.equals(this.closed, quoteLineUpsertDto.closed) &&
        Objects.equals(this.title, quoteLineUpsertDto.title) &&
        Objects.equals(this.userId, quoteLineUpsertDto.userId) &&
        Objects.equals(this.priceListId, quoteLineUpsertDto.priceListId) &&
        Objects.equals(this.description, quoteLineUpsertDto.description) &&
        Objects.equals(this.individualId, quoteLineUpsertDto.individualId) &&
        Objects.equals(this.paymentTermId, quoteLineUpsertDto.paymentTermId) &&
        Objects.equals(this.organizationId, quoteLineUpsertDto.organizationId) &&
        Objects.equals(this.receiverTenantId, quoteLineUpsertDto.receiverTenantId) &&
        Objects.equals(this.firstName, quoteLineUpsertDto.firstName) &&
        Objects.equals(this.lastName, quoteLineUpsertDto.lastName) &&
        Objects.equals(this.companyName, quoteLineUpsertDto.companyName) &&
        Objects.equals(this.billingEmail, quoteLineUpsertDto.billingEmail) &&
        Objects.equals(this.addressLine1, quoteLineUpsertDto.addressLine1) &&
        Objects.equals(this.addressLine2, quoteLineUpsertDto.addressLine2) &&
        Objects.equals(this.postalCode, quoteLineUpsertDto.postalCode) &&
        Objects.equals(this.countryId, quoteLineUpsertDto.countryId) &&
        Objects.equals(this.stateId, quoteLineUpsertDto.stateId) &&
        Objects.equals(this.cityId, quoteLineUpsertDto.cityId) &&
        Objects.equals(this.billingLocationId, quoteLineUpsertDto.billingLocationId) &&
        Objects.equals(this.shippingLocationId, quoteLineUpsertDto.shippingLocationId) &&
        Objects.equals(this.shippingMethodId, quoteLineUpsertDto.shippingMethodId) &&
        Objects.equals(this.forexRate, quoteLineUpsertDto.forexRate) &&
        Objects.equals(this.currencyId, quoteLineUpsertDto.currencyId) &&
        Objects.equals(this.totalDetail, quoteLineUpsertDto.totalDetail) &&
        Objects.equals(this.totalDetailCurrencyId, quoteLineUpsertDto.totalDetailCurrencyId) &&
        Objects.equals(this.totalProfit, quoteLineUpsertDto.totalProfit) &&
        Objects.equals(this.totalProfitCurrencyId, quoteLineUpsertDto.totalProfitCurrencyId) &&
        Objects.equals(this.totalDiscounts, quoteLineUpsertDto.totalDiscounts) &&
        Objects.equals(this.totalDiscountsCurrencyId, quoteLineUpsertDto.totalDiscountsCurrencyId) &&
        Objects.equals(this.totalSurcharges, quoteLineUpsertDto.totalSurcharges) &&
        Objects.equals(this.totalSurchargesCurrencyId, quoteLineUpsertDto.totalSurchargesCurrencyId) &&
        Objects.equals(this.totalShippingTax, quoteLineUpsertDto.totalShippingTax) &&
        Objects.equals(this.totalShippingTaxCurrencyId, quoteLineUpsertDto.totalShippingTaxCurrencyId) &&
        Objects.equals(this.totalShippingCost, quoteLineUpsertDto.totalShippingCost) &&
        Objects.equals(this.totalShippingCostCurrencyId, quoteLineUpsertDto.totalShippingCostCurrencyId) &&
        Objects.equals(this.totalGlobalDiscounts, quoteLineUpsertDto.totalGlobalDiscounts) &&
        Objects.equals(this.totalGlobalDiscountsCurrencyId, quoteLineUpsertDto.totalGlobalDiscountsCurrencyId) &&
        Objects.equals(this.totalGlobalSurcharges, quoteLineUpsertDto.totalGlobalSurcharges) &&
        Objects.equals(this.totalGlobalSurchargesCurrencyId, quoteLineUpsertDto.totalGlobalSurchargesCurrencyId) &&
        Objects.equals(this.totalWithheldTax, quoteLineUpsertDto.totalWithheldTax) &&
        Objects.equals(this.totalWithheldTaxCurrencyId, quoteLineUpsertDto.totalWithheldTaxCurrencyId) &&
        Objects.equals(this.totalTaxBase, quoteLineUpsertDto.totalTaxBase) &&
        Objects.equals(this.totalTaxBaseCurrencyId, quoteLineUpsertDto.totalTaxBaseCurrencyId) &&
        Objects.equals(this.totalTaxes, quoteLineUpsertDto.totalTaxes) &&
        Objects.equals(this.totalTaxesCurrencyId, quoteLineUpsertDto.totalTaxesCurrencyId) &&
        Objects.equals(this.total, quoteLineUpsertDto.total) &&
        Objects.equals(this.totalCurrencyId, quoteLineUpsertDto.totalCurrencyId) &&
        Objects.equals(this.costCalculationMethod, quoteLineUpsertDto.costCalculationMethod) &&
        Objects.equals(this.taxCalculationMethod, quoteLineUpsertDto.taxCalculationMethod) &&
        Objects.equals(this.itemId, quoteLineUpsertDto.itemId) &&
        Objects.equals(this.itemTitle, quoteLineUpsertDto.itemTitle) &&
        ...
        Objects.equals(this.free, quoteLineUpsertDto.free) &&
        Objects.equals(this.freeReason, quoteLineUpsertDto.freeReason) &&
        Objects.equals(this.freeReasonCode, quoteLineUpsertDto.freeReasonCode) &&
        Objects.equals(this.data, quoteLineUpsertDto.data) &&
        Objects.equals(this.dataLabel, quoteLineUpsertDto.dataLabel) &&
        Objects.equals(this.data1, quoteLineUpsertDto.data1) &&
        Objects.equals(this.data1Label, quoteLineUpsertDto.data1Label) &&
        Objects.equals(this.data2, quoteLineUpsertDto.data2) &&
        Objects.equals(this.data2Label, quoteLineUpsertDto.data2Label) &&
        Objects.equals(this.data3, quoteLineUpsertDto.data3) &&
        Objects.equals(this.data3Label, quoteLineUpsertDto.data3Label) &&
        Objects.equals(this.data4, quoteLineUpsertDto.data4) &&
        Objects.equals(this.data4Label, quoteLineUpsertDto.data4Label) &&
        Objects.equals(this.data5, quoteLineUpsertDto.data5) &&
        Objects.equals(this.data5Label, quoteLineUpsertDto.data5Label) &&
        Objects.equals(this.data6, quoteLineUpsertDto.data6) &&
        Objects.equals(this.data6Label, quoteLineUpsertDto.data6Label) &&
        Objects.equals(this.data7, quoteLineUpsertDto.data7) &&
        Objects.equals(this.data7Label, quoteLineUpsertDto.data7Label) &&
        Objects.equals(this.data8, quoteLineUpsertDto.data8) &&
        Objects.equals(this.data8Label, quoteLineUpsertDto.data8Label) &&
        Objects.equals(this.data9, quoteLineUpsertDto.data9) &&
        Objects.equals(this.data9Label, quoteLineUpsertDto.data9Label) &&
        Objects.equals(this.itemPriceId, quoteLineUpsertDto.itemPriceId) &&
        Objects.equals(this.priceListItemId, quoteLineUpsertDto.priceListItemId) &&
        Objects.equals(this.unitId, quoteLineUpsertDto.unitId) &&
        Objects.equals(this.unitGroupId, quoteLineUpsertDto.unitGroupId) &&
        Objects.equals(this.forexRatesSnapshot, quoteLineUpsertDto.forexRatesSnapshot) &&
        Objects.equals(this.totalBaseAmountInUsd, quoteLineUpsertDto.totalBaseAmountInUsd) &&
        Objects.equals(this.totalProfitInUsd, quoteLineUpsertDto.totalProfitInUsd) &&
        Objects.equals(this.totalDetailAmountInUsd, quoteLineUpsertDto.totalDetailAmountInUsd) &&
        Objects.equals(this.totalTaxBaseInUsd, quoteLineUpsertDto.totalTaxBaseInUsd) &&
        Objects.equals(this.totalDiscountsInUsd, quoteLineUpsertDto.totalDiscountsInUsd) &&
        Objects.equals(this.totalTaxesInUsd, quoteLineUpsertDto.totalTaxesInUsd) &&
        Objects.equals(this.totalWithheldTaxesInUsd, quoteLineUpsertDto.totalWithheldTaxesInUsd) &&
        Objects.equals(this.totalShippingCostInUsd, quoteLineUpsertDto.totalShippingCostInUsd) &&
        Objects.equals(this.totalShippingTaxesInUsd, quoteLineUpsertDto.totalShippingTaxesInUsd) &&
        Objects.equals(this.totalWarrantyCostInUsd, quoteLineUpsertDto.totalWarrantyCostInUsd) &&
        Objects.equals(this.totalReturnCostInUsd, quoteLineUpsertDto.totalReturnCostInUsd) &&
        Objects.equals(this.totalRefundCostInUsd, quoteLineUpsertDto.totalRefundCostInUsd) &&
        Objects.equals(this.totalSurchargesInUsd, quoteLineUpsertDto.totalSurchargesInUsd) &&
        Objects.equals(this.totalAmountInUsd, quoteLineUpsertDto.totalAmountInUsd) &&
        Objects.equals(this.totalGlobalDiscountsInUsd, quoteLineUpsertDto.totalGlobalDiscountsInUsd) &&
        Objects.equals(this.totalGlobalSurchargesInUsd, quoteLineUpsertDto.totalGlobalSurchargesInUsd) &&
        Objects.equals(this.customGlobalSurchargesAmount, quoteLineUpsertDto.customGlobalSurchargesAmount) &&
        Objects.equals(this.customGlobalSurchargesAmountCurrencyId, quoteLineUpsertDto.customGlobalSurchargesAmountCurrencyId) &&
        Objects.equals(this.customGlobalDiscountsAmount, quoteLineUpsertDto.customGlobalDiscountsAmount) &&
        Objects.equals(this.customGlobalDiscountsAmountCurrencyId, quoteLineUpsertDto.customGlobalDiscountsAmountCurrencyId) &&
        Objects.equals(this.returnPolicyId, quoteLineUpsertDto.returnPolicyId) &&
        Objects.equals(this.refundPolicyId, quoteLineUpsertDto.refundPolicyId) &&
        Objects.equals(this.warrantyPolicyId, quoteLineUpsertDto.warrantyPolicyId) &&
        Objects.equals(this.shipmentPolicyId, quoteLineUpsertDto.shipmentPolicyId) &&
  ...
  public String toString() {
    ...
    sb.append("class QuoteLineUpsertDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to QuoteLineUpsertDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QuoteLineUpsertDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in QuoteLineUpsertDto is not found in the empty JSON string", QuoteLineUpsertDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!QuoteLineUpsertDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `QuoteLineUpsertDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QuoteLineUpsertDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QuoteLineUpsertDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QuoteLineUpsertDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QuoteLineUpsertDto.class));

       return (TypeAdapter<T>) new TypeAdapter<QuoteLineUpsertDto>() {
           @Override
           public void write(JsonWriter out, QuoteLineUpsertDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public QuoteLineUpsertDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of QuoteLineUpsertDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of QuoteLineUpsertDto
   * @throws IOException if the JSON string is invalid with respect to QuoteLineUpsertDto
   */
  public static QuoteLineUpsertDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QuoteLineUpsertDto.class);
  }

  /**
   * Convert an instance of QuoteLineUpsertDto to an JSON string
   *
   * @return JSON string
   */
