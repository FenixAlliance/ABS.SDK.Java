...
public class SimpleUserDto {
  ...
  public SimpleUserDto handler(String handler) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, simpleUserDto.id) &&
        ...
        Objects.equals(this.handler, simpleUserDto.handler) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, fullName, qualifiedName, publicName, handler, lastName, firstName, coverUrl, avatarUrl, gitHubUrl, countryId, timezoneId, websiteUrl, twitterUrl, youTubeUrl, linkedInUrl, facebookUrl, instagramUrl, socialProfileId);
  }
