...
public class ResetPasswordRequest {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, resetPasswordRequest.email) &&
        Objects.equals(this.resetCode, resetPasswordRequest.resetCode) &&
        Objects.equals(this.newPassword, resetPasswordRequest.newPassword);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, resetCode, newPassword);
  }
  ...
  static {
    ...
    openapiFields.add("resetCode");
    openapiFields.add("newPassword");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("email");
    openapiRequiredFields.add("resetCode");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("resetCode") != null && !jsonObj.get("resetCode").isJsonNull()) && !jsonObj.get("resetCode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `resetCode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("resetCode").toString()));
      }
