...
public class InvoiceAdjustmentCreateDto {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, currencyId, description, surchargePercent, surchargeAmount, discountPercent, discountAmount, totalSurcharge, totalDiscount, type);
  }
