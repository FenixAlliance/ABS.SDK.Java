...
public class InvoiceAdjustmentCreateDto {
  ...
  public InvoiceAdjustmentCreateDto id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public InvoiceAdjustmentCreateDto timestamp(OffsetDateTime timestamp) {
  ...
  public InvoiceAdjustmentCreateDto priority(Integer priority) {
  ...
  public InvoiceAdjustmentCreateDto code(String code) {
    this.code = code;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, invoiceAdjustmentCreateDto.id) &&
        ...
        Objects.equals(this.priority, invoiceAdjustmentCreateDto.priority) &&
        Objects.equals(this.code, invoiceAdjustmentCreateDto.code) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, currencyId, priority, code, description, surchargePercent, surchargeAmount, discountPercent, discountAmount, totalSurcharge, totalDiscount, type);
  }
