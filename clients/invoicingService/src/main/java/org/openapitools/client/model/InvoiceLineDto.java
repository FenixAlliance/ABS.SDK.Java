...
public class InvoiceLineDto {
  ...
  public InvoiceLineDto id(String id) {
    this.id = id;
    return this;
  }
  ...
  public InvoiceLineDto timestamp(OffsetDateTime timestamp) {
  ...
  public InvoiceLineDto closed(Boolean closed) {
    this.closed = closed;
    return this;
  }
  ...
  public InvoiceLineDto itemId(String itemId) {
    this.itemId = itemId;
    return this;
  }
  ...
  public InvoiceLineDto itemTitle(String itemTitle) {
  ...
  public InvoiceLineDto itemShortDescription(String itemShortDescription) {
  ...
  public InvoiceLineDto itemPrimaryImageUrl(String itemPrimaryImageUrl) {
  ...
  public InvoiceLineDto shippingPolicyId(String shippingPolicyId) {
  ...
  public InvoiceLineDto tenantId(String tenantId) {
  ...
  public InvoiceLineDto enrollmentId(String enrollmentId) {
  ...
  public InvoiceLineDto currencyId(String currencyId) {
  ...
  public InvoiceLineDto quantity(Double quantity) {
  ...
  public InvoiceLineDto free(Boolean free) {
    this.free = free;
    return this;
  }
  ...
  public InvoiceLineDto freeReason(String freeReason) {
  ...
  public InvoiceLineDto freeReasonCode(String freeReasonCode) {
  ...
  public InvoiceLineDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public InvoiceLineDto dataLabel(String dataLabel) {
  ...
  public InvoiceLineDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public InvoiceLineDto data1Label(String data1Label) {
  ...
  public InvoiceLineDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public InvoiceLineDto data2Label(String data2Label) {
  ...
  public InvoiceLineDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public InvoiceLineDto data3Label(String data3Label) {
  ...
  public InvoiceLineDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public InvoiceLineDto data4Label(String data4Label) {
  ...
  public InvoiceLineDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public InvoiceLineDto data5Label(String data5Label) {
  ...
  public InvoiceLineDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public InvoiceLineDto data6Label(String data6Label) {
  ...
  public InvoiceLineDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public InvoiceLineDto data7Label(String data7Label) {
  ...
  public InvoiceLineDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public InvoiceLineDto data8Label(String data8Label) {
  ...
  public InvoiceLineDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public InvoiceLineDto data9Label(String data9Label) {
  ...
  public InvoiceLineDto itemPriceId(String itemPriceId) {
  ...
  public InvoiceLineDto priceListItemId(String priceListItemId) {
  ...
  public InvoiceLineDto unitId(String unitId) {
    this.unitId = unitId;
    return this;
  }
  ...
  public InvoiceLineDto unitGroupId(String unitGroupId) {
  ...
  public InvoiceLineDto taxCalculationMethod(TaxCalculationMethodEnum taxCalculationMethod) {
  ...
  public InvoiceLineDto costCalculationMethod(CostCalculationMethodEnum costCalculationMethod) {
  ...
  public InvoiceLineDto forexRates(ForexRates forexRates) {
  ...
  public InvoiceLineDto forexRate(Double forexRate) {
  ...
  public InvoiceLineDto totalDetailInUsd(Double totalDetailInUsd) {
  ...
  public InvoiceLineDto totalProfitInUsd(Double totalProfitInUsd) {
  ...
  public InvoiceLineDto totalDiscountsInUsd(Double totalDiscountsInUsd) {
  ...
  public InvoiceLineDto totalSurchargesInUsd(Double totalSurchargesInUsd) {
  ...
  public InvoiceLineDto totalTaxBaseInUsd(Double totalTaxBaseInUsd) {
  ...
  public InvoiceLineDto totalTaxesInUsd(Double totalTaxesInUsd) {
  ...
  public InvoiceLineDto totalWithheldTaxesInUsd(Double totalWithheldTaxesInUsd) {
  ...
  public InvoiceLineDto totalShippingCostInUsd(Double totalShippingCostInUsd) {
  ...
  public InvoiceLineDto totalShippingTaxesInUsd(Double totalShippingTaxesInUsd) {
  ...
  public InvoiceLineDto totalWarrantyCostInUsd(Double totalWarrantyCostInUsd) {
  ...
  public InvoiceLineDto totalReturnCostInUsd(Double totalReturnCostInUsd) {
  ...
  public InvoiceLineDto totalRefundCostInUsd(Double totalRefundCostInUsd) {
  ...
  public InvoiceLineDto totalInUsd(Double totalInUsd) {
  ...
  public InvoiceLineDto totalGlobalDiscountsInUsd(Double totalGlobalDiscountsInUsd) {
  ...
  public InvoiceLineDto totalGlobalSurchargesInUsd(Double totalGlobalSurchargesInUsd) {
  ...
  public InvoiceLineDto customGlobalSurchargesAmount(Double customGlobalSurchargesAmount) {
  ...
  public InvoiceLineDto customGlobalDiscountsAmount(Double customGlobalDiscountsAmount) {
  ...
  public InvoiceLineDto returnPolicyId(String returnPolicyId) {
  ...
  public InvoiceLineDto refundPolicyId(String refundPolicyId) {
  ...
  public InvoiceLineDto warrantyPolicyId(String warrantyPolicyId) {
  ...
  public InvoiceLineDto shipmentPolicyId(String shipmentPolicyId) {
  ...
  public InvoiceLineDto shippingLocationId(String shippingLocationId) {
  ...
  public InvoiceLineDto locationId(String locationId) {
  ...
  public InvoiceLineDto quoteItemRecordId(String quoteItemRecordId) {
  ...
  public InvoiceLineDto businessProfileRecordId(String businessProfileRecordId) {
  ...
  public InvoiceLineDto parentBillingItemRecordId(String parentBillingItemRecordId) {
  ...
  public InvoiceLineDto currency(CurrencyId currency) {
  ...
  public InvoiceLineDto totalDetail(Double totalDetail) {
  ...
  public InvoiceLineDto totalDetailCurrencyId(String totalDetailCurrencyId) {
  ...
  public InvoiceLineDto totalDetailAmount(Money totalDetailAmount) {
  ...
  public InvoiceLineDto totalProfit(Double totalProfit) {
  ...
  public InvoiceLineDto totalProfitCurrencyId(String totalProfitCurrencyId) {
  ...
  public InvoiceLineDto totalProfitAmount(Money totalProfitAmount) {
  ...
  public InvoiceLineDto totalDiscounts(Double totalDiscounts) {
  ...
  public InvoiceLineDto totalDiscountsCurrencyId(String totalDiscountsCurrencyId) {
  ...
  public InvoiceLineDto totalDiscountsAmount(Money totalDiscountsAmount) {
  ...
  public InvoiceLineDto totalSurcharges(Double totalSurcharges) {
  ...
  public InvoiceLineDto totalSurchargesCurrencyId(String totalSurchargesCurrencyId) {
  ...
  public InvoiceLineDto totalSurchargesAmount(Money totalSurchargesAmount) {
  ...
  public InvoiceLineDto totalTaxBase(Double totalTaxBase) {
  ...
  public InvoiceLineDto totalTaxBaseCurrencyId(String totalTaxBaseCurrencyId) {
  ...
  public InvoiceLineDto totalTaxBaseAmount(Money totalTaxBaseAmount) {
  ...
  public InvoiceLineDto totalTaxes(Double totalTaxes) {
  ...
  public InvoiceLineDto totalTaxesCurrencyId(String totalTaxesCurrencyId) {
  ...
  public InvoiceLineDto totalTaxesAmount(Money totalTaxesAmount) {
  ...
  public InvoiceLineDto totalShippingCost(Double totalShippingCost) {
  ...
  public InvoiceLineDto totalShippingCostCurrencyId(String totalShippingCostCurrencyId) {
  ...
  public InvoiceLineDto totalShippingCostAmount(Money totalShippingCostAmount) {
  ...
  public InvoiceLineDto totalShippingTax(Double totalShippingTax) {
  ...
  public InvoiceLineDto totalShippingTaxCurrencyId(String totalShippingTaxCurrencyId) {
  ...
  public InvoiceLineDto totalShippingTaxAmount(Money totalShippingTaxAmount) {
  ...
  public InvoiceLineDto totalWithheldTax(Double totalWithheldTax) {
  ...
  public InvoiceLineDto totalWithheldTaxCurrencyId(String totalWithheldTaxCurrencyId) {
  ...
  public InvoiceLineDto totalWithheldTaxAmount(Money totalWithheldTaxAmount) {
  ...
  public InvoiceLineDto totalGlobalDiscounts(Double totalGlobalDiscounts) {
  ...
  public InvoiceLineDto totalGlobalDiscountsCurrencyId(String totalGlobalDiscountsCurrencyId) {
  ...
  public InvoiceLineDto totalGlobalDiscountsAmount(Money totalGlobalDiscountsAmount) {
  ...
  public InvoiceLineDto totalGlobalSurcharges(Double totalGlobalSurcharges) {
  ...
  public InvoiceLineDto totalGlobalSurchargesCurrencyId(String totalGlobalSurchargesCurrencyId) {
  ...
  public InvoiceLineDto totalGlobalSurchargesAmount(Money totalGlobalSurchargesAmount) {
  ...
  public InvoiceLineDto total(Double total) {
    this.total = total;
    return this;
  }
  ...
  public InvoiceLineDto totalCurrencyId(String totalCurrencyId) {
  ...
  public InvoiceLineDto totalAmount(Money totalAmount) {
  ...
  public InvoiceLineDto invoiceId(String invoiceId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, invoiceLineDto.id) &&
        Objects.equals(this.timestamp, invoiceLineDto.timestamp) &&
        Objects.equals(this.closed, invoiceLineDto.closed) &&
        Objects.equals(this.itemId, invoiceLineDto.itemId) &&
        Objects.equals(this.itemTitle, invoiceLineDto.itemTitle) &&
        Objects.equals(this.itemShortDescription, invoiceLineDto.itemShortDescription) &&
        Objects.equals(this.itemPrimaryImageUrl, invoiceLineDto.itemPrimaryImageUrl) &&
        Objects.equals(this.shippingPolicyId, invoiceLineDto.shippingPolicyId) &&
        Objects.equals(this.tenantId, invoiceLineDto.tenantId) &&
        Objects.equals(this.enrollmentId, invoiceLineDto.enrollmentId) &&
        Objects.equals(this.currencyId, invoiceLineDto.currencyId) &&
        Objects.equals(this.description, invoiceLineDto.description) &&
        Objects.equals(this.quantity, invoiceLineDto.quantity) &&
        Objects.equals(this.free, invoiceLineDto.free) &&
        Objects.equals(this.freeReason, invoiceLineDto.freeReason) &&
        Objects.equals(this.freeReasonCode, invoiceLineDto.freeReasonCode) &&
        Objects.equals(this.data, invoiceLineDto.data) &&
        Objects.equals(this.dataLabel, invoiceLineDto.dataLabel) &&
        Objects.equals(this.data1, invoiceLineDto.data1) &&
        Objects.equals(this.data1Label, invoiceLineDto.data1Label) &&
        Objects.equals(this.data2, invoiceLineDto.data2) &&
        Objects.equals(this.data2Label, invoiceLineDto.data2Label) &&
        Objects.equals(this.data3, invoiceLineDto.data3) &&
        Objects.equals(this.data3Label, invoiceLineDto.data3Label) &&
        Objects.equals(this.data4, invoiceLineDto.data4) &&
        Objects.equals(this.data4Label, invoiceLineDto.data4Label) &&
        Objects.equals(this.data5, invoiceLineDto.data5) &&
        Objects.equals(this.data5Label, invoiceLineDto.data5Label) &&
        Objects.equals(this.data6, invoiceLineDto.data6) &&
        Objects.equals(this.data6Label, invoiceLineDto.data6Label) &&
        Objects.equals(this.data7, invoiceLineDto.data7) &&
        Objects.equals(this.data7Label, invoiceLineDto.data7Label) &&
        Objects.equals(this.data8, invoiceLineDto.data8) &&
        Objects.equals(this.data8Label, invoiceLineDto.data8Label) &&
        Objects.equals(this.data9, invoiceLineDto.data9) &&
        Objects.equals(this.data9Label, invoiceLineDto.data9Label) &&
        Objects.equals(this.itemPriceId, invoiceLineDto.itemPriceId) &&
        Objects.equals(this.priceListItemId, invoiceLineDto.priceListItemId) &&
        Objects.equals(this.unitId, invoiceLineDto.unitId) &&
        Objects.equals(this.unitGroupId, invoiceLineDto.unitGroupId) &&
        Objects.equals(this.taxCalculationMethod, invoiceLineDto.taxCalculationMethod) &&
        Objects.equals(this.costCalculationMethod, invoiceLineDto.costCalculationMethod) &&
        Objects.equals(this.forexRates, invoiceLineDto.forexRates) &&
        Objects.equals(this.forexRate, invoiceLineDto.forexRate) &&
        Objects.equals(this.totalDetailInUsd, invoiceLineDto.totalDetailInUsd) &&
        Objects.equals(this.totalProfitInUsd, invoiceLineDto.totalProfitInUsd) &&
        Objects.equals(this.totalDiscountsInUsd, invoiceLineDto.totalDiscountsInUsd) &&
        Objects.equals(this.totalSurchargesInUsd, invoiceLineDto.totalSurchargesInUsd) &&
        Objects.equals(this.totalTaxBaseInUsd, invoiceLineDto.totalTaxBaseInUsd) &&
        Objects.equals(this.totalTaxesInUsd, invoiceLineDto.totalTaxesInUsd) &&
        Objects.equals(this.totalWithheldTaxesInUsd, invoiceLineDto.totalWithheldTaxesInUsd) &&
        Objects.equals(this.totalShippingCostInUsd, invoiceLineDto.totalShippingCostInUsd) &&
        Objects.equals(this.totalShippingTaxesInUsd, invoiceLineDto.totalShippingTaxesInUsd) &&
        Objects.equals(this.totalWarrantyCostInUsd, invoiceLineDto.totalWarrantyCostInUsd) &&
        Objects.equals(this.totalReturnCostInUsd, invoiceLineDto.totalReturnCostInUsd) &&
        Objects.equals(this.totalRefundCostInUsd, invoiceLineDto.totalRefundCostInUsd) &&
        Objects.equals(this.totalInUsd, invoiceLineDto.totalInUsd) &&
        Objects.equals(this.totalGlobalDiscountsInUsd, invoiceLineDto.totalGlobalDiscountsInUsd) &&
        Objects.equals(this.totalGlobalSurchargesInUsd, invoiceLineDto.totalGlobalSurchargesInUsd) &&
        Objects.equals(this.customGlobalSurchargesAmount, invoiceLineDto.customGlobalSurchargesAmount) &&
        Objects.equals(this.customGlobalDiscountsAmount, invoiceLineDto.customGlobalDiscountsAmount) &&
        Objects.equals(this.returnPolicyId, invoiceLineDto.returnPolicyId) &&
        Objects.equals(this.refundPolicyId, invoiceLineDto.refundPolicyId) &&
        Objects.equals(this.warrantyPolicyId, invoiceLineDto.warrantyPolicyId) &&
        Objects.equals(this.shipmentPolicyId, invoiceLineDto.shipmentPolicyId) &&
        Objects.equals(this.shippingLocationId, invoiceLineDto.shippingLocationId) &&
        Objects.equals(this.locationId, invoiceLineDto.locationId) &&
        Objects.equals(this.quoteItemRecordId, invoiceLineDto.quoteItemRecordId) &&
        Objects.equals(this.businessProfileRecordId, invoiceLineDto.businessProfileRecordId) &&
        Objects.equals(this.parentBillingItemRecordId, invoiceLineDto.parentBillingItemRecordId) &&
        Objects.equals(this.currency, invoiceLineDto.currency) &&
        Objects.equals(this.totalDetail, invoiceLineDto.totalDetail) &&
        Objects.equals(this.totalDetailCurrencyId, invoiceLineDto.totalDetailCurrencyId) &&
        Objects.equals(this.totalDetailAmount, invoiceLineDto.totalDetailAmount) &&
        Objects.equals(this.totalProfit, invoiceLineDto.totalProfit) &&
        Objects.equals(this.totalProfitCurrencyId, invoiceLineDto.totalProfitCurrencyId) &&
        Objects.equals(this.totalProfitAmount, invoiceLineDto.totalProfitAmount) &&
        Objects.equals(this.totalDiscounts, invoiceLineDto.totalDiscounts) &&
        Objects.equals(this.totalDiscountsCurrencyId, invoiceLineDto.totalDiscountsCurrencyId) &&
        Objects.equals(this.totalDiscountsAmount, invoiceLineDto.totalDiscountsAmount) &&
        Objects.equals(this.totalSurcharges, invoiceLineDto.totalSurcharges) &&
        Objects.equals(this.totalSurchargesCurrencyId, invoiceLineDto.totalSurchargesCurrencyId) &&
        Objects.equals(this.totalSurchargesAmount, invoiceLineDto.totalSurchargesAmount) &&
        Objects.equals(this.totalTaxBase, invoiceLineDto.totalTaxBase) &&
        Objects.equals(this.totalTaxBaseCurrencyId, invoiceLineDto.totalTaxBaseCurrencyId) &&
        Objects.equals(this.totalTaxBaseAmount, invoiceLineDto.totalTaxBaseAmount) &&
        Objects.equals(this.totalTaxes, invoiceLineDto.totalTaxes) &&
        Objects.equals(this.totalTaxesCurrencyId, invoiceLineDto.totalTaxesCurrencyId) &&
        Objects.equals(this.totalTaxesAmount, invoiceLineDto.totalTaxesAmount) &&
        Objects.equals(this.totalShippingCost, invoiceLineDto.totalShippingCost) &&
        Objects.equals(this.totalShippingCostCurrencyId, invoiceLineDto.totalShippingCostCurrencyId) &&
        Objects.equals(this.totalShippingCostAmount, invoiceLineDto.totalShippingCostAmount) &&
        Objects.equals(this.totalShippingTax, invoiceLineDto.totalShippingTax) &&
        Objects.equals(this.totalShippingTaxCurrencyId, invoiceLineDto.totalShippingTaxCurrencyId) &&
        Objects.equals(this.totalShippingTaxAmount, invoiceLineDto.totalShippingTaxAmount) &&
        Objects.equals(this.totalWithheldTax, invoiceLineDto.totalWithheldTax) &&
        Objects.equals(this.totalWithheldTaxCurrencyId, invoiceLineDto.totalWithheldTaxCurrencyId) &&
        Objects.equals(this.totalWithheldTaxAmount, invoiceLineDto.totalWithheldTaxAmount) &&
        Objects.equals(this.totalGlobalDiscounts, invoiceLineDto.totalGlobalDiscounts) &&
        Objects.equals(this.totalGlobalDiscountsCurrencyId, invoiceLineDto.totalGlobalDiscountsCurrencyId) &&
        Objects.equals(this.totalGlobalDiscountsAmount, invoiceLineDto.totalGlobalDiscountsAmount) &&
        Objects.equals(this.totalGlobalSurcharges, invoiceLineDto.totalGlobalSurcharges) &&
        Objects.equals(this.totalGlobalSurchargesCurrencyId, invoiceLineDto.totalGlobalSurchargesCurrencyId) &&
        Objects.equals(this.totalGlobalSurchargesAmount, invoiceLineDto.totalGlobalSurchargesAmount) &&
        Objects.equals(this.total, invoiceLineDto.total) &&
        Objects.equals(this.totalCurrencyId, invoiceLineDto.totalCurrencyId) &&
        Objects.equals(this.totalAmount, invoiceLineDto.totalAmount) &&
        Objects.equals(this.invoiceId, invoiceLineDto.invoiceId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InvoiceLineDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InvoiceLineDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoiceLineDto is not found in the empty JSON string", InvoiceLineDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InvoiceLineDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InvoiceLineDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoiceLineDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoiceLineDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoiceLineDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoiceLineDto.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoiceLineDto>() {
           @Override
           public void write(JsonWriter out, InvoiceLineDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InvoiceLineDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InvoiceLineDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InvoiceLineDto
   * @throws IOException if the JSON string is invalid with respect to InvoiceLineDto
   */
  public static InvoiceLineDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoiceLineDto.class);
  }

  /**
   * Convert an instance of InvoiceLineDto to an JSON string
   *
   * @return JSON string
   */
