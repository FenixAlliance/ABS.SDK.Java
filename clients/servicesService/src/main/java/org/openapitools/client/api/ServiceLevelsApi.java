...
public class ServiceLevelsApi {
    ...
    /**
     * Build call for patchServiceLevelAsync
     * @param tenantId  (required)
     * @param serviceId  (required)
     * @param serviceLevelId  (required)
     * @param apiVersion  (optional)
    ...
    private okhttp3.Call patchServiceLevelAsyncValidateBeforeCall(UUID tenantId, UUID serviceId, UUID serviceLevelId, String apiVersion, String xApiVersion, List<Operation> operation, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'serviceId' is set
        if (serviceId == null) {
            throw new ApiException("Missing the required parameter 'serviceId' when calling patchServiceLevelAsync(Async)");
        }
    ...
    /**
     * Patch a service level (asynchronously)
     * Partially updates an existing service level using a JSON Patch document.
     * @param tenantId  (required)
     * @param serviceId  (required)
     * @param serviceLevelId  (required)
