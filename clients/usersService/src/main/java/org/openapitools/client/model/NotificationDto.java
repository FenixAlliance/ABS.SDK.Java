...
public class NotificationDto {
  ...
  public NotificationDto imageUrl(String imageUrl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, notificationDto.id) &&
        ...
        Objects.equals(this.imageUrl, notificationDto.imageUrl) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, read, icon, message, imageUrl, redirectUrl, type, socialProfileId, readTimestamp, issuedTimestamp);
  }
