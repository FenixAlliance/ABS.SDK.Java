...
public class UsersApi {
     ...
     */
    public TenantEnrollmentDtoListEnvelope getCurrentUserEnrollmentsAsync(String apiVersion, String xApiVersion) throws ApiException {
        ApiResponse<TenantEnrollmentDtoListEnvelope> localVarResp = getCurrentUserEnrollmentsAsyncWithHttpInfo(apiVersion, xApiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TenantEnrollmentDtoListEnvelope> getCurrentUserEnrollmentsAsyncWithHttpInfo(String apiVersion, String xApiVersion) throws ApiException {
     ...
     */
    public okhttp3.Call getCurrentUserEnrollmentsAsyncAsync(String apiVersion, String xApiVersion, final ApiCallback<TenantEnrollmentDtoListEnvelope> _callback) throws ApiException {
     ...
     */
    public ExtendedTenantEnrollmentDtoListEnvelope getCurrentUserEnrollmentsExtendedAsync(String apiVersion, String xApiVersion) throws ApiException {
        ApiResponse<ExtendedTenantEnrollmentDtoListEnvelope> localVarResp = getCurrentUserEnrollmentsExtendedAsyncWithHttpInfo(apiVersion, xApiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ExtendedTenantEnrollmentDtoListEnvelope> getCurrentUserEnrollmentsExtendedAsyncWithHttpInfo(String apiVersion, String xApiVersion) throws ApiException {
        okhttp3.Call localVarCall = getCurrentUserEnrollmentsExtendedAsyncValidateBeforeCall(apiVersion, xApiVersion, null);
        Type localVarReturnType = new TypeToken<ExtendedTenantEnrollmentDtoListEnvelope>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getCurrentUserEnrollmentsExtendedAsyncAsync(String apiVersion, String xApiVersion, final ApiCallback<ExtendedTenantEnrollmentDtoListEnvelope> _callback) throws ApiException {
    ...
    public okhttp3.Call getCurrentUserTenantsExtendedAsyncCall(String apiVersion, String xApiVersion, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/Me/Tenants/Extended";
    ...
    /**
     * Build call for getEnrollmentAsync
     ...
     */
    public okhttp3.Call getEnrollmentAsyncCall(UUID enrollmentId, String apiVersion, String xApiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getEnrollmentAsyncValidateBeforeCall(UUID enrollmentId, String apiVersion, String xApiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'enrollmentId' is set
        if (enrollmentId == null) {
            throw new ApiException("Missing the required parameter 'enrollmentId' when calling getEnrollmentAsync(Async)");
        }

        return getEnrollmentAsyncCall(enrollmentId, apiVersion, xApiVersion, _callback);
     ...
     */
    public TenantEnrollmentDtoEnvelope getEnrollmentAsync(UUID enrollmentId, String apiVersion, String xApiVersion) throws ApiException {
        ApiResponse<TenantEnrollmentDtoEnvelope> localVarResp = getEnrollmentAsyncWithHttpInfo(enrollmentId, apiVersion, xApiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TenantEnrollmentDtoEnvelope> getEnrollmentAsyncWithHttpInfo(UUID enrollmentId, String apiVersion, String xApiVersion) throws ApiException {
        okhttp3.Call localVarCall = getEnrollmentAsyncValidateBeforeCall(enrollmentId, apiVersion, xApiVersion, null);
     ...
     */
    public okhttp3.Call getEnrollmentAsyncAsync(UUID enrollmentId, String apiVersion, String xApiVersion, final ApiCallback<TenantEnrollmentDtoEnvelope> _callback) throws ApiException {

        okhttp3.Call localVarCall = getEnrollmentAsyncValidateBeforeCall(enrollmentId, apiVersion, xApiVersion, _callback);
        Type localVarReturnType = new TypeToken<TenantEnrollmentDtoEnvelope>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
