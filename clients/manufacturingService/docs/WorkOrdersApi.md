...
import org.openapitools.client.api.WorkOrdersApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    WorkOrdersApi apiInstance = new WorkOrdersApi(defaultClient);
    UUID tenantId = UUID.randomUUID(); // UUID | 
    String apiVersion = "apiVersion_example"; // String | 
    String xApiVersion = "xApiVersion_example"; // String | 
    WorkOrderCreateDto workOrderCreateDto = new WorkOrderCreateDto(); // WorkOrderCreateDto | 
    try {
      apiInstance.createWorkOrderAsync(tenantId, apiVersion, xApiVersion, workOrderCreateDto);
    } catch (ApiException e) {
      System.err.println("Exception when calling WorkOrdersApi#createWorkOrderAsync");
...
> deleteWorkOrderAsync(tenantId, id, apiVersion, xApiVersion)
...
public class Example {
  public static void main(String[] args) {
    ...
    String xApiVersion = "xApiVersion_example"; // String | 
    try {
      apiInstance.deleteWorkOrderAsync(tenantId, id, apiVersion, xApiVersion);
    } catch (ApiException e) {
      System.err.println("Exception when calling WorkOrdersApi#deleteWorkOrderAsync");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> WorkOrderDto getWorkOrderByIdAsync(tenantId, id, apiVersion, xApiVersion)
...
public class Example {
  public static void main(String[] args) {
    ...
    String xApiVersion = "xApiVersion_example"; // String | 
    try {
      WorkOrderDto result = apiInstance.getWorkOrderByIdAsync(tenantId, id, apiVersion, xApiVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling WorkOrdersApi#getWorkOrderByIdAsync");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> updateWorkOrderAsync(tenantId, id, apiVersion, xApiVersion, workOrderUpdateDto)
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | 
    String xApiVersion = "xApiVersion_example"; // String | 
    WorkOrderUpdateDto workOrderUpdateDto = new WorkOrderUpdateDto(); // WorkOrderUpdateDto | 
    try {
      apiInstance.updateWorkOrderAsync(tenantId, id, apiVersion, xApiVersion, workOrderUpdateDto);
    } catch (ApiException e) {
      System.err.println("Exception when calling WorkOrdersApi#updateWorkOrderAsync");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
