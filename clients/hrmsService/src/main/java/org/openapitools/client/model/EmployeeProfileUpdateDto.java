...
public class EmployeeProfileUpdateDto {
  ...
  public EmployeeProfileUpdateDto type(String type) {
    this.type = type;
    return this;
  }
  ...
  public EmployeeProfileUpdateDto contactId(String contactId) {
  ...
  public EmployeeProfileUpdateDto about(String about) {
    this.about = about;
    return this;
  }
  ...
  public EmployeeProfileUpdateDto avatarUrl(String avatarUrl) {
  ...
  public EmployeeProfileUpdateDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public EmployeeProfileUpdateDto dataLabel(String dataLabel) {
  ...
  public EmployeeProfileUpdateDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public EmployeeProfileUpdateDto data1Label(String data1Label) {
  ...
  public EmployeeProfileUpdateDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public EmployeeProfileUpdateDto data2Label(String data2Label) {
  ...
  public EmployeeProfileUpdateDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public EmployeeProfileUpdateDto data3Label(String data3Label) {
  ...
  public EmployeeProfileUpdateDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public EmployeeProfileUpdateDto data4Label(String data4Label) {
  ...
  public EmployeeProfileUpdateDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public EmployeeProfileUpdateDto data5Label(String data5Label) {
  ...
  public EmployeeProfileUpdateDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public EmployeeProfileUpdateDto data6Label(String data6Label) {
  ...
  public EmployeeProfileUpdateDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public EmployeeProfileUpdateDto data7Label(String data7Label) {
  ...
  public EmployeeProfileUpdateDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public EmployeeProfileUpdateDto data8Label(String data8Label) {
  ...
  public EmployeeProfileUpdateDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public EmployeeProfileUpdateDto data9Label(String data9Label) {
  ...
  public EmployeeProfileUpdateDto grossPay(Double grossPay) {
  ...
  public EmployeeProfileUpdateDto netSalary(Double netSalary) {
  ...
  public EmployeeProfileUpdateDto payrollCurrency(String payrollCurrency) {
  ...
  public EmployeeProfileUpdateDto maxWorkHoursPerDay(Integer maxWorkHoursPerDay) {
  ...
  public EmployeeProfileUpdateDto jobTitleId(String jobTitleId) {
  ...
  public EmployeeProfileUpdateDto employeeTypeId(String employeeTypeId) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeProfileUpdateDto employeeProfileUpdateDto = (EmployeeProfileUpdateDto) o;
    return Objects.equals(this.type, employeeProfileUpdateDto.type) &&
        Objects.equals(this.contactId, employeeProfileUpdateDto.contactId) &&
        Objects.equals(this.about, employeeProfileUpdateDto.about) &&
        Objects.equals(this.avatarUrl, employeeProfileUpdateDto.avatarUrl) &&
        Objects.equals(this.data, employeeProfileUpdateDto.data) &&
        Objects.equals(this.dataLabel, employeeProfileUpdateDto.dataLabel) &&
        Objects.equals(this.data1, employeeProfileUpdateDto.data1) &&
        Objects.equals(this.data1Label, employeeProfileUpdateDto.data1Label) &&
        Objects.equals(this.data2, employeeProfileUpdateDto.data2) &&
        Objects.equals(this.data2Label, employeeProfileUpdateDto.data2Label) &&
        Objects.equals(this.data3, employeeProfileUpdateDto.data3) &&
        Objects.equals(this.data3Label, employeeProfileUpdateDto.data3Label) &&
        Objects.equals(this.data4, employeeProfileUpdateDto.data4) &&
        Objects.equals(this.data4Label, employeeProfileUpdateDto.data4Label) &&
        Objects.equals(this.data5, employeeProfileUpdateDto.data5) &&
        Objects.equals(this.data5Label, employeeProfileUpdateDto.data5Label) &&
        Objects.equals(this.data6, employeeProfileUpdateDto.data6) &&
        Objects.equals(this.data6Label, employeeProfileUpdateDto.data6Label) &&
        Objects.equals(this.data7, employeeProfileUpdateDto.data7) &&
        Objects.equals(this.data7Label, employeeProfileUpdateDto.data7Label) &&
        Objects.equals(this.data8, employeeProfileUpdateDto.data8) &&
        Objects.equals(this.data8Label, employeeProfileUpdateDto.data8Label) &&
        Objects.equals(this.data9, employeeProfileUpdateDto.data9) &&
        Objects.equals(this.data9Label, employeeProfileUpdateDto.data9Label) &&
        Objects.equals(this.grossPay, employeeProfileUpdateDto.grossPay) &&
        Objects.equals(this.netSalary, employeeProfileUpdateDto.netSalary) &&
        Objects.equals(this.payrollCurrency, employeeProfileUpdateDto.payrollCurrency) &&
        Objects.equals(this.maxWorkHoursPerDay, employeeProfileUpdateDto.maxWorkHoursPerDay) &&
        Objects.equals(this.jobTitleId, employeeProfileUpdateDto.jobTitleId) &&
        Objects.equals(this.employeeTypeId, employeeProfileUpdateDto.employeeTypeId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, contactId, about, avatarUrl, data, dataLabel, data1, data1Label, data2, data2Label, data3, data3Label, data4, data4Label, data5, data5Label, data6, data6Label, data7, data7Label, data8, data8Label, data9, data9Label, grossPay, netSalary, payrollCurrency, maxWorkHoursPerDay, jobTitleId, employeeTypeId);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeProfileUpdateDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeProfileUpdateDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeProfileUpdateDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeProfileUpdateDto is not found in the empty JSON string", EmployeeProfileUpdateDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeeProfileUpdateDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeeProfileUpdateDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeProfileUpdateDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeProfileUpdateDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeProfileUpdateDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeProfileUpdateDto.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeProfileUpdateDto>() {
           @Override
           public void write(JsonWriter out, EmployeeProfileUpdateDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeeProfileUpdateDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeeProfileUpdateDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeeProfileUpdateDto
   * @throws IOException if the JSON string is invalid with respect to EmployeeProfileUpdateDto
   */
  public static EmployeeProfileUpdateDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeProfileUpdateDto.class);
  }

  /**
   * Convert an instance of EmployeeProfileUpdateDto to an JSON string
   *
   * @return JSON string
   */
