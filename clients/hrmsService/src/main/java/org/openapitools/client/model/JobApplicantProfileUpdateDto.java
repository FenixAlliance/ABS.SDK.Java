...
public class JobApplicantProfileUpdateDto {
  ...
  public JobApplicantProfileUpdateDto() {
  }

  public JobApplicantProfileUpdateDto type(String type) {
    this.type = type;
    return this;
  }
  ...
  public JobApplicantProfileUpdateDto contactId(String contactId) {
  ...
  public JobApplicantProfileUpdateDto about(String about) {
    this.about = about;
    return this;
  }
  ...
  public JobApplicantProfileUpdateDto avatarUrl(String avatarUrl) {
  ...
  public JobApplicantProfileUpdateDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public JobApplicantProfileUpdateDto dataLabel(String dataLabel) {
  ...
  public JobApplicantProfileUpdateDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public JobApplicantProfileUpdateDto data1Label(String data1Label) {
  ...
  public JobApplicantProfileUpdateDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public JobApplicantProfileUpdateDto data2Label(String data2Label) {
  ...
  public JobApplicantProfileUpdateDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public JobApplicantProfileUpdateDto data3Label(String data3Label) {
  ...
  public JobApplicantProfileUpdateDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public JobApplicantProfileUpdateDto data4Label(String data4Label) {
  ...
  public JobApplicantProfileUpdateDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public JobApplicantProfileUpdateDto data5Label(String data5Label) {
  ...
  public JobApplicantProfileUpdateDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public JobApplicantProfileUpdateDto data6Label(String data6Label) {
  ...
  public JobApplicantProfileUpdateDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public JobApplicantProfileUpdateDto data7Label(String data7Label) {
  ...
  public JobApplicantProfileUpdateDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public JobApplicantProfileUpdateDto data8Label(String data8Label) {
  ...
  public JobApplicantProfileUpdateDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public JobApplicantProfileUpdateDto data9Label(String data9Label) {
  ...
  public JobApplicantProfileUpdateDto availableForHire(Boolean availableForHire) {
  ...
  public JobApplicantProfileUpdateDto careerLevel(CareerLevelEnum careerLevel) {
  ...
  public JobApplicantProfileUpdateDto experienceInYears(Integer experienceInYears) {
  ...
  public JobApplicantProfileUpdateDto currentSalary(Double currentSalary) {
  ...
  public JobApplicantProfileUpdateDto minSalaryExpectation(Double minSalaryExpectation) {
  ...
  public JobApplicantProfileUpdateDto maxSalaryExpectation(Double maxSalaryExpectation) {
  ...
  public JobApplicantProfileUpdateDto currencyId(String currencyId) {
  ...
  public boolean equals(Object o) {
    ...
    JobApplicantProfileUpdateDto jobApplicantProfileUpdateDto = (JobApplicantProfileUpdateDto) o;
    return Objects.equals(this.type, jobApplicantProfileUpdateDto.type) &&
        Objects.equals(this.contactId, jobApplicantProfileUpdateDto.contactId) &&
        Objects.equals(this.about, jobApplicantProfileUpdateDto.about) &&
        Objects.equals(this.avatarUrl, jobApplicantProfileUpdateDto.avatarUrl) &&
        Objects.equals(this.data, jobApplicantProfileUpdateDto.data) &&
        Objects.equals(this.dataLabel, jobApplicantProfileUpdateDto.dataLabel) &&
        Objects.equals(this.data1, jobApplicantProfileUpdateDto.data1) &&
        Objects.equals(this.data1Label, jobApplicantProfileUpdateDto.data1Label) &&
        Objects.equals(this.data2, jobApplicantProfileUpdateDto.data2) &&
        Objects.equals(this.data2Label, jobApplicantProfileUpdateDto.data2Label) &&
        Objects.equals(this.data3, jobApplicantProfileUpdateDto.data3) &&
        Objects.equals(this.data3Label, jobApplicantProfileUpdateDto.data3Label) &&
        Objects.equals(this.data4, jobApplicantProfileUpdateDto.data4) &&
        Objects.equals(this.data4Label, jobApplicantProfileUpdateDto.data4Label) &&
        Objects.equals(this.data5, jobApplicantProfileUpdateDto.data5) &&
        Objects.equals(this.data5Label, jobApplicantProfileUpdateDto.data5Label) &&
        Objects.equals(this.data6, jobApplicantProfileUpdateDto.data6) &&
        Objects.equals(this.data6Label, jobApplicantProfileUpdateDto.data6Label) &&
        Objects.equals(this.data7, jobApplicantProfileUpdateDto.data7) &&
        Objects.equals(this.data7Label, jobApplicantProfileUpdateDto.data7Label) &&
        Objects.equals(this.data8, jobApplicantProfileUpdateDto.data8) &&
        Objects.equals(this.data8Label, jobApplicantProfileUpdateDto.data8Label) &&
        Objects.equals(this.data9, jobApplicantProfileUpdateDto.data9) &&
        Objects.equals(this.data9Label, jobApplicantProfileUpdateDto.data9Label) &&
        Objects.equals(this.availableForHire, jobApplicantProfileUpdateDto.availableForHire) &&
        Objects.equals(this.careerLevel, jobApplicantProfileUpdateDto.careerLevel) &&
        Objects.equals(this.experienceInYears, jobApplicantProfileUpdateDto.experienceInYears) &&
        Objects.equals(this.currentSalary, jobApplicantProfileUpdateDto.currentSalary) &&
        Objects.equals(this.minSalaryExpectation, jobApplicantProfileUpdateDto.minSalaryExpectation) &&
        Objects.equals(this.maxSalaryExpectation, jobApplicantProfileUpdateDto.maxSalaryExpectation) &&
        Objects.equals(this.currencyId, jobApplicantProfileUpdateDto.currencyId);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobApplicantProfileUpdateDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to JobApplicantProfileUpdateDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JobApplicantProfileUpdateDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JobApplicantProfileUpdateDto is not found in the empty JSON string", JobApplicantProfileUpdateDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JobApplicantProfileUpdateDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JobApplicantProfileUpdateDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JobApplicantProfileUpdateDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JobApplicantProfileUpdateDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JobApplicantProfileUpdateDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JobApplicantProfileUpdateDto.class));

       return (TypeAdapter<T>) new TypeAdapter<JobApplicantProfileUpdateDto>() {
           @Override
           public void write(JsonWriter out, JobApplicantProfileUpdateDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JobApplicantProfileUpdateDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JobApplicantProfileUpdateDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JobApplicantProfileUpdateDto
   * @throws IOException if the JSON string is invalid with respect to JobApplicantProfileUpdateDto
   */
  public static JobApplicantProfileUpdateDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JobApplicantProfileUpdateDto.class);
  }

  /**
   * Convert an instance of JobApplicantProfileUpdateDto to an JSON string
   *
   * @return JSON string
   */
