...
public class EmployerProfileCreateDto {
  ...
  public EmployerProfileCreateDto id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public EmployerProfileCreateDto timestamp(OffsetDateTime timestamp) {
  ...
  public EmployerProfileCreateDto type(String type) {
    this.type = type;
    return this;
  }
  ...
  public EmployerProfileCreateDto contactId(String contactId) {
  ...
  public EmployerProfileCreateDto contact(ContactCreateDto contact) {
  ...
  public EmployerProfileCreateDto about(String about) {
    this.about = about;
    return this;
  }
  ...
  public EmployerProfileCreateDto avatarUrl(String avatarUrl) {
  ...
  public EmployerProfileCreateDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public EmployerProfileCreateDto dataLabel(String dataLabel) {
  ...
  public EmployerProfileCreateDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public EmployerProfileCreateDto data1Label(String data1Label) {
  ...
  public EmployerProfileCreateDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public EmployerProfileCreateDto data2Label(String data2Label) {
  ...
  public EmployerProfileCreateDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public EmployerProfileCreateDto data3Label(String data3Label) {
  ...
  public EmployerProfileCreateDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public EmployerProfileCreateDto data4Label(String data4Label) {
  ...
  public EmployerProfileCreateDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public EmployerProfileCreateDto data5Label(String data5Label) {
  ...
  public EmployerProfileCreateDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public EmployerProfileCreateDto data6Label(String data6Label) {
  ...
  public EmployerProfileCreateDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public EmployerProfileCreateDto data7Label(String data7Label) {
  ...
  public EmployerProfileCreateDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public EmployerProfileCreateDto data8Label(String data8Label) {
  ...
  public EmployerProfileCreateDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public EmployerProfileCreateDto data9Label(String data9Label) {
  ...
  public boolean equals(Object o) {
    ...
    EmployerProfileCreateDto employerProfileCreateDto = (EmployerProfileCreateDto) o;
    return Objects.equals(this.id, employerProfileCreateDto.id) &&
        Objects.equals(this.timestamp, employerProfileCreateDto.timestamp) &&
        Objects.equals(this.type, employerProfileCreateDto.type) &&
        Objects.equals(this.contactId, employerProfileCreateDto.contactId) &&
        Objects.equals(this.contact, employerProfileCreateDto.contact) &&
        Objects.equals(this.about, employerProfileCreateDto.about) &&
        Objects.equals(this.avatarUrl, employerProfileCreateDto.avatarUrl) &&
        Objects.equals(this.data, employerProfileCreateDto.data) &&
        Objects.equals(this.dataLabel, employerProfileCreateDto.dataLabel) &&
        Objects.equals(this.data1, employerProfileCreateDto.data1) &&
        Objects.equals(this.data1Label, employerProfileCreateDto.data1Label) &&
        Objects.equals(this.data2, employerProfileCreateDto.data2) &&
        Objects.equals(this.data2Label, employerProfileCreateDto.data2Label) &&
        Objects.equals(this.data3, employerProfileCreateDto.data3) &&
        Objects.equals(this.data3Label, employerProfileCreateDto.data3Label) &&
        Objects.equals(this.data4, employerProfileCreateDto.data4) &&
        Objects.equals(this.data4Label, employerProfileCreateDto.data4Label) &&
        Objects.equals(this.data5, employerProfileCreateDto.data5) &&
        Objects.equals(this.data5Label, employerProfileCreateDto.data5Label) &&
        Objects.equals(this.data6, employerProfileCreateDto.data6) &&
        Objects.equals(this.data6Label, employerProfileCreateDto.data6Label) &&
        Objects.equals(this.data7, employerProfileCreateDto.data7) &&
        Objects.equals(this.data7Label, employerProfileCreateDto.data7Label) &&
        Objects.equals(this.data8, employerProfileCreateDto.data8) &&
        Objects.equals(this.data8Label, employerProfileCreateDto.data8Label) &&
        Objects.equals(this.data9, employerProfileCreateDto.data9) &&
        Objects.equals(this.data9Label, employerProfileCreateDto.data9Label);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployerProfileCreateDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployerProfileCreateDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployerProfileCreateDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployerProfileCreateDto is not found in the empty JSON string", EmployerProfileCreateDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployerProfileCreateDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployerProfileCreateDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployerProfileCreateDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployerProfileCreateDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployerProfileCreateDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployerProfileCreateDto.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployerProfileCreateDto>() {
           @Override
           public void write(JsonWriter out, EmployerProfileCreateDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployerProfileCreateDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployerProfileCreateDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployerProfileCreateDto
   * @throws IOException if the JSON string is invalid with respect to EmployerProfileCreateDto
   */
  public static EmployerProfileCreateDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployerProfileCreateDto.class);
  }

  /**
   * Convert an instance of EmployerProfileCreateDto to an JSON string
   *
   * @return JSON string
   */
