...
public class EmployerProfileUpdateDto {
  ...
  public EmployerProfileUpdateDto() {
  }

  public EmployerProfileUpdateDto type(String type) {
    this.type = type;
    return this;
  }
  ...
  public EmployerProfileUpdateDto contactId(String contactId) {
  ...
  public EmployerProfileUpdateDto about(String about) {
    this.about = about;
    return this;
  }
  ...
  public EmployerProfileUpdateDto avatarUrl(String avatarUrl) {
  ...
  public EmployerProfileUpdateDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public EmployerProfileUpdateDto dataLabel(String dataLabel) {
  ...
  public EmployerProfileUpdateDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public EmployerProfileUpdateDto data1Label(String data1Label) {
  ...
  public EmployerProfileUpdateDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public EmployerProfileUpdateDto data2Label(String data2Label) {
  ...
  public EmployerProfileUpdateDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public EmployerProfileUpdateDto data3Label(String data3Label) {
  ...
  public EmployerProfileUpdateDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public EmployerProfileUpdateDto data4Label(String data4Label) {
  ...
  public EmployerProfileUpdateDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public EmployerProfileUpdateDto data5Label(String data5Label) {
  ...
  public EmployerProfileUpdateDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public EmployerProfileUpdateDto data6Label(String data6Label) {
  ...
  public EmployerProfileUpdateDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public EmployerProfileUpdateDto data7Label(String data7Label) {
  ...
  public EmployerProfileUpdateDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public EmployerProfileUpdateDto data8Label(String data8Label) {
  ...
  public EmployerProfileUpdateDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public EmployerProfileUpdateDto data9Label(String data9Label) {
  ...
  public boolean equals(Object o) {
    ...
    EmployerProfileUpdateDto employerProfileUpdateDto = (EmployerProfileUpdateDto) o;
    return Objects.equals(this.type, employerProfileUpdateDto.type) &&
        Objects.equals(this.contactId, employerProfileUpdateDto.contactId) &&
        Objects.equals(this.about, employerProfileUpdateDto.about) &&
        Objects.equals(this.avatarUrl, employerProfileUpdateDto.avatarUrl) &&
        Objects.equals(this.data, employerProfileUpdateDto.data) &&
        Objects.equals(this.dataLabel, employerProfileUpdateDto.dataLabel) &&
        Objects.equals(this.data1, employerProfileUpdateDto.data1) &&
        Objects.equals(this.data1Label, employerProfileUpdateDto.data1Label) &&
        Objects.equals(this.data2, employerProfileUpdateDto.data2) &&
        Objects.equals(this.data2Label, employerProfileUpdateDto.data2Label) &&
        Objects.equals(this.data3, employerProfileUpdateDto.data3) &&
        Objects.equals(this.data3Label, employerProfileUpdateDto.data3Label) &&
        Objects.equals(this.data4, employerProfileUpdateDto.data4) &&
        Objects.equals(this.data4Label, employerProfileUpdateDto.data4Label) &&
        Objects.equals(this.data5, employerProfileUpdateDto.data5) &&
        Objects.equals(this.data5Label, employerProfileUpdateDto.data5Label) &&
        Objects.equals(this.data6, employerProfileUpdateDto.data6) &&
        Objects.equals(this.data6Label, employerProfileUpdateDto.data6Label) &&
        Objects.equals(this.data7, employerProfileUpdateDto.data7) &&
        Objects.equals(this.data7Label, employerProfileUpdateDto.data7Label) &&
        Objects.equals(this.data8, employerProfileUpdateDto.data8) &&
        Objects.equals(this.data8Label, employerProfileUpdateDto.data8Label) &&
        Objects.equals(this.data9, employerProfileUpdateDto.data9) &&
        Objects.equals(this.data9Label, employerProfileUpdateDto.data9Label);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployerProfileUpdateDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployerProfileUpdateDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployerProfileUpdateDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployerProfileUpdateDto is not found in the empty JSON string", EmployerProfileUpdateDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployerProfileUpdateDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployerProfileUpdateDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployerProfileUpdateDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployerProfileUpdateDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployerProfileUpdateDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployerProfileUpdateDto.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployerProfileUpdateDto>() {
           @Override
           public void write(JsonWriter out, EmployerProfileUpdateDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployerProfileUpdateDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployerProfileUpdateDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployerProfileUpdateDto
   * @throws IOException if the JSON string is invalid with respect to EmployerProfileUpdateDto
   */
  public static EmployerProfileUpdateDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployerProfileUpdateDto.class);
  }

  /**
   * Convert an instance of EmployerProfileUpdateDto to an JSON string
   *
   * @return JSON string
   */
