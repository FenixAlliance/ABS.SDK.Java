...
public class EmployeeProfileDto {
  ...
  public EmployeeProfileDto id(String id) {
    this.id = id;
    return this;
  }
  ...
  public EmployeeProfileDto timestamp(OffsetDateTime timestamp) {
  ...
  public EmployeeProfileDto contactId(String contactId) {
  ...
  public EmployeeProfileDto tenantId(String tenantId) {
  ...
  public EmployeeProfileDto type(String type) {
    this.type = type;
    return this;
  }
  ...
  public EmployeeProfileDto enrollmentId(String enrollmentId) {
  ...
  public EmployeeProfileDto about(String about) {
    this.about = about;
    return this;
  }
  ...
  public EmployeeProfileDto verified(Boolean verified) {
  ...
  public EmployeeProfileDto submitted(Boolean submitted) {
  ...
  public EmployeeProfileDto avatarUrl(String avatarUrl) {
  ...
  public EmployeeProfileDto contact(ContactDto contact) {
  ...
  public EmployeeProfileDto verificationTimestamp(OffsetDateTime verificationTimestamp) {
  ...
  public EmployeeProfileDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public EmployeeProfileDto dataLabel(String dataLabel) {
  ...
  public EmployeeProfileDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public EmployeeProfileDto data1Label(String data1Label) {
  ...
  public EmployeeProfileDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public EmployeeProfileDto data2Label(String data2Label) {
  ...
  public EmployeeProfileDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public EmployeeProfileDto data3Label(String data3Label) {
  ...
  public EmployeeProfileDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public EmployeeProfileDto data4Label(String data4Label) {
  ...
  public EmployeeProfileDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public EmployeeProfileDto data5Label(String data5Label) {
  ...
  public EmployeeProfileDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public EmployeeProfileDto data6Label(String data6Label) {
  ...
  public EmployeeProfileDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public EmployeeProfileDto data7Label(String data7Label) {
  ...
  public EmployeeProfileDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public EmployeeProfileDto data8Label(String data8Label) {
  ...
  public EmployeeProfileDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public EmployeeProfileDto data9Label(String data9Label) {
  ...
  public EmployeeProfileDto grossPay(Double grossPay) {
  ...
  public EmployeeProfileDto netSalary(Double netSalary) {
  ...
  public EmployeeProfileDto payrollCurrency(String payrollCurrency) {
  ...
  public EmployeeProfileDto maxWorkHoursPerDay(Integer maxWorkHoursPerDay) {
  ...
  public EmployeeProfileDto jobTitleId(String jobTitleId) {
  ...
  public EmployeeProfileDto employeeTypeId(String employeeTypeId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, employeeProfileDto.id) &&
        Objects.equals(this.timestamp, employeeProfileDto.timestamp) &&
        Objects.equals(this.contactId, employeeProfileDto.contactId) &&
        Objects.equals(this.tenantId, employeeProfileDto.tenantId) &&
        Objects.equals(this.type, employeeProfileDto.type) &&
        Objects.equals(this.enrollmentId, employeeProfileDto.enrollmentId) &&
        Objects.equals(this.about, employeeProfileDto.about) &&
        Objects.equals(this.verified, employeeProfileDto.verified) &&
        Objects.equals(this.submitted, employeeProfileDto.submitted) &&
        Objects.equals(this.avatarUrl, employeeProfileDto.avatarUrl) &&
        Objects.equals(this.contact, employeeProfileDto.contact) &&
        Objects.equals(this.qualifiedName, employeeProfileDto.qualifiedName) &&
        Objects.equals(this.verificationTimestamp, employeeProfileDto.verificationTimestamp) &&
        Objects.equals(this.data, employeeProfileDto.data) &&
        Objects.equals(this.dataLabel, employeeProfileDto.dataLabel) &&
        Objects.equals(this.data1, employeeProfileDto.data1) &&
        Objects.equals(this.data1Label, employeeProfileDto.data1Label) &&
        Objects.equals(this.data2, employeeProfileDto.data2) &&
        Objects.equals(this.data2Label, employeeProfileDto.data2Label) &&
        Objects.equals(this.data3, employeeProfileDto.data3) &&
        Objects.equals(this.data3Label, employeeProfileDto.data3Label) &&
        Objects.equals(this.data4, employeeProfileDto.data4) &&
        Objects.equals(this.data4Label, employeeProfileDto.data4Label) &&
        Objects.equals(this.data5, employeeProfileDto.data5) &&
        Objects.equals(this.data5Label, employeeProfileDto.data5Label) &&
        Objects.equals(this.data6, employeeProfileDto.data6) &&
        Objects.equals(this.data6Label, employeeProfileDto.data6Label) &&
        Objects.equals(this.data7, employeeProfileDto.data7) &&
        Objects.equals(this.data7Label, employeeProfileDto.data7Label) &&
        Objects.equals(this.data8, employeeProfileDto.data8) &&
        Objects.equals(this.data8Label, employeeProfileDto.data8Label) &&
        Objects.equals(this.data9, employeeProfileDto.data9) &&
        Objects.equals(this.data9Label, employeeProfileDto.data9Label) &&
        Objects.equals(this.grossPay, employeeProfileDto.grossPay) &&
        Objects.equals(this.netSalary, employeeProfileDto.netSalary) &&
        Objects.equals(this.payrollCurrency, employeeProfileDto.payrollCurrency) &&
        Objects.equals(this.maxWorkHoursPerDay, employeeProfileDto.maxWorkHoursPerDay) &&
        Objects.equals(this.jobTitleId, employeeProfileDto.jobTitleId) &&
        Objects.equals(this.employeeTypeId, employeeProfileDto.employeeTypeId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, contactId, tenantId, type, enrollmentId, about, verified, submitted, avatarUrl, contact, qualifiedName, verificationTimestamp, data, dataLabel, data1, data1Label, data2, data2Label, data3, data3Label, data4, data4Label, data5, data5Label, data6, data6Label, data7, data7Label, data8, data8Label, data9, data9Label, grossPay, netSalary, payrollCurrency, maxWorkHoursPerDay, jobTitleId, employeeTypeId);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeProfileDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeProfileDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeProfileDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeProfileDto is not found in the empty JSON string", EmployeeProfileDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeeProfileDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeeProfileDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeProfileDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeProfileDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeProfileDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeProfileDto.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeProfileDto>() {
           @Override
           public void write(JsonWriter out, EmployeeProfileDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeeProfileDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeeProfileDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeeProfileDto
   * @throws IOException if the JSON string is invalid with respect to EmployeeProfileDto
   */
  public static EmployeeProfileDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeProfileDto.class);
  }

  /**
   * Convert an instance of EmployeeProfileDto to an JSON string
   *
   * @return JSON string
   */
