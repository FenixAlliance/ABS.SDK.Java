...
public class JobApplicantProfileCreateDto {
  ...
  public JobApplicantProfileCreateDto() {
  }

  public JobApplicantProfileCreateDto id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public JobApplicantProfileCreateDto timestamp(OffsetDateTime timestamp) {
  ...
  public JobApplicantProfileCreateDto type(String type) {
    this.type = type;
    return this;
  }
  ...
  public JobApplicantProfileCreateDto contactId(String contactId) {
  ...
  public JobApplicantProfileCreateDto contact(ContactCreateDto contact) {
  ...
  public JobApplicantProfileCreateDto about(String about) {
    this.about = about;
    return this;
  }
  ...
  public JobApplicantProfileCreateDto avatarUrl(String avatarUrl) {
  ...
  public JobApplicantProfileCreateDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public JobApplicantProfileCreateDto dataLabel(String dataLabel) {
  ...
  public JobApplicantProfileCreateDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public JobApplicantProfileCreateDto data1Label(String data1Label) {
  ...
  public JobApplicantProfileCreateDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public JobApplicantProfileCreateDto data2Label(String data2Label) {
  ...
  public JobApplicantProfileCreateDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public JobApplicantProfileCreateDto data3Label(String data3Label) {
  ...
  public JobApplicantProfileCreateDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public JobApplicantProfileCreateDto data4Label(String data4Label) {
  ...
  public JobApplicantProfileCreateDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public JobApplicantProfileCreateDto data5Label(String data5Label) {
  ...
  public JobApplicantProfileCreateDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public JobApplicantProfileCreateDto data6Label(String data6Label) {
  ...
  public JobApplicantProfileCreateDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public JobApplicantProfileCreateDto data7Label(String data7Label) {
  ...
  public JobApplicantProfileCreateDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public JobApplicantProfileCreateDto data8Label(String data8Label) {
  ...
  public JobApplicantProfileCreateDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public JobApplicantProfileCreateDto data9Label(String data9Label) {
  ...
  public JobApplicantProfileCreateDto availableForHire(Boolean availableForHire) {
  ...
  public JobApplicantProfileCreateDto careerLevel(CareerLevelEnum careerLevel) {
  ...
  public JobApplicantProfileCreateDto experienceInYears(Integer experienceInYears) {
  ...
  public JobApplicantProfileCreateDto currentSalary(Double currentSalary) {
  ...
  public JobApplicantProfileCreateDto minSalaryExpectation(Double minSalaryExpectation) {
  ...
  public JobApplicantProfileCreateDto maxSalaryExpectation(Double maxSalaryExpectation) {
  ...
  public JobApplicantProfileCreateDto currencyId(String currencyId) {
  ...
  public boolean equals(Object o) {
    ...
    JobApplicantProfileCreateDto jobApplicantProfileCreateDto = (JobApplicantProfileCreateDto) o;
    return Objects.equals(this.id, jobApplicantProfileCreateDto.id) &&
        Objects.equals(this.timestamp, jobApplicantProfileCreateDto.timestamp) &&
        Objects.equals(this.type, jobApplicantProfileCreateDto.type) &&
        Objects.equals(this.contactId, jobApplicantProfileCreateDto.contactId) &&
        Objects.equals(this.contact, jobApplicantProfileCreateDto.contact) &&
        Objects.equals(this.about, jobApplicantProfileCreateDto.about) &&
        Objects.equals(this.avatarUrl, jobApplicantProfileCreateDto.avatarUrl) &&
        Objects.equals(this.data, jobApplicantProfileCreateDto.data) &&
        Objects.equals(this.dataLabel, jobApplicantProfileCreateDto.dataLabel) &&
        Objects.equals(this.data1, jobApplicantProfileCreateDto.data1) &&
        Objects.equals(this.data1Label, jobApplicantProfileCreateDto.data1Label) &&
        Objects.equals(this.data2, jobApplicantProfileCreateDto.data2) &&
        Objects.equals(this.data2Label, jobApplicantProfileCreateDto.data2Label) &&
        Objects.equals(this.data3, jobApplicantProfileCreateDto.data3) &&
        Objects.equals(this.data3Label, jobApplicantProfileCreateDto.data3Label) &&
        Objects.equals(this.data4, jobApplicantProfileCreateDto.data4) &&
        Objects.equals(this.data4Label, jobApplicantProfileCreateDto.data4Label) &&
        Objects.equals(this.data5, jobApplicantProfileCreateDto.data5) &&
        Objects.equals(this.data5Label, jobApplicantProfileCreateDto.data5Label) &&
        Objects.equals(this.data6, jobApplicantProfileCreateDto.data6) &&
        Objects.equals(this.data6Label, jobApplicantProfileCreateDto.data6Label) &&
        Objects.equals(this.data7, jobApplicantProfileCreateDto.data7) &&
        Objects.equals(this.data7Label, jobApplicantProfileCreateDto.data7Label) &&
        Objects.equals(this.data8, jobApplicantProfileCreateDto.data8) &&
        Objects.equals(this.data8Label, jobApplicantProfileCreateDto.data8Label) &&
        Objects.equals(this.data9, jobApplicantProfileCreateDto.data9) &&
        Objects.equals(this.data9Label, jobApplicantProfileCreateDto.data9Label) &&
        Objects.equals(this.availableForHire, jobApplicantProfileCreateDto.availableForHire) &&
        Objects.equals(this.careerLevel, jobApplicantProfileCreateDto.careerLevel) &&
        Objects.equals(this.experienceInYears, jobApplicantProfileCreateDto.experienceInYears) &&
        Objects.equals(this.currentSalary, jobApplicantProfileCreateDto.currentSalary) &&
        Objects.equals(this.minSalaryExpectation, jobApplicantProfileCreateDto.minSalaryExpectation) &&
        Objects.equals(this.maxSalaryExpectation, jobApplicantProfileCreateDto.maxSalaryExpectation) &&
        Objects.equals(this.currencyId, jobApplicantProfileCreateDto.currencyId);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobApplicantProfileCreateDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to JobApplicantProfileCreateDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JobApplicantProfileCreateDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JobApplicantProfileCreateDto is not found in the empty JSON string", JobApplicantProfileCreateDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JobApplicantProfileCreateDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JobApplicantProfileCreateDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JobApplicantProfileCreateDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JobApplicantProfileCreateDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JobApplicantProfileCreateDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JobApplicantProfileCreateDto.class));

       return (TypeAdapter<T>) new TypeAdapter<JobApplicantProfileCreateDto>() {
           @Override
           public void write(JsonWriter out, JobApplicantProfileCreateDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JobApplicantProfileCreateDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JobApplicantProfileCreateDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JobApplicantProfileCreateDto
   * @throws IOException if the JSON string is invalid with respect to JobApplicantProfileCreateDto
   */
  public static JobApplicantProfileCreateDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JobApplicantProfileCreateDto.class);
  }

  /**
   * Convert an instance of JobApplicantProfileCreateDto to an JSON string
   *
   * @return JSON string
   */
