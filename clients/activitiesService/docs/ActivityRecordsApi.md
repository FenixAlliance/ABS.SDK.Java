...
import org.openapitools.client.api.ActivityRecordsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ActivityRecordsApi apiInstance = new ActivityRecordsApi(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling ActivityRecordsApi#getActivityRecordsCountAsync");
