...
public class ActivityRecordsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ActivityRecordsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ActivityRecordsApi(ApiClient apiClient) {
    ...
    public okhttp3.Call getActivityRecordsCountAsyncCall(UUID tenantId, String apiVersion, String xApiVersion, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/ActivitiesService/ActivityRecords/Count";
