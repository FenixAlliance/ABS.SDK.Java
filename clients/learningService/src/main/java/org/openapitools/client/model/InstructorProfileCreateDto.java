...
public class InstructorProfileCreateDto {
  ...
  public InstructorProfileCreateDto() {
  }

  public InstructorProfileCreateDto id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public InstructorProfileCreateDto timestamp(OffsetDateTime timestamp) {
  ...
  public InstructorProfileCreateDto authorized(Boolean authorized) {
  ...
  public InstructorProfileCreateDto about(String about) {
    this.about = about;
    return this;
  }
  ...
  public InstructorProfileCreateDto verified(Boolean verified) {
  ...
  public InstructorProfileCreateDto submitted(Boolean submitted) {
  ...
  public InstructorProfileCreateDto avatarUrl(String avatarUrl) {
  ...
  public InstructorProfileCreateDto qualifiedName(String qualifiedName) {
  ...
  public InstructorProfileCreateDto verificationTimestamp(OffsetDateTime verificationTimestamp) {
  ...
  public InstructorProfileCreateDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public InstructorProfileCreateDto dataLabel(String dataLabel) {
  ...
  public InstructorProfileCreateDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public InstructorProfileCreateDto data1Label(String data1Label) {
  ...
  public InstructorProfileCreateDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public InstructorProfileCreateDto data2Label(String data2Label) {
  ...
  public InstructorProfileCreateDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public InstructorProfileCreateDto data3Label(String data3Label) {
  ...
  public InstructorProfileCreateDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public InstructorProfileCreateDto data4Label(String data4Label) {
  ...
  public InstructorProfileCreateDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public InstructorProfileCreateDto data5Label(String data5Label) {
  ...
  public InstructorProfileCreateDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public InstructorProfileCreateDto data6Label(String data6Label) {
  ...
  public InstructorProfileCreateDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public InstructorProfileCreateDto data7Label(String data7Label) {
  ...
  public InstructorProfileCreateDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public InstructorProfileCreateDto data8Label(String data8Label) {
  ...
  public InstructorProfileCreateDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public InstructorProfileCreateDto data9Label(String data9Label) {
  ...
  public InstructorProfileCreateDto businessID(String businessID) {
  ...
  public InstructorProfileCreateDto contactID(String contactID) {
  ...
  public InstructorProfileCreateDto businessProfileRecordID(String businessProfileRecordID) {
  ...
  public boolean equals(Object o) {
    ...
    InstructorProfileCreateDto instructorProfileCreateDto = (InstructorProfileCreateDto) o;
    return Objects.equals(this.id, instructorProfileCreateDto.id) &&
        Objects.equals(this.timestamp, instructorProfileCreateDto.timestamp) &&
        Objects.equals(this.authorized, instructorProfileCreateDto.authorized) &&
        Objects.equals(this.about, instructorProfileCreateDto.about) &&
        Objects.equals(this.verified, instructorProfileCreateDto.verified) &&
        Objects.equals(this.submitted, instructorProfileCreateDto.submitted) &&
        Objects.equals(this.avatarUrl, instructorProfileCreateDto.avatarUrl) &&
        Objects.equals(this.qualifiedName, instructorProfileCreateDto.qualifiedName) &&
        Objects.equals(this.verificationTimestamp, instructorProfileCreateDto.verificationTimestamp) &&
        Objects.equals(this.data, instructorProfileCreateDto.data) &&
        Objects.equals(this.dataLabel, instructorProfileCreateDto.dataLabel) &&
        Objects.equals(this.data1, instructorProfileCreateDto.data1) &&
        Objects.equals(this.data1Label, instructorProfileCreateDto.data1Label) &&
        Objects.equals(this.data2, instructorProfileCreateDto.data2) &&
        Objects.equals(this.data2Label, instructorProfileCreateDto.data2Label) &&
        Objects.equals(this.data3, instructorProfileCreateDto.data3) &&
        Objects.equals(this.data3Label, instructorProfileCreateDto.data3Label) &&
        Objects.equals(this.data4, instructorProfileCreateDto.data4) &&
        Objects.equals(this.data4Label, instructorProfileCreateDto.data4Label) &&
        Objects.equals(this.data5, instructorProfileCreateDto.data5) &&
        Objects.equals(this.data5Label, instructorProfileCreateDto.data5Label) &&
        Objects.equals(this.data6, instructorProfileCreateDto.data6) &&
        Objects.equals(this.data6Label, instructorProfileCreateDto.data6Label) &&
        Objects.equals(this.data7, instructorProfileCreateDto.data7) &&
        Objects.equals(this.data7Label, instructorProfileCreateDto.data7Label) &&
        Objects.equals(this.data8, instructorProfileCreateDto.data8) &&
        Objects.equals(this.data8Label, instructorProfileCreateDto.data8Label) &&
        Objects.equals(this.data9, instructorProfileCreateDto.data9) &&
        Objects.equals(this.data9Label, instructorProfileCreateDto.data9Label) &&
        Objects.equals(this.businessID, instructorProfileCreateDto.businessID) &&
        Objects.equals(this.contactID, instructorProfileCreateDto.contactID) &&
        Objects.equals(this.businessProfileRecordID, instructorProfileCreateDto.businessProfileRecordID);
  }
  ...
  public String toString() {
    ...
    sb.append("class InstructorProfileCreateDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InstructorProfileCreateDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InstructorProfileCreateDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InstructorProfileCreateDto is not found in the empty JSON string", InstructorProfileCreateDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InstructorProfileCreateDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InstructorProfileCreateDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InstructorProfileCreateDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InstructorProfileCreateDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InstructorProfileCreateDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InstructorProfileCreateDto.class));

       return (TypeAdapter<T>) new TypeAdapter<InstructorProfileCreateDto>() {
           @Override
           public void write(JsonWriter out, InstructorProfileCreateDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InstructorProfileCreateDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InstructorProfileCreateDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InstructorProfileCreateDto
   * @throws IOException if the JSON string is invalid with respect to InstructorProfileCreateDto
   */
  public static InstructorProfileCreateDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InstructorProfileCreateDto.class);
  }

  /**
   * Convert an instance of InstructorProfileCreateDto to an JSON string
   *
   * @return JSON string
   */
