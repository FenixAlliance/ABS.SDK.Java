...
public class StudentProfileUpdateDto {
  ...
  public StudentProfileUpdateDto id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public StudentProfileUpdateDto timestamp(OffsetDateTime timestamp) {
  ...
  public StudentProfileUpdateDto about(String about) {
    this.about = about;
    return this;
  }
  ...
  public StudentProfileUpdateDto verified(Boolean verified) {
  ...
  public StudentProfileUpdateDto submitted(Boolean submitted) {
  ...
  public StudentProfileUpdateDto avatarUrl(String avatarUrl) {
  ...
  public StudentProfileUpdateDto qualifiedName(String qualifiedName) {
  ...
  public StudentProfileUpdateDto verificationTimestamp(OffsetDateTime verificationTimestamp) {
  ...
  public StudentProfileUpdateDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public StudentProfileUpdateDto dataLabel(String dataLabel) {
  ...
  public StudentProfileUpdateDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public StudentProfileUpdateDto data1Label(String data1Label) {
  ...
  public StudentProfileUpdateDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public StudentProfileUpdateDto data2Label(String data2Label) {
  ...
  public StudentProfileUpdateDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public StudentProfileUpdateDto data3Label(String data3Label) {
  ...
  public StudentProfileUpdateDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public StudentProfileUpdateDto data4Label(String data4Label) {
  ...
  public StudentProfileUpdateDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public StudentProfileUpdateDto data5Label(String data5Label) {
  ...
  public StudentProfileUpdateDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public StudentProfileUpdateDto data6Label(String data6Label) {
  ...
  public StudentProfileUpdateDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public StudentProfileUpdateDto data7Label(String data7Label) {
  ...
  public StudentProfileUpdateDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public StudentProfileUpdateDto data8Label(String data8Label) {
  ...
  public StudentProfileUpdateDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public StudentProfileUpdateDto data9Label(String data9Label) {
  ...
  public StudentProfileUpdateDto businessID(String businessID) {
  ...
  public StudentProfileUpdateDto contactID(String contactID) {
  ...
  public StudentProfileUpdateDto businessProfileRecordID(String businessProfileRecordID) {
  ...
  public boolean equals(Object o) {
    ...
    StudentProfileUpdateDto studentProfileUpdateDto = (StudentProfileUpdateDto) o;
    return Objects.equals(this.id, studentProfileUpdateDto.id) &&
        Objects.equals(this.timestamp, studentProfileUpdateDto.timestamp) &&
        Objects.equals(this.about, studentProfileUpdateDto.about) &&
        Objects.equals(this.verified, studentProfileUpdateDto.verified) &&
        Objects.equals(this.submitted, studentProfileUpdateDto.submitted) &&
        Objects.equals(this.avatarUrl, studentProfileUpdateDto.avatarUrl) &&
        Objects.equals(this.qualifiedName, studentProfileUpdateDto.qualifiedName) &&
        Objects.equals(this.verificationTimestamp, studentProfileUpdateDto.verificationTimestamp) &&
        Objects.equals(this.data, studentProfileUpdateDto.data) &&
        Objects.equals(this.dataLabel, studentProfileUpdateDto.dataLabel) &&
        Objects.equals(this.data1, studentProfileUpdateDto.data1) &&
        Objects.equals(this.data1Label, studentProfileUpdateDto.data1Label) &&
        Objects.equals(this.data2, studentProfileUpdateDto.data2) &&
        Objects.equals(this.data2Label, studentProfileUpdateDto.data2Label) &&
        Objects.equals(this.data3, studentProfileUpdateDto.data3) &&
        Objects.equals(this.data3Label, studentProfileUpdateDto.data3Label) &&
        Objects.equals(this.data4, studentProfileUpdateDto.data4) &&
        Objects.equals(this.data4Label, studentProfileUpdateDto.data4Label) &&
        Objects.equals(this.data5, studentProfileUpdateDto.data5) &&
        Objects.equals(this.data5Label, studentProfileUpdateDto.data5Label) &&
        Objects.equals(this.data6, studentProfileUpdateDto.data6) &&
        Objects.equals(this.data6Label, studentProfileUpdateDto.data6Label) &&
        Objects.equals(this.data7, studentProfileUpdateDto.data7) &&
        Objects.equals(this.data7Label, studentProfileUpdateDto.data7Label) &&
        Objects.equals(this.data8, studentProfileUpdateDto.data8) &&
        Objects.equals(this.data8Label, studentProfileUpdateDto.data8Label) &&
        Objects.equals(this.data9, studentProfileUpdateDto.data9) &&
        Objects.equals(this.data9Label, studentProfileUpdateDto.data9Label) &&
        Objects.equals(this.businessID, studentProfileUpdateDto.businessID) &&
        Objects.equals(this.contactID, studentProfileUpdateDto.contactID) &&
        Objects.equals(this.businessProfileRecordID, studentProfileUpdateDto.businessProfileRecordID);
  }
  ...
  public String toString() {
    ...
    sb.append("class StudentProfileUpdateDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StudentProfileUpdateDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StudentProfileUpdateDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StudentProfileUpdateDto is not found in the empty JSON string", StudentProfileUpdateDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StudentProfileUpdateDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StudentProfileUpdateDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StudentProfileUpdateDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StudentProfileUpdateDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StudentProfileUpdateDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StudentProfileUpdateDto.class));

       return (TypeAdapter<T>) new TypeAdapter<StudentProfileUpdateDto>() {
           @Override
           public void write(JsonWriter out, StudentProfileUpdateDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StudentProfileUpdateDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StudentProfileUpdateDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StudentProfileUpdateDto
   * @throws IOException if the JSON string is invalid with respect to StudentProfileUpdateDto
   */
  public static StudentProfileUpdateDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StudentProfileUpdateDto.class);
  }

  /**
   * Convert an instance of StudentProfileUpdateDto to an JSON string
   *
   * @return JSON string
   */
