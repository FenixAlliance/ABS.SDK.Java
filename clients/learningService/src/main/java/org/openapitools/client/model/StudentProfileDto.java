...
public class StudentProfileDto {
  ...
  public StudentProfileDto id(String id) {
    this.id = id;
    return this;
  }
  ...
  public StudentProfileDto timestamp(OffsetDateTime timestamp) {
  ...
  public StudentProfileDto contactId(String contactId) {
  ...
  public StudentProfileDto tenantId(String tenantId) {
  ...
  public StudentProfileDto type(String type) {
    this.type = type;
    return this;
  }
  ...
  public StudentProfileDto enrollmentId(String enrollmentId) {
  ...
  public StudentProfileDto about(String about) {
    this.about = about;
    return this;
  }
  ...
  public StudentProfileDto verified(Boolean verified) {
  ...
  public StudentProfileDto submitted(Boolean submitted) {
  ...
  public StudentProfileDto avatarUrl(String avatarUrl) {
  ...
  public StudentProfileDto contact(ContactDto contact) {
  ...
  public StudentProfileDto verificationTimestamp(OffsetDateTime verificationTimestamp) {
  ...
  public StudentProfileDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public StudentProfileDto dataLabel(String dataLabel) {
  ...
  public StudentProfileDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public StudentProfileDto data1Label(String data1Label) {
  ...
  public StudentProfileDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public StudentProfileDto data2Label(String data2Label) {
  ...
  public StudentProfileDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public StudentProfileDto data3Label(String data3Label) {
  ...
  public StudentProfileDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public StudentProfileDto data4Label(String data4Label) {
  ...
  public StudentProfileDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public StudentProfileDto data5Label(String data5Label) {
  ...
  public StudentProfileDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public StudentProfileDto data6Label(String data6Label) {
  ...
  public StudentProfileDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public StudentProfileDto data7Label(String data7Label) {
  ...
  public StudentProfileDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public StudentProfileDto data8Label(String data8Label) {
  ...
  public StudentProfileDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public StudentProfileDto data9Label(String data9Label) {
  ...
  public StudentProfileDto businessID(String businessID) {
  ...
  public StudentProfileDto businessProfileRecordID(String businessProfileRecordID) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, studentProfileDto.id) &&
        Objects.equals(this.timestamp, studentProfileDto.timestamp) &&
        Objects.equals(this.contactId, studentProfileDto.contactId) &&
        Objects.equals(this.tenantId, studentProfileDto.tenantId) &&
        Objects.equals(this.type, studentProfileDto.type) &&
        Objects.equals(this.enrollmentId, studentProfileDto.enrollmentId) &&
        Objects.equals(this.about, studentProfileDto.about) &&
        Objects.equals(this.verified, studentProfileDto.verified) &&
        Objects.equals(this.submitted, studentProfileDto.submitted) &&
        Objects.equals(this.avatarUrl, studentProfileDto.avatarUrl) &&
        Objects.equals(this.contact, studentProfileDto.contact) &&
        Objects.equals(this.qualifiedName, studentProfileDto.qualifiedName) &&
        Objects.equals(this.verificationTimestamp, studentProfileDto.verificationTimestamp) &&
        Objects.equals(this.data, studentProfileDto.data) &&
        Objects.equals(this.dataLabel, studentProfileDto.dataLabel) &&
        Objects.equals(this.data1, studentProfileDto.data1) &&
        Objects.equals(this.data1Label, studentProfileDto.data1Label) &&
        Objects.equals(this.data2, studentProfileDto.data2) &&
        Objects.equals(this.data2Label, studentProfileDto.data2Label) &&
        Objects.equals(this.data3, studentProfileDto.data3) &&
        Objects.equals(this.data3Label, studentProfileDto.data3Label) &&
        Objects.equals(this.data4, studentProfileDto.data4) &&
        Objects.equals(this.data4Label, studentProfileDto.data4Label) &&
        Objects.equals(this.data5, studentProfileDto.data5) &&
        Objects.equals(this.data5Label, studentProfileDto.data5Label) &&
        Objects.equals(this.data6, studentProfileDto.data6) &&
        Objects.equals(this.data6Label, studentProfileDto.data6Label) &&
        Objects.equals(this.data7, studentProfileDto.data7) &&
        Objects.equals(this.data7Label, studentProfileDto.data7Label) &&
        Objects.equals(this.data8, studentProfileDto.data8) &&
        Objects.equals(this.data8Label, studentProfileDto.data8Label) &&
        Objects.equals(this.data9, studentProfileDto.data9) &&
        Objects.equals(this.data9Label, studentProfileDto.data9Label) &&
        Objects.equals(this.businessID, studentProfileDto.businessID) &&
        Objects.equals(this.contactID, studentProfileDto.contactID) &&
        Objects.equals(this.businessProfileRecordID, studentProfileDto.businessProfileRecordID);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, contactId, tenantId, type, enrollmentId, about, verified, submitted, avatarUrl, contact, qualifiedName, verificationTimestamp, data, dataLabel, data1, data1Label, data2, data2Label, data3, data3Label, data4, data4Label, data5, data5Label, data6, data6Label, data7, data7Label, data8, data8Label, data9, data9Label, businessID, contactID, businessProfileRecordID);
  }
  ...
  public String toString() {
    ...
    sb.append("class StudentProfileDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StudentProfileDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StudentProfileDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StudentProfileDto is not found in the empty JSON string", StudentProfileDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StudentProfileDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StudentProfileDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StudentProfileDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StudentProfileDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StudentProfileDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StudentProfileDto.class));

       return (TypeAdapter<T>) new TypeAdapter<StudentProfileDto>() {
           @Override
           public void write(JsonWriter out, StudentProfileDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StudentProfileDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StudentProfileDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StudentProfileDto
   * @throws IOException if the JSON string is invalid with respect to StudentProfileDto
   */
  public static StudentProfileDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StudentProfileDto.class);
  }

  /**
   * Convert an instance of StudentProfileDto to an JSON string
   *
   * @return JSON string
   */
