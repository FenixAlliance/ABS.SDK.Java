...
public class InstructorProfileUpdateDto {
  ...
  public InstructorProfileUpdateDto type(String type) {
    this.type = type;
    return this;
  }
  ...
  public InstructorProfileUpdateDto contactId(String contactId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, instructorProfileUpdateDto.type) &&
        Objects.equals(this.contactId, instructorProfileUpdateDto.contactId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, contactId, about, avatarUrl, data, dataLabel, data1, data1Label, data2, data2Label, data3, data3Label, data4, data4Label, data5, data5Label, data6, data6Label, data7, data7Label, data8, data8Label, data9, data9Label, authorized);
  }
