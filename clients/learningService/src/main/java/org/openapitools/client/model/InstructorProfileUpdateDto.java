...
public class InstructorProfileUpdateDto {
  ...
  public InstructorProfileUpdateDto() {
  }

  public InstructorProfileUpdateDto id(String id) {
    this.id = id;
    return this;
  }
  ...
  public InstructorProfileUpdateDto timestamp(OffsetDateTime timestamp) {
  ...
  public InstructorProfileUpdateDto authorized(Boolean authorized) {
  ...
  public InstructorProfileUpdateDto about(String about) {
    this.about = about;
    return this;
  }
  ...
  public InstructorProfileUpdateDto verified(Boolean verified) {
  ...
  public InstructorProfileUpdateDto submitted(Boolean submitted) {
  ...
  public InstructorProfileUpdateDto avatarUrl(String avatarUrl) {
  ...
  public InstructorProfileUpdateDto qualifiedName(String qualifiedName) {
  ...
  public InstructorProfileUpdateDto verificationTimestamp(OffsetDateTime verificationTimestamp) {
  ...
  public InstructorProfileUpdateDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public InstructorProfileUpdateDto dataLabel(String dataLabel) {
  ...
  public InstructorProfileUpdateDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public InstructorProfileUpdateDto data1Label(String data1Label) {
  ...
  public InstructorProfileUpdateDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public InstructorProfileUpdateDto data2Label(String data2Label) {
  ...
  public InstructorProfileUpdateDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public InstructorProfileUpdateDto data3Label(String data3Label) {
  ...
  public InstructorProfileUpdateDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public InstructorProfileUpdateDto data4Label(String data4Label) {
  ...
  public InstructorProfileUpdateDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public InstructorProfileUpdateDto data5Label(String data5Label) {
  ...
  public InstructorProfileUpdateDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public InstructorProfileUpdateDto data6Label(String data6Label) {
  ...
  public InstructorProfileUpdateDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public InstructorProfileUpdateDto data7Label(String data7Label) {
  ...
  public InstructorProfileUpdateDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public InstructorProfileUpdateDto data8Label(String data8Label) {
  ...
  public InstructorProfileUpdateDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public InstructorProfileUpdateDto data9Label(String data9Label) {
  ...
  public boolean equals(Object o) {
    ...
    InstructorProfileUpdateDto instructorProfileUpdateDto = (InstructorProfileUpdateDto) o;
    return Objects.equals(this.id, instructorProfileUpdateDto.id) &&
        Objects.equals(this.timestamp, instructorProfileUpdateDto.timestamp) &&
        Objects.equals(this.authorized, instructorProfileUpdateDto.authorized) &&
        Objects.equals(this.about, instructorProfileUpdateDto.about) &&
        Objects.equals(this.verified, instructorProfileUpdateDto.verified) &&
        Objects.equals(this.submitted, instructorProfileUpdateDto.submitted) &&
        Objects.equals(this.avatarUrl, instructorProfileUpdateDto.avatarUrl) &&
        Objects.equals(this.qualifiedName, instructorProfileUpdateDto.qualifiedName) &&
        Objects.equals(this.verificationTimestamp, instructorProfileUpdateDto.verificationTimestamp) &&
        Objects.equals(this.data, instructorProfileUpdateDto.data) &&
        Objects.equals(this.dataLabel, instructorProfileUpdateDto.dataLabel) &&
        Objects.equals(this.data1, instructorProfileUpdateDto.data1) &&
        Objects.equals(this.data1Label, instructorProfileUpdateDto.data1Label) &&
        Objects.equals(this.data2, instructorProfileUpdateDto.data2) &&
        Objects.equals(this.data2Label, instructorProfileUpdateDto.data2Label) &&
        Objects.equals(this.data3, instructorProfileUpdateDto.data3) &&
        Objects.equals(this.data3Label, instructorProfileUpdateDto.data3Label) &&
        Objects.equals(this.data4, instructorProfileUpdateDto.data4) &&
        Objects.equals(this.data4Label, instructorProfileUpdateDto.data4Label) &&
        Objects.equals(this.data5, instructorProfileUpdateDto.data5) &&
        Objects.equals(this.data5Label, instructorProfileUpdateDto.data5Label) &&
        Objects.equals(this.data6, instructorProfileUpdateDto.data6) &&
        Objects.equals(this.data6Label, instructorProfileUpdateDto.data6Label) &&
        Objects.equals(this.data7, instructorProfileUpdateDto.data7) &&
        Objects.equals(this.data7Label, instructorProfileUpdateDto.data7Label) &&
        Objects.equals(this.data8, instructorProfileUpdateDto.data8) &&
        Objects.equals(this.data8Label, instructorProfileUpdateDto.data8Label) &&
        Objects.equals(this.data9, instructorProfileUpdateDto.data9) &&
        Objects.equals(this.data9Label, instructorProfileUpdateDto.data9Label);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, authorized, about, verified, submitted, avatarUrl, qualifiedName, verificationTimestamp, data, dataLabel, data1, data1Label, data2, data2Label, data3, data3Label, data4, data4Label, data5, data5Label, data6, data6Label, data7, data7Label, data8, data8Label, data9, data9Label);
  }
  ...
  public String toString() {
    ...
    sb.append("class InstructorProfileUpdateDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InstructorProfileUpdateDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InstructorProfileUpdateDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InstructorProfileUpdateDto is not found in the empty JSON string", InstructorProfileUpdateDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InstructorProfileUpdateDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InstructorProfileUpdateDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InstructorProfileUpdateDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InstructorProfileUpdateDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InstructorProfileUpdateDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InstructorProfileUpdateDto.class));

       return (TypeAdapter<T>) new TypeAdapter<InstructorProfileUpdateDto>() {
           @Override
           public void write(JsonWriter out, InstructorProfileUpdateDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InstructorProfileUpdateDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InstructorProfileUpdateDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InstructorProfileUpdateDto
   * @throws IOException if the JSON string is invalid with respect to InstructorProfileUpdateDto
   */
  public static InstructorProfileUpdateDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InstructorProfileUpdateDto.class);
  }

  /**
   * Convert an instance of InstructorProfileUpdateDto to an JSON string
   *
   * @return JSON string
   */
