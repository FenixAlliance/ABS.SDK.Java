...
public class ContactProfileUpdateDto {
  ...
  public ContactProfileUpdateDto() {
  }

  public ContactProfileUpdateDto type(String type) {
    this.type = type;
    return this;
  }
  ...
  public ContactProfileUpdateDto contactId(String contactId) {
  ...
  public ContactProfileUpdateDto about(String about) {
    this.about = about;
    return this;
  }
  ...
  public ContactProfileUpdateDto avatarUrl(String avatarUrl) {
  ...
  public ContactProfileUpdateDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public ContactProfileUpdateDto dataLabel(String dataLabel) {
  ...
  public ContactProfileUpdateDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public ContactProfileUpdateDto data1Label(String data1Label) {
  ...
  public ContactProfileUpdateDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public ContactProfileUpdateDto data2Label(String data2Label) {
  ...
  public ContactProfileUpdateDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public ContactProfileUpdateDto data3Label(String data3Label) {
  ...
  public ContactProfileUpdateDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public ContactProfileUpdateDto data4Label(String data4Label) {
  ...
  public ContactProfileUpdateDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public ContactProfileUpdateDto data5Label(String data5Label) {
  ...
  public ContactProfileUpdateDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public ContactProfileUpdateDto data6Label(String data6Label) {
  ...
  public ContactProfileUpdateDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public ContactProfileUpdateDto data7Label(String data7Label) {
  ...
  public ContactProfileUpdateDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public ContactProfileUpdateDto data8Label(String data8Label) {
  ...
  public ContactProfileUpdateDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public ContactProfileUpdateDto data9Label(String data9Label) {
  ...
  public boolean equals(Object o) {
    ...
    ContactProfileUpdateDto contactProfileUpdateDto = (ContactProfileUpdateDto) o;
    return Objects.equals(this.type, contactProfileUpdateDto.type) &&
        Objects.equals(this.contactId, contactProfileUpdateDto.contactId) &&
        Objects.equals(this.about, contactProfileUpdateDto.about) &&
        Objects.equals(this.avatarUrl, contactProfileUpdateDto.avatarUrl) &&
        Objects.equals(this.data, contactProfileUpdateDto.data) &&
        Objects.equals(this.dataLabel, contactProfileUpdateDto.dataLabel) &&
        Objects.equals(this.data1, contactProfileUpdateDto.data1) &&
        Objects.equals(this.data1Label, contactProfileUpdateDto.data1Label) &&
        Objects.equals(this.data2, contactProfileUpdateDto.data2) &&
        Objects.equals(this.data2Label, contactProfileUpdateDto.data2Label) &&
        Objects.equals(this.data3, contactProfileUpdateDto.data3) &&
        Objects.equals(this.data3Label, contactProfileUpdateDto.data3Label) &&
        Objects.equals(this.data4, contactProfileUpdateDto.data4) &&
        Objects.equals(this.data4Label, contactProfileUpdateDto.data4Label) &&
        Objects.equals(this.data5, contactProfileUpdateDto.data5) &&
        Objects.equals(this.data5Label, contactProfileUpdateDto.data5Label) &&
        Objects.equals(this.data6, contactProfileUpdateDto.data6) &&
        Objects.equals(this.data6Label, contactProfileUpdateDto.data6Label) &&
        Objects.equals(this.data7, contactProfileUpdateDto.data7) &&
        Objects.equals(this.data7Label, contactProfileUpdateDto.data7Label) &&
        Objects.equals(this.data8, contactProfileUpdateDto.data8) &&
        Objects.equals(this.data8Label, contactProfileUpdateDto.data8Label) &&
        Objects.equals(this.data9, contactProfileUpdateDto.data9) &&
        Objects.equals(this.data9Label, contactProfileUpdateDto.data9Label);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactProfileUpdateDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContactProfileUpdateDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContactProfileUpdateDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactProfileUpdateDto is not found in the empty JSON string", ContactProfileUpdateDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContactProfileUpdateDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactProfileUpdateDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactProfileUpdateDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactProfileUpdateDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactProfileUpdateDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactProfileUpdateDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactProfileUpdateDto>() {
           @Override
           public void write(JsonWriter out, ContactProfileUpdateDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactProfileUpdateDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContactProfileUpdateDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContactProfileUpdateDto
   * @throws IOException if the JSON string is invalid with respect to ContactProfileUpdateDto
   */
  public static ContactProfileUpdateDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactProfileUpdateDto.class);
  }

  /**
   * Convert an instance of ContactProfileUpdateDto to an JSON string
   *
   * @return JSON string
   */
