 ...
 * ExtendedContactDto
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-04-16T21:10:54.929032600-05:00[America/Bogota]", comments = "Generator version: 7.9.0")
public class ExtendedContactDto {
  ...
  public static final String SERIALIZED_NAME_PARENT_CONTACT = "parentContact";
  @SerializedName(SERIALIZED_NAME_PARENT_CONTACT)
  private SimpleContactDto parentContact;

  public static final String SERIALIZED_NAME_PRIMARY_CONTACT = "primaryContact";
  @SerializedName(SERIALIZED_NAME_PRIMARY_CONTACT)
  private SimpleContactDto primaryContact;

  public ExtendedContactDto() {
  }
  ...
  public ExtendedContactDto id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ExtendedContactDto timestamp(OffsetDateTime timestamp) {
  ...
  public ExtendedContactDto tenantId(String tenantId) {
  ...
  public ExtendedContactDto type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public ExtendedContactDto email(String email) {
    this.email = email;
    return this;
  }
  ...
  public ExtendedContactDto phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public ExtendedContactDto publicName(String publicName) {
  ...
  public ExtendedContactDto firstName(String firstName) {
  ...
  public ExtendedContactDto lastName(String lastName) {
  ...
  public ExtendedContactDto jobTitle(String jobTitle) {
  ...
  public ExtendedContactDto coverUrl(String coverUrl) {
  ...
  public ExtendedContactDto avatarUrl(String avatarUrl) {
  ...
  public ExtendedContactDto countryId(String countryId) {
  ...
  public ExtendedContactDto timezoneId(String timezoneId) {
  ...
  public ExtendedContactDto languageId(String languageId) {
  ...
  public ExtendedContactDto socialProfileId(String socialProfileId) {
  ...
  public ExtendedContactDto webUrl(URI webUrl) {
    this.webUrl = webUrl;
    return this;
  }
  ...
  public ExtendedContactDto gitHubUrl(URI gitHubUrl) {
  ...
  public ExtendedContactDto twitchUrl(URI twitchUrl) {
  ...
  public void setTwitchUrl(URI twitchUrl) {
    this.twitchUrl = twitchUrl;
  }


  public ExtendedContactDto redditUrl(URI redditUrl) {
   ...
   */
  @javax.annotation.Nullable
  public URI getRedditUrl() {
    return redditUrl;
  }

  public void setRedditUrl(URI redditUrl) {
    this.redditUrl = redditUrl;
  }


  public ExtendedContactDto tikTokUrl(URI tikTokUrl) {
   ...
   */
  @javax.annotation.Nullable
  public URI getTikTokUrl() {
    return tikTokUrl;
  }

  public void setTikTokUrl(URI tikTokUrl) {
    this.tikTokUrl = tikTokUrl;
  }


  public ExtendedContactDto websiteUrl(URI websiteUrl) {
  ...
  public ExtendedContactDto twitterUrl(URI twitterUrl) {
  ...
  public ExtendedContactDto facebookUrl(URI facebookUrl) {
  ...
  public ExtendedContactDto youTubeUrl(URI youTubeUrl) {
  ...
  public void setYouTubeUrl(URI youTubeUrl) {
    this.youTubeUrl = youTubeUrl;
  }


  public ExtendedContactDto linkedInUrl(URI linkedInUrl) {
  ...
  public void setLinkedInUrl(URI linkedInUrl) {
    this.linkedInUrl = linkedInUrl;
  }


  public ExtendedContactDto instagramUrl(URI instagramUrl) {
   ...
   */
  @javax.annotation.Nullable
  public URI getInstagramUrl() {
    return instagramUrl;
  }

  public void setInstagramUrl(URI instagramUrl) {
    this.instagramUrl = instagramUrl;
  }


  public ExtendedContactDto githubUsername(String githubUsername) {
  ...
  public ExtendedContactDto duns(String duns) {
    this.duns = duns;
    return this;
  }
  ...
  public ExtendedContactDto taxId(String taxId) {
    this.taxId = taxId;
    return this;
  }
  ...
  public ExtendedContactDto about(String about) {
    this.about = about;
    return this;
  }
  ...
  public ExtendedContactDto street(String street) {
    this.street = street;
    return this;
  }
  ...
  public ExtendedContactDto cartId(String cartId) {
    this.cartId = cartId;
    return this;
  }
  ...
  public ExtendedContactDto cityId(String cityId) {
    this.cityId = cityId;
    return this;
  }
  ...
  public ExtendedContactDto zipCode(String zipCode) {
  ...
  public ExtendedContactDto stateId(String stateId) {
  ...
  public ExtendedContactDto walletId(String walletId) {
  ...
  public ExtendedContactDto faxNumber(String faxNumber) {
  ...
  public ExtendedContactDto postalCode(String postalCode) {
  ...
  public ExtendedContactDto currencyId(String currencyId) {
  ...
  public ExtendedContactDto streetLine1(String streetLine1) {
  ...
  public ExtendedContactDto streetLine2(String streetLine2) {
  ...
  public ExtendedContactDto territoryId(String territoryId) {
  ...
  public ExtendedContactDto mobilePhone(String mobilePhone) {
  ...
  public ExtendedContactDto enrollmentId(String enrollmentId) {
  ...
  public ExtendedContactDto annualRevenue(String annualRevenue) {
  ...
  public ExtendedContactDto relatedUserId(String relatedUserId) {
  ...
  public ExtendedContactDto businessPhone(String businessPhone) {
  ...
  public ExtendedContactDto ownerContactId(String ownerContactId) {
  ...
  public ExtendedContactDto relatedTenantId(String relatedTenantId) {
  ...
  public ExtendedContactDto activityFeedId(String activityFeedId) {
  ...
  public ExtendedContactDto parentContactId(String parentContactId) {
  ...
  public ExtendedContactDto identityProvider(String identityProvider) {
  ...
  public ExtendedContactDto partnerProfileId(String partnerProfileId) {
  ...
  public ExtendedContactDto primaryContactId(String primaryContactId) {
  ...
  public ExtendedContactDto activeDirectoryId(String activeDirectoryId) {
  ...
  public ExtendedContactDto identityProviderAccessToken(String identityProviderAccessToken) {
  ...
  public ExtendedContactDto birthday(OffsetDateTime birthday) {
  ...
  public ExtendedContactDto cart(CartDto cart) {
    this.cart = cart;
    return this;
  }
  ...
  public ExtendedContactDto wallet(WalletDto wallet) {
    this.wallet = wallet;
    return this;
  }
  ...
  public ExtendedContactDto socialProfile(SocialProfileDto socialProfile) {
  ...
  public ExtendedContactDto parentContact(SimpleContactDto parentContact) {
   ...
   */
  @javax.annotation.Nullable
  public SimpleContactDto getParentContact() {
    return parentContact;
  }

  public void setParentContact(SimpleContactDto parentContact) {
    this.parentContact = parentContact;
  }


  public ExtendedContactDto primaryContact(SimpleContactDto primaryContact) {
   ...
   */
  @javax.annotation.Nullable
  public SimpleContactDto getPrimaryContact() {
    return primaryContact;
  }

  public void setPrimaryContact(SimpleContactDto primaryContact) {
    this.primaryContact = primaryContact;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExtendedContactDto extendedContactDto = (ExtendedContactDto) o;
    return Objects.equals(this.id, extendedContactDto.id) &&
        Objects.equals(this.timestamp, extendedContactDto.timestamp) &&
        Objects.equals(this.qualifiedName, extendedContactDto.qualifiedName) &&
        Objects.equals(this.tenantId, extendedContactDto.tenantId) &&
        Objects.equals(this.type, extendedContactDto.type) &&
        Objects.equals(this.email, extendedContactDto.email) &&
        Objects.equals(this.phone, extendedContactDto.phone) &&
        Objects.equals(this.publicName, extendedContactDto.publicName) &&
        Objects.equals(this.firstName, extendedContactDto.firstName) &&
        Objects.equals(this.lastName, extendedContactDto.lastName) &&
        Objects.equals(this.jobTitle, extendedContactDto.jobTitle) &&
        Objects.equals(this.coverUrl, extendedContactDto.coverUrl) &&
        Objects.equals(this.avatarUrl, extendedContactDto.avatarUrl) &&
        Objects.equals(this.countryId, extendedContactDto.countryId) &&
        Objects.equals(this.timezoneId, extendedContactDto.timezoneId) &&
        Objects.equals(this.languageId, extendedContactDto.languageId) &&
        Objects.equals(this.socialProfileId, extendedContactDto.socialProfileId) &&
        Objects.equals(this.webUrl, extendedContactDto.webUrl) &&
        Objects.equals(this.gitHubUrl, extendedContactDto.gitHubUrl) &&
        Objects.equals(this.twitchUrl, extendedContactDto.twitchUrl) &&
        Objects.equals(this.redditUrl, extendedContactDto.redditUrl) &&
        Objects.equals(this.tikTokUrl, extendedContactDto.tikTokUrl) &&
        Objects.equals(this.websiteUrl, extendedContactDto.websiteUrl) &&
        Objects.equals(this.twitterUrl, extendedContactDto.twitterUrl) &&
        Objects.equals(this.facebookUrl, extendedContactDto.facebookUrl) &&
        Objects.equals(this.youTubeUrl, extendedContactDto.youTubeUrl) &&
        Objects.equals(this.linkedInUrl, extendedContactDto.linkedInUrl) &&
        Objects.equals(this.instagramUrl, extendedContactDto.instagramUrl) &&
        Objects.equals(this.githubUsername, extendedContactDto.githubUsername) &&
        Objects.equals(this.duns, extendedContactDto.duns) &&
        Objects.equals(this.taxId, extendedContactDto.taxId) &&
        Objects.equals(this.about, extendedContactDto.about) &&
        Objects.equals(this.street, extendedContactDto.street) &&
        Objects.equals(this.cartId, extendedContactDto.cartId) &&
        Objects.equals(this.cityId, extendedContactDto.cityId) &&
        Objects.equals(this.zipCode, extendedContactDto.zipCode) &&
        Objects.equals(this.stateId, extendedContactDto.stateId) &&
        Objects.equals(this.walletId, extendedContactDto.walletId) &&
        Objects.equals(this.faxNumber, extendedContactDto.faxNumber) &&
        Objects.equals(this.postalCode, extendedContactDto.postalCode) &&
        Objects.equals(this.currencyId, extendedContactDto.currencyId) &&
        Objects.equals(this.streetLine1, extendedContactDto.streetLine1) &&
        Objects.equals(this.streetLine2, extendedContactDto.streetLine2) &&
        Objects.equals(this.territoryId, extendedContactDto.territoryId) &&
        Objects.equals(this.mobilePhone, extendedContactDto.mobilePhone) &&
        Objects.equals(this.enrollmentId, extendedContactDto.enrollmentId) &&
        Objects.equals(this.annualRevenue, extendedContactDto.annualRevenue) &&
        Objects.equals(this.relatedUserId, extendedContactDto.relatedUserId) &&
        Objects.equals(this.businessPhone, extendedContactDto.businessPhone) &&
        Objects.equals(this.ownerContactId, extendedContactDto.ownerContactId) &&
        Objects.equals(this.relatedTenantId, extendedContactDto.relatedTenantId) &&
        Objects.equals(this.activityFeedId, extendedContactDto.activityFeedId) &&
        Objects.equals(this.parentContactId, extendedContactDto.parentContactId) &&
        Objects.equals(this.identityProvider, extendedContactDto.identityProvider) &&
        Objects.equals(this.partnerProfileId, extendedContactDto.partnerProfileId) &&
        Objects.equals(this.primaryContactId, extendedContactDto.primaryContactId) &&
        Objects.equals(this.activeDirectoryId, extendedContactDto.activeDirectoryId) &&
        Objects.equals(this.identityProviderAccessToken, extendedContactDto.identityProviderAccessToken) &&
        Objects.equals(this.birthday, extendedContactDto.birthday) &&
        Objects.equals(this.cart, extendedContactDto.cart) &&
        Objects.equals(this.wallet, extendedContactDto.wallet) &&
        Objects.equals(this.socialProfile, extendedContactDto.socialProfile) &&
        Objects.equals(this.parentContact, extendedContactDto.parentContact) &&
        Objects.equals(this.primaryContact, extendedContactDto.primaryContact);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExtendedContactDto {\n");
    ...
    sb.append("    parentContact: ").append(toIndentedString(parentContact)).append("\n");
  ...
  static {
    ...
    openapiFields.add("parentContact");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExtendedContactDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExtendedContactDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExtendedContactDto is not found in the empty JSON string", ExtendedContactDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExtendedContactDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExtendedContactDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `parentContact`
      if (jsonObj.get("parentContact") != null && !jsonObj.get("parentContact").isJsonNull()) {
        SimpleContactDto.validateJsonElement(jsonObj.get("parentContact"));
      }
      // validate the optional field `primaryContact`
      if (jsonObj.get("primaryContact") != null && !jsonObj.get("primaryContact").isJsonNull()) {
        SimpleContactDto.validateJsonElement(jsonObj.get("primaryContact"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExtendedContactDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExtendedContactDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExtendedContactDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExtendedContactDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ExtendedContactDto>() {
           @Override
           public void write(JsonWriter out, ExtendedContactDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExtendedContactDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExtendedContactDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExtendedContactDto
   * @throws IOException if the JSON string is invalid with respect to ExtendedContactDto
   */
  public static ExtendedContactDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExtendedContactDto.class);
  }

  /**
   * Convert an instance of ExtendedContactDto to an JSON string
   *
   * @return JSON string
   */
