...
public class ContactProfileCreateDto {
  ...
  public ContactProfileCreateDto() {
  }

  public ContactProfileCreateDto id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public ContactProfileCreateDto timestamp(OffsetDateTime timestamp) {
  ...
  public ContactProfileCreateDto type(String type) {
    this.type = type;
    return this;
  }
  ...
  public ContactProfileCreateDto contactId(String contactId) {
  ...
  public ContactProfileCreateDto contact(ContactCreateDto contact) {
  ...
  public ContactProfileCreateDto about(String about) {
    this.about = about;
    return this;
  }
  ...
  public ContactProfileCreateDto avatarUrl(String avatarUrl) {
  ...
  public ContactProfileCreateDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public ContactProfileCreateDto dataLabel(String dataLabel) {
  ...
  public ContactProfileCreateDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public ContactProfileCreateDto data1Label(String data1Label) {
  ...
  public ContactProfileCreateDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public ContactProfileCreateDto data2Label(String data2Label) {
  ...
  public ContactProfileCreateDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public ContactProfileCreateDto data3Label(String data3Label) {
  ...
  public ContactProfileCreateDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public ContactProfileCreateDto data4Label(String data4Label) {
  ...
  public ContactProfileCreateDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public ContactProfileCreateDto data5Label(String data5Label) {
  ...
  public ContactProfileCreateDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public ContactProfileCreateDto data6Label(String data6Label) {
  ...
  public ContactProfileCreateDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public ContactProfileCreateDto data7Label(String data7Label) {
  ...
  public ContactProfileCreateDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public ContactProfileCreateDto data8Label(String data8Label) {
  ...
  public ContactProfileCreateDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public ContactProfileCreateDto data9Label(String data9Label) {
  ...
  public boolean equals(Object o) {
    ...
    ContactProfileCreateDto contactProfileCreateDto = (ContactProfileCreateDto) o;
    return Objects.equals(this.id, contactProfileCreateDto.id) &&
        Objects.equals(this.timestamp, contactProfileCreateDto.timestamp) &&
        Objects.equals(this.type, contactProfileCreateDto.type) &&
        Objects.equals(this.contactId, contactProfileCreateDto.contactId) &&
        Objects.equals(this.contact, contactProfileCreateDto.contact) &&
        Objects.equals(this.about, contactProfileCreateDto.about) &&
        Objects.equals(this.avatarUrl, contactProfileCreateDto.avatarUrl) &&
        Objects.equals(this.data, contactProfileCreateDto.data) &&
        Objects.equals(this.dataLabel, contactProfileCreateDto.dataLabel) &&
        Objects.equals(this.data1, contactProfileCreateDto.data1) &&
        Objects.equals(this.data1Label, contactProfileCreateDto.data1Label) &&
        Objects.equals(this.data2, contactProfileCreateDto.data2) &&
        Objects.equals(this.data2Label, contactProfileCreateDto.data2Label) &&
        Objects.equals(this.data3, contactProfileCreateDto.data3) &&
        Objects.equals(this.data3Label, contactProfileCreateDto.data3Label) &&
        Objects.equals(this.data4, contactProfileCreateDto.data4) &&
        Objects.equals(this.data4Label, contactProfileCreateDto.data4Label) &&
        Objects.equals(this.data5, contactProfileCreateDto.data5) &&
        Objects.equals(this.data5Label, contactProfileCreateDto.data5Label) &&
        Objects.equals(this.data6, contactProfileCreateDto.data6) &&
        Objects.equals(this.data6Label, contactProfileCreateDto.data6Label) &&
        Objects.equals(this.data7, contactProfileCreateDto.data7) &&
        Objects.equals(this.data7Label, contactProfileCreateDto.data7Label) &&
        Objects.equals(this.data8, contactProfileCreateDto.data8) &&
        Objects.equals(this.data8Label, contactProfileCreateDto.data8Label) &&
        Objects.equals(this.data9, contactProfileCreateDto.data9) &&
        Objects.equals(this.data9Label, contactProfileCreateDto.data9Label);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactProfileCreateDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContactProfileCreateDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContactProfileCreateDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactProfileCreateDto is not found in the empty JSON string", ContactProfileCreateDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContactProfileCreateDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactProfileCreateDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactProfileCreateDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactProfileCreateDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactProfileCreateDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactProfileCreateDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactProfileCreateDto>() {
           @Override
           public void write(JsonWriter out, ContactProfileCreateDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactProfileCreateDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContactProfileCreateDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContactProfileCreateDto
   * @throws IOException if the JSON string is invalid with respect to ContactProfileCreateDto
   */
  public static ContactProfileCreateDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactProfileCreateDto.class);
  }

  /**
   * Convert an instance of ContactProfileCreateDto to an JSON string
   *
   * @return JSON string
   */
