...
public class MethodInfo {
  ...
  static {
    ...
    openapiFields.add("returnParameter");
    openapiFields.add("returnType");
    openapiFields.add("returnTypeCustomAttributes");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MethodInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MethodInfo is not found in the empty JSON string", MethodInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MethodInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MethodInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
