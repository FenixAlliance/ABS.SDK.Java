...
public class SupplierProfileCreateDto {
  ...
  public SupplierProfileCreateDto() {
  }

  public SupplierProfileCreateDto id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public SupplierProfileCreateDto timestamp(OffsetDateTime timestamp) {
  ...
  public SupplierProfileCreateDto type(String type) {
    this.type = type;
    return this;
  }
  ...
  public SupplierProfileCreateDto contactId(String contactId) {
  ...
  public SupplierProfileCreateDto contact(ContactCreateDto contact) {
  ...
  public SupplierProfileCreateDto about(String about) {
    this.about = about;
    return this;
  }
  ...
  public SupplierProfileCreateDto avatarUrl(String avatarUrl) {
  ...
  public SupplierProfileCreateDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public SupplierProfileCreateDto dataLabel(String dataLabel) {
  ...
  public SupplierProfileCreateDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public SupplierProfileCreateDto data1Label(String data1Label) {
  ...
  public SupplierProfileCreateDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public SupplierProfileCreateDto data2Label(String data2Label) {
  ...
  public SupplierProfileCreateDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public SupplierProfileCreateDto data3Label(String data3Label) {
  ...
  public SupplierProfileCreateDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public SupplierProfileCreateDto data4Label(String data4Label) {
  ...
  public SupplierProfileCreateDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public SupplierProfileCreateDto data5Label(String data5Label) {
  ...
  public SupplierProfileCreateDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public SupplierProfileCreateDto data6Label(String data6Label) {
  ...
  public SupplierProfileCreateDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public SupplierProfileCreateDto data7Label(String data7Label) {
  ...
  public SupplierProfileCreateDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public SupplierProfileCreateDto data8Label(String data8Label) {
  ...
  public SupplierProfileCreateDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public SupplierProfileCreateDto data9Label(String data9Label) {
  ...
  public boolean equals(Object o) {
    ...
    SupplierProfileCreateDto supplierProfileCreateDto = (SupplierProfileCreateDto) o;
    return Objects.equals(this.id, supplierProfileCreateDto.id) &&
        Objects.equals(this.timestamp, supplierProfileCreateDto.timestamp) &&
        Objects.equals(this.type, supplierProfileCreateDto.type) &&
        Objects.equals(this.contactId, supplierProfileCreateDto.contactId) &&
        Objects.equals(this.contact, supplierProfileCreateDto.contact) &&
        Objects.equals(this.about, supplierProfileCreateDto.about) &&
        Objects.equals(this.avatarUrl, supplierProfileCreateDto.avatarUrl) &&
        Objects.equals(this.data, supplierProfileCreateDto.data) &&
        Objects.equals(this.dataLabel, supplierProfileCreateDto.dataLabel) &&
        Objects.equals(this.data1, supplierProfileCreateDto.data1) &&
        Objects.equals(this.data1Label, supplierProfileCreateDto.data1Label) &&
        Objects.equals(this.data2, supplierProfileCreateDto.data2) &&
        Objects.equals(this.data2Label, supplierProfileCreateDto.data2Label) &&
        Objects.equals(this.data3, supplierProfileCreateDto.data3) &&
        Objects.equals(this.data3Label, supplierProfileCreateDto.data3Label) &&
        Objects.equals(this.data4, supplierProfileCreateDto.data4) &&
        Objects.equals(this.data4Label, supplierProfileCreateDto.data4Label) &&
        Objects.equals(this.data5, supplierProfileCreateDto.data5) &&
        Objects.equals(this.data5Label, supplierProfileCreateDto.data5Label) &&
        Objects.equals(this.data6, supplierProfileCreateDto.data6) &&
        Objects.equals(this.data6Label, supplierProfileCreateDto.data6Label) &&
        Objects.equals(this.data7, supplierProfileCreateDto.data7) &&
        Objects.equals(this.data7Label, supplierProfileCreateDto.data7Label) &&
        Objects.equals(this.data8, supplierProfileCreateDto.data8) &&
        Objects.equals(this.data8Label, supplierProfileCreateDto.data8Label) &&
        Objects.equals(this.data9, supplierProfileCreateDto.data9) &&
        Objects.equals(this.data9Label, supplierProfileCreateDto.data9Label);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, type, contactId, contact, about, avatarUrl, data, dataLabel, data1, data1Label, data2, data2Label, data3, data3Label, data4, data4Label, data5, data5Label, data6, data6Label, data7, data7Label, data8, data8Label, data9, data9Label);
  }
  ...
  public String toString() {
    ...
    sb.append("class SupplierProfileCreateDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SupplierProfileCreateDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SupplierProfileCreateDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SupplierProfileCreateDto is not found in the empty JSON string", SupplierProfileCreateDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SupplierProfileCreateDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SupplierProfileCreateDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SupplierProfileCreateDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SupplierProfileCreateDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SupplierProfileCreateDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SupplierProfileCreateDto.class));

       return (TypeAdapter<T>) new TypeAdapter<SupplierProfileCreateDto>() {
           @Override
           public void write(JsonWriter out, SupplierProfileCreateDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SupplierProfileCreateDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SupplierProfileCreateDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SupplierProfileCreateDto
   * @throws IOException if the JSON string is invalid with respect to SupplierProfileCreateDto
   */
  public static SupplierProfileCreateDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SupplierProfileCreateDto.class);
  }

  /**
   * Convert an instance of SupplierProfileCreateDto to an JSON string
   *
   * @return JSON string
   */
