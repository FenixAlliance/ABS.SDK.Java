...
public class SupplierProfileUpdateDto {
  ...
  public SupplierProfileUpdateDto() {
  }

  public SupplierProfileUpdateDto type(String type) {
    this.type = type;
    return this;
  }
  ...
  public SupplierProfileUpdateDto contactId(String contactId) {
  ...
  public SupplierProfileUpdateDto about(String about) {
    this.about = about;
    return this;
  }
  ...
  public SupplierProfileUpdateDto avatarUrl(String avatarUrl) {
  ...
  public SupplierProfileUpdateDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public SupplierProfileUpdateDto dataLabel(String dataLabel) {
  ...
  public SupplierProfileUpdateDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public SupplierProfileUpdateDto data1Label(String data1Label) {
  ...
  public SupplierProfileUpdateDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public SupplierProfileUpdateDto data2Label(String data2Label) {
  ...
  public SupplierProfileUpdateDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public SupplierProfileUpdateDto data3Label(String data3Label) {
  ...
  public SupplierProfileUpdateDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public SupplierProfileUpdateDto data4Label(String data4Label) {
  ...
  public SupplierProfileUpdateDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public SupplierProfileUpdateDto data5Label(String data5Label) {
  ...
  public SupplierProfileUpdateDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public SupplierProfileUpdateDto data6Label(String data6Label) {
  ...
  public SupplierProfileUpdateDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public SupplierProfileUpdateDto data7Label(String data7Label) {
  ...
  public SupplierProfileUpdateDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public SupplierProfileUpdateDto data8Label(String data8Label) {
  ...
  public SupplierProfileUpdateDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public SupplierProfileUpdateDto data9Label(String data9Label) {
  ...
  public boolean equals(Object o) {
    ...
    SupplierProfileUpdateDto supplierProfileUpdateDto = (SupplierProfileUpdateDto) o;
    return Objects.equals(this.type, supplierProfileUpdateDto.type) &&
        Objects.equals(this.contactId, supplierProfileUpdateDto.contactId) &&
        Objects.equals(this.about, supplierProfileUpdateDto.about) &&
        Objects.equals(this.avatarUrl, supplierProfileUpdateDto.avatarUrl) &&
        Objects.equals(this.data, supplierProfileUpdateDto.data) &&
        Objects.equals(this.dataLabel, supplierProfileUpdateDto.dataLabel) &&
        Objects.equals(this.data1, supplierProfileUpdateDto.data1) &&
        Objects.equals(this.data1Label, supplierProfileUpdateDto.data1Label) &&
        Objects.equals(this.data2, supplierProfileUpdateDto.data2) &&
        Objects.equals(this.data2Label, supplierProfileUpdateDto.data2Label) &&
        Objects.equals(this.data3, supplierProfileUpdateDto.data3) &&
        Objects.equals(this.data3Label, supplierProfileUpdateDto.data3Label) &&
        Objects.equals(this.data4, supplierProfileUpdateDto.data4) &&
        Objects.equals(this.data4Label, supplierProfileUpdateDto.data4Label) &&
        Objects.equals(this.data5, supplierProfileUpdateDto.data5) &&
        Objects.equals(this.data5Label, supplierProfileUpdateDto.data5Label) &&
        Objects.equals(this.data6, supplierProfileUpdateDto.data6) &&
        Objects.equals(this.data6Label, supplierProfileUpdateDto.data6Label) &&
        Objects.equals(this.data7, supplierProfileUpdateDto.data7) &&
        Objects.equals(this.data7Label, supplierProfileUpdateDto.data7Label) &&
        Objects.equals(this.data8, supplierProfileUpdateDto.data8) &&
        Objects.equals(this.data8Label, supplierProfileUpdateDto.data8Label) &&
        Objects.equals(this.data9, supplierProfileUpdateDto.data9) &&
        Objects.equals(this.data9Label, supplierProfileUpdateDto.data9Label);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, contactId, about, avatarUrl, data, dataLabel, data1, data1Label, data2, data2Label, data3, data3Label, data4, data4Label, data5, data5Label, data6, data6Label, data7, data7Label, data8, data8Label, data9, data9Label);
  }
  ...
  public String toString() {
    ...
    sb.append("class SupplierProfileUpdateDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SupplierProfileUpdateDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SupplierProfileUpdateDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SupplierProfileUpdateDto is not found in the empty JSON string", SupplierProfileUpdateDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SupplierProfileUpdateDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SupplierProfileUpdateDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SupplierProfileUpdateDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SupplierProfileUpdateDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SupplierProfileUpdateDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SupplierProfileUpdateDto.class));

       return (TypeAdapter<T>) new TypeAdapter<SupplierProfileUpdateDto>() {
           @Override
           public void write(JsonWriter out, SupplierProfileUpdateDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SupplierProfileUpdateDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SupplierProfileUpdateDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SupplierProfileUpdateDto
   * @throws IOException if the JSON string is invalid with respect to SupplierProfileUpdateDto
   */
  public static SupplierProfileUpdateDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SupplierProfileUpdateDto.class);
  }

  /**
   * Convert an instance of SupplierProfileUpdateDto to an JSON string
   *
   * @return JSON string
   */
