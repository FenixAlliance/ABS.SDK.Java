...
public class ProjectTimeLogDto {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, projectId, projectTaskId, taskCategoryId, projectPeriodId, responsibleContactId, creatorContactId, recordType, timeSpan, logDate, comments, type);
  }
