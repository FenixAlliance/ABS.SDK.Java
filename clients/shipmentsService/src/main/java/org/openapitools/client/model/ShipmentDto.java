...
public class ShipmentDto {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, trackingCode, isInternational, shipped, delivered, shipmentTimestamp, deliveryTimestamp, expectedShippingDate, expectedDeliveryDate, shippingTerms, orderId, tenantId);
  }
