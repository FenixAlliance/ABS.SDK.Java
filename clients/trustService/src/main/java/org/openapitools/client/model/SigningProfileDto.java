...
public class SigningProfileDto {
  ...
  public SigningProfileDto id(String id) {
    this.id = id;
    return this;
  }
  ...
  public SigningProfileDto timestamp(OffsetDateTime timestamp) {
  ...
  public SigningProfileDto contactId(String contactId) {
  ...
  public SigningProfileDto tenantId(String tenantId) {
  ...
  public SigningProfileDto type(String type) {
    this.type = type;
    return this;
  }
  ...
  public SigningProfileDto enrollmentId(String enrollmentId) {
  ...
  public SigningProfileDto about(String about) {
    this.about = about;
    return this;
  }
  ...
  public SigningProfileDto verified(Boolean verified) {
  ...
  public SigningProfileDto submitted(Boolean submitted) {
  ...
  public SigningProfileDto avatarUrl(String avatarUrl) {
  ...
  public SigningProfileDto contact(ContactDto contact) {
  ...
  public SigningProfileDto verificationTimestamp(OffsetDateTime verificationTimestamp) {
  ...
  public SigningProfileDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public SigningProfileDto dataLabel(String dataLabel) {
  ...
  public SigningProfileDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public SigningProfileDto data1Label(String data1Label) {
  ...
  public SigningProfileDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public SigningProfileDto data2Label(String data2Label) {
  ...
  public SigningProfileDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public SigningProfileDto data3Label(String data3Label) {
  ...
  public SigningProfileDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public SigningProfileDto data4Label(String data4Label) {
  ...
  public SigningProfileDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public SigningProfileDto data5Label(String data5Label) {
  ...
  public SigningProfileDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public SigningProfileDto data6Label(String data6Label) {
  ...
  public SigningProfileDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public SigningProfileDto data7Label(String data7Label) {
  ...
  public SigningProfileDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public SigningProfileDto data8Label(String data8Label) {
  ...
  public SigningProfileDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public SigningProfileDto data9Label(String data9Label) {
  ...
  public SigningProfileDto contactName(String contactName) {
  ...
  public SigningProfileDto signatureFormat(SignatureFormatEnum signatureFormat) {
  ...
  public SigningProfileDto signaturePurpose(SignaturePurposeEnum signaturePurpose) {
  ...
  public SigningProfileDto digestAlgorithm(String digestAlgorithm) {
  ...
  public SigningProfileDto signatureAlgorithm(String signatureAlgorithm) {
  ...
  public SigningProfileDto canonicalizationAlgorithm(String canonicalizationAlgorithm) {
  ...
  public SigningProfileDto policyIdentifier(String policyIdentifier) {
  ...
  public SigningProfileDto policyUri(String policyUri) {
  ...
  public SigningProfileDto authorityProfile(String authorityProfile) {
  ...
  public SigningProfileDto isActive(Boolean isActive) {
  ...
  public SigningProfileDto defaultForDocumentType(String defaultForDocumentType) {
  ...
  public boolean equals(Object o) {
    ...
    SigningProfileDto signingProfileDto = (SigningProfileDto) o;
    return Objects.equals(this.id, signingProfileDto.id) &&
        Objects.equals(this.timestamp, signingProfileDto.timestamp) &&
        Objects.equals(this.contactId, signingProfileDto.contactId) &&
        Objects.equals(this.tenantId, signingProfileDto.tenantId) &&
        Objects.equals(this.type, signingProfileDto.type) &&
        Objects.equals(this.enrollmentId, signingProfileDto.enrollmentId) &&
        Objects.equals(this.about, signingProfileDto.about) &&
        Objects.equals(this.verified, signingProfileDto.verified) &&
        Objects.equals(this.submitted, signingProfileDto.submitted) &&
        Objects.equals(this.avatarUrl, signingProfileDto.avatarUrl) &&
        Objects.equals(this.contact, signingProfileDto.contact) &&
        Objects.equals(this.qualifiedName, signingProfileDto.qualifiedName) &&
        Objects.equals(this.verificationTimestamp, signingProfileDto.verificationTimestamp) &&
        Objects.equals(this.data, signingProfileDto.data) &&
        Objects.equals(this.dataLabel, signingProfileDto.dataLabel) &&
        Objects.equals(this.data1, signingProfileDto.data1) &&
        Objects.equals(this.data1Label, signingProfileDto.data1Label) &&
        Objects.equals(this.data2, signingProfileDto.data2) &&
        Objects.equals(this.data2Label, signingProfileDto.data2Label) &&
        Objects.equals(this.data3, signingProfileDto.data3) &&
        Objects.equals(this.data3Label, signingProfileDto.data3Label) &&
        Objects.equals(this.data4, signingProfileDto.data4) &&
        Objects.equals(this.data4Label, signingProfileDto.data4Label) &&
        Objects.equals(this.data5, signingProfileDto.data5) &&
        Objects.equals(this.data5Label, signingProfileDto.data5Label) &&
        Objects.equals(this.data6, signingProfileDto.data6) &&
        Objects.equals(this.data6Label, signingProfileDto.data6Label) &&
        Objects.equals(this.data7, signingProfileDto.data7) &&
        Objects.equals(this.data7Label, signingProfileDto.data7Label) &&
        Objects.equals(this.data8, signingProfileDto.data8) &&
        Objects.equals(this.data8Label, signingProfileDto.data8Label) &&
        Objects.equals(this.data9, signingProfileDto.data9) &&
        Objects.equals(this.data9Label, signingProfileDto.data9Label) &&
        Objects.equals(this.contactName, signingProfileDto.contactName) &&
        Objects.equals(this.signatureFormat, signingProfileDto.signatureFormat) &&
        Objects.equals(this.signaturePurpose, signingProfileDto.signaturePurpose) &&
        Objects.equals(this.digestAlgorithm, signingProfileDto.digestAlgorithm) &&
        Objects.equals(this.signatureAlgorithm, signingProfileDto.signatureAlgorithm) &&
        Objects.equals(this.canonicalizationAlgorithm, signingProfileDto.canonicalizationAlgorithm) &&
        Objects.equals(this.policyIdentifier, signingProfileDto.policyIdentifier) &&
        Objects.equals(this.policyUri, signingProfileDto.policyUri) &&
        Objects.equals(this.authorityProfile, signingProfileDto.authorityProfile) &&
        Objects.equals(this.isActive, signingProfileDto.isActive) &&
        Objects.equals(this.defaultForDocumentType, signingProfileDto.defaultForDocumentType);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, contactId, tenantId, type, enrollmentId, about, verified, submitted, avatarUrl, contact, qualifiedName, verificationTimestamp, data, dataLabel, data1, data1Label, data2, data2Label, data3, data3Label, data4, data4Label, data5, data5Label, data6, data6Label, data7, data7Label, data8, data8Label, data9, data9Label, contactName, signatureFormat, signaturePurpose, digestAlgorithm, signatureAlgorithm, canonicalizationAlgorithm, policyIdentifier, policyUri, authorityProfile, isActive, defaultForDocumentType);
  }
  ...
  public String toString() {
    ...
    sb.append("class SigningProfileDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SigningProfileDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SigningProfileDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SigningProfileDto is not found in the empty JSON string", SigningProfileDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SigningProfileDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SigningProfileDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SigningProfileDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SigningProfileDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SigningProfileDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SigningProfileDto.class));

       return (TypeAdapter<T>) new TypeAdapter<SigningProfileDto>() {
           @Override
           public void write(JsonWriter out, SigningProfileDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SigningProfileDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SigningProfileDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SigningProfileDto
   * @throws IOException if the JSON string is invalid with respect to SigningProfileDto
   */
  public static SigningProfileDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SigningProfileDto.class);
  }

  /**
   * Convert an instance of SigningProfileDto to an JSON string
   *
   * @return JSON string
   */
