...
public class SigningEngineApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public SigningEngineApi() {
        this(Configuration.getDefaultApiClient());
    }

    public SigningEngineApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getProvidersAsync
    ...
    /**
     * List signing providers (asynchronously)
     * Returns the registered alpha signing providers (Noop / Manual / External). OData-queryable.
     * @param tenantId  (required)
     * @param apiVersion  (optional)
     * @param xApiVersion  (optional)
    ...
    /**
     * Build call for getProvidersCountAsync
     * @param tenantId  (required)
     * @param apiVersion  (optional)
     * @param xApiVersion  (optional)
     * @param trustSigningProviderDescriptorDtoCollectionQueryParameters  (optional)
    ...
    /**
     * Count signing providers (asynchronously)
     * Returns the count of registered alpha signing providers. OData-queryable.
     * @param tenantId  (required)
     * @param apiVersion  (optional)
     * @param xApiVersion  (optional)
     ...
     */
    public okhttp3.Call previewAsyncCall(UUID tenantId, String apiVersion, String xApiVersion, TrustSigningRequestDto trustSigningRequestDto, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = trustSigningRequestDto;

        // create path and map variables
        String localVarPath = "/api/v2/TrustService/SigningEngine/Preview";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call previewAsyncValidateBeforeCall(UUID tenantId, String apiVersion, String xApiVersion, TrustSigningRequestDto trustSigningRequestDto, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'tenantId' is set
        if (tenantId == null) {
            throw new ApiException("Missing the required parameter 'tenantId' when calling previewAsync(Async)");
        }

        return previewAsyncCall(tenantId, apiVersion, xApiVersion, trustSigningRequestDto, _callback);
     ...
     */
    public TrustSigningReadinessDtoEnvelope previewAsync(UUID tenantId, String apiVersion, String xApiVersion, TrustSigningRequestDto trustSigningRequestDto) throws ApiException {
        ApiResponse<TrustSigningReadinessDtoEnvelope> localVarResp = previewAsyncWithHttpInfo(tenantId, apiVersion, xApiVersion, trustSigningRequestDto);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TrustSigningReadinessDtoEnvelope> previewAsyncWithHttpInfo(UUID tenantId, String apiVersion, String xApiVersion, TrustSigningRequestDto trustSigningRequestDto) throws ApiException {
        okhttp3.Call localVarCall = previewAsyncValidateBeforeCall(tenantId, apiVersion, xApiVersion, trustSigningRequestDto, null);
        Type localVarReturnType = new TypeToken<TrustSigningReadinessDtoEnvelope>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Preview signing readiness (asynchronously)
     * Side-effect-free: validates a signing request and reports whether it can proceed and with what policy.
     * @param tenantId  (required)
     * @param apiVersion  (optional)
     * @param xApiVersion  (optional)
     ...
     */
    public okhttp3.Call previewAsyncAsync(UUID tenantId, String apiVersion, String xApiVersion, TrustSigningRequestDto trustSigningRequestDto, final ApiCallback<TrustSigningReadinessDtoEnvelope> _callback) throws ApiException {

        okhttp3.Call localVarCall = previewAsyncValidateBeforeCall(tenantId, apiVersion, xApiVersion, trustSigningRequestDto, _callback);
        Type localVarReturnType = new TypeToken<TrustSigningReadinessDtoEnvelope>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
