...
public class Example {
  public static void main(String[] args) {
    ...
    String xApiVersion = "xApiVersion_example"; // String | 
    try {
      SigningProfileDtoListEnvelope result = apiInstance.getSigningProfilesAsync(tenantId, apiVersion, xApiVersion);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String xApiVersion = "xApiVersion_example"; // String | 
    try {
      Int32Envelope result = apiInstance.getSigningProfilesCountAsync(tenantId, apiVersion, xApiVersion);
      System.out.println(result);
    } catch (ApiException e) {
...
> EmptyEnvelope patchSigningProfileAsync(tenantId, id, apiVersion, xApiVersion, operation)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      EmptyEnvelope result = apiInstance.patchSigningProfileAsync(tenantId, id, apiVersion, xApiVersion, operation);
      System.out.println(result);
    } catch (ApiException e) {
