...
public class PriceListDto {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, name, startDate, endDate, description, currencyId, tenantId, unitId, unitGroupId, partnerVisible, unitOfMeasureDependant, enrollmentId);
  }
