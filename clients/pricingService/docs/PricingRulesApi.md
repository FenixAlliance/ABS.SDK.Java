...
# **getPricingRuleById**
> PricingRuleDtoEnvelope getPricingRuleById(tenantId, pricingRuleId, apiVersion, xApiVersion)
...
public class Example {
  public static void main(String[] args) {
    ...
    String xApiVersion = "xApiVersion_example"; // String | 
    try {
      PricingRuleDtoEnvelope result = apiInstance.getPricingRuleById(tenantId, pricingRuleId, apiVersion, xApiVersion);
      System.out.println(result);
    } catch (ApiException e) {
