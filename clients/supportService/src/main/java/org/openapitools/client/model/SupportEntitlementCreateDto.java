...
public class SupportEntitlementCreateDto {
  ...
  public SupportEntitlementCreateDto() {
  }

  public SupportEntitlementCreateDto id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public SupportEntitlementCreateDto timestamp(OffsetDateTime timestamp) {
  ...
  public SupportEntitlementCreateDto title(String title) {
    this.title = title;
    return this;
  }
  ...
  public SupportEntitlementCreateDto description(String description) {
  ...
  public SupportEntitlementCreateDto startDateTime(OffsetDateTime startDateTime) {
  ...
  public SupportEntitlementCreateDto endDateTime(OffsetDateTime endDateTime) {
  ...
  public SupportEntitlementCreateDto nextInvoiceDateTime(OffsetDateTime nextInvoiceDateTime) {
  ...
  public SupportEntitlementCreateDto code(String code) {
    this.code = code;
    return this;
  }
  ...
  public SupportEntitlementCreateDto signature(String signature) {
  ...
  public SupportEntitlementCreateDto quantity(Integer quantity) {
  ...
  public SupportEntitlementCreateDto repetitions(Integer repetitions) {
  ...
  public SupportEntitlementCreateDto chargeAttempts(Integer chargeAttempts) {
  ...
  public SupportEntitlementCreateDto freeTrialInDays(Integer freeTrialInDays) {
  ...
  public SupportEntitlementCreateDto gracePeriodInDays(Integer gracePeriodInDays) {
  ...
  public SupportEntitlementCreateDto customRenewalPeriod(Integer customRenewalPeriod) {
  ...
  public SupportEntitlementCreateDto enableAutomaticRenew(Boolean enableAutomaticRenew) {
  ...
  public SupportEntitlementCreateDto enableProRateBilling(Boolean enableProRateBilling) {
  ...
  public SupportEntitlementCreateDto enableUsageThreshold(Boolean enableUsageThreshold) {
  ...
  public SupportEntitlementCreateDto enableAutomaticDisable(Boolean enableAutomaticDisable) {
  ...
  public SupportEntitlementCreateDto enableAutomaticPayments(Boolean enableAutomaticPayments) {
  ...
  public SupportEntitlementCreateDto usageThreshold(Integer usageThreshold) {
  ...
  public SupportEntitlementCreateDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public SupportEntitlementCreateDto dataLabel(String dataLabel) {
  ...
  public SupportEntitlementCreateDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public SupportEntitlementCreateDto data1Label(String data1Label) {
  ...
  public SupportEntitlementCreateDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public SupportEntitlementCreateDto data2Label(String data2Label) {
  ...
  public SupportEntitlementCreateDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public SupportEntitlementCreateDto data3Label(String data3Label) {
  ...
  public SupportEntitlementCreateDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public SupportEntitlementCreateDto data4Label(String data4Label) {
  ...
  public SupportEntitlementCreateDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public SupportEntitlementCreateDto data5Label(String data5Label) {
  ...
  public SupportEntitlementCreateDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public SupportEntitlementCreateDto data6Label(String data6Label) {
  ...
  public SupportEntitlementCreateDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public SupportEntitlementCreateDto data7Label(String data7Label) {
  ...
  public SupportEntitlementCreateDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public SupportEntitlementCreateDto data8Label(String data8Label) {
  ...
  public SupportEntitlementCreateDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public SupportEntitlementCreateDto data9Label(String data9Label) {
  ...
  public SupportEntitlementCreateDto accountHolderID(String accountHolderID) {
  ...
  public SupportEntitlementCreateDto individualID(String individualID) {
  ...
  public SupportEntitlementCreateDto organizationID(String organizationID) {
  ...
  public SupportEntitlementCreateDto receiverBusinessID(String receiverBusinessID) {
  ...
  public SupportEntitlementCreateDto businessID(String businessID) {
  ...
  public SupportEntitlementCreateDto businessProfileRecordID(String businessProfileRecordID) {
  ...
  public SupportEntitlementCreateDto paymentTokenID(String paymentTokenID) {
  ...
  public SupportEntitlementCreateDto walletAccountID(String walletAccountID) {
  ...
  public SupportEntitlementCreateDto securityCertificateID(String securityCertificateID) {
  ...
  public boolean equals(Object o) {
    ...
    SupportEntitlementCreateDto supportEntitlementCreateDto = (SupportEntitlementCreateDto) o;
    return Objects.equals(this.id, supportEntitlementCreateDto.id) &&
        Objects.equals(this.timestamp, supportEntitlementCreateDto.timestamp) &&
        Objects.equals(this.title, supportEntitlementCreateDto.title) &&
        Objects.equals(this.description, supportEntitlementCreateDto.description) &&
        Objects.equals(this.startDateTime, supportEntitlementCreateDto.startDateTime) &&
        Objects.equals(this.endDateTime, supportEntitlementCreateDto.endDateTime) &&
        Objects.equals(this.nextInvoiceDateTime, supportEntitlementCreateDto.nextInvoiceDateTime) &&
        Objects.equals(this.code, supportEntitlementCreateDto.code) &&
        Objects.equals(this.signature, supportEntitlementCreateDto.signature) &&
        Objects.equals(this.quantity, supportEntitlementCreateDto.quantity) &&
        Objects.equals(this.repetitions, supportEntitlementCreateDto.repetitions) &&
        Objects.equals(this.chargeAttempts, supportEntitlementCreateDto.chargeAttempts) &&
        Objects.equals(this.freeTrialInDays, supportEntitlementCreateDto.freeTrialInDays) &&
        Objects.equals(this.gracePeriodInDays, supportEntitlementCreateDto.gracePeriodInDays) &&
        Objects.equals(this.customRenewalPeriod, supportEntitlementCreateDto.customRenewalPeriod) &&
        Objects.equals(this.enableAutomaticRenew, supportEntitlementCreateDto.enableAutomaticRenew) &&
        Objects.equals(this.enableProRateBilling, supportEntitlementCreateDto.enableProRateBilling) &&
        Objects.equals(this.enableUsageThreshold, supportEntitlementCreateDto.enableUsageThreshold) &&
        Objects.equals(this.enableAutomaticDisable, supportEntitlementCreateDto.enableAutomaticDisable) &&
        Objects.equals(this.enableAutomaticPayments, supportEntitlementCreateDto.enableAutomaticPayments) &&
        Objects.equals(this.usageThreshold, supportEntitlementCreateDto.usageThreshold) &&
        Objects.equals(this.data, supportEntitlementCreateDto.data) &&
        Objects.equals(this.dataLabel, supportEntitlementCreateDto.dataLabel) &&
        Objects.equals(this.data1, supportEntitlementCreateDto.data1) &&
        Objects.equals(this.data1Label, supportEntitlementCreateDto.data1Label) &&
        Objects.equals(this.data2, supportEntitlementCreateDto.data2) &&
        Objects.equals(this.data2Label, supportEntitlementCreateDto.data2Label) &&
        Objects.equals(this.data3, supportEntitlementCreateDto.data3) &&
        Objects.equals(this.data3Label, supportEntitlementCreateDto.data3Label) &&
        Objects.equals(this.data4, supportEntitlementCreateDto.data4) &&
        Objects.equals(this.data4Label, supportEntitlementCreateDto.data4Label) &&
        Objects.equals(this.data5, supportEntitlementCreateDto.data5) &&
        Objects.equals(this.data5Label, supportEntitlementCreateDto.data5Label) &&
        Objects.equals(this.data6, supportEntitlementCreateDto.data6) &&
        Objects.equals(this.data6Label, supportEntitlementCreateDto.data6Label) &&
        Objects.equals(this.data7, supportEntitlementCreateDto.data7) &&
        Objects.equals(this.data7Label, supportEntitlementCreateDto.data7Label) &&
        Objects.equals(this.data8, supportEntitlementCreateDto.data8) &&
        Objects.equals(this.data8Label, supportEntitlementCreateDto.data8Label) &&
        Objects.equals(this.data9, supportEntitlementCreateDto.data9) &&
        Objects.equals(this.data9Label, supportEntitlementCreateDto.data9Label) &&
        Objects.equals(this.accountHolderID, supportEntitlementCreateDto.accountHolderID) &&
        Objects.equals(this.individualID, supportEntitlementCreateDto.individualID) &&
        Objects.equals(this.organizationID, supportEntitlementCreateDto.organizationID) &&
        Objects.equals(this.receiverBusinessID, supportEntitlementCreateDto.receiverBusinessID) &&
        Objects.equals(this.businessID, supportEntitlementCreateDto.businessID) &&
        Objects.equals(this.businessProfileRecordID, supportEntitlementCreateDto.businessProfileRecordID) &&
        Objects.equals(this.paymentTokenID, supportEntitlementCreateDto.paymentTokenID) &&
        Objects.equals(this.walletAccountID, supportEntitlementCreateDto.walletAccountID) &&
        Objects.equals(this.securityCertificateID, supportEntitlementCreateDto.securityCertificateID);
  }
  ...
  public String toString() {
    ...
    sb.append("class SupportEntitlementCreateDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SupportEntitlementCreateDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SupportEntitlementCreateDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SupportEntitlementCreateDto is not found in the empty JSON string", SupportEntitlementCreateDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SupportEntitlementCreateDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SupportEntitlementCreateDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SupportEntitlementCreateDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SupportEntitlementCreateDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SupportEntitlementCreateDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SupportEntitlementCreateDto.class));

       return (TypeAdapter<T>) new TypeAdapter<SupportEntitlementCreateDto>() {
           @Override
           public void write(JsonWriter out, SupportEntitlementCreateDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SupportEntitlementCreateDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SupportEntitlementCreateDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SupportEntitlementCreateDto
   * @throws IOException if the JSON string is invalid with respect to SupportEntitlementCreateDto
   */
  public static SupportEntitlementCreateDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SupportEntitlementCreateDto.class);
  }

  /**
   * Convert an instance of SupportEntitlementCreateDto to an JSON string
   *
   * @return JSON string
   */
