...
public class SocialCommentReactionDto {
  ...
  public static final String SERIALIZED_NAME_SOCIAL_COMMENT_ID = "socialCommentId";
  @SerializedName(SERIALIZED_NAME_SOCIAL_COMMENT_ID)
  private String socialCommentId;

  public SocialCommentReactionDto() {
  }

  public SocialCommentReactionDto id(String id) {
    this.id = id;
    return this;
  }
  ...
  public SocialCommentReactionDto timestamp(OffsetDateTime timestamp) {
  ...
  public SocialCommentReactionDto reaction(ReactionEnum reaction) {
  ...
  public SocialCommentReactionDto reactionValue(String reactionValue) {
  ...
  public SocialCommentReactionDto socialProfileId(String socialProfileId) {
  ...
  public SocialCommentReactionDto socialProfileName(String socialProfileName) {
  ...
  public SocialCommentReactionDto socialProfileAvatarUrl(String socialProfileAvatarUrl) {
  ...
  public SocialCommentReactionDto socialProfileType(SocialProfileTypeEnum socialProfileType) {
  ...
  public SocialCommentReactionDto socialCommentId(String socialCommentId) {
  ...
  public void setSocialCommentId(String socialCommentId) {
    this.socialCommentId = socialCommentId;
  }
  ...
  public boolean equals(Object o) {
    ...
    SocialCommentReactionDto socialCommentReactionDto = (SocialCommentReactionDto) o;
    return Objects.equals(this.id, socialCommentReactionDto.id) &&
        Objects.equals(this.timestamp, socialCommentReactionDto.timestamp) &&
        Objects.equals(this.reaction, socialCommentReactionDto.reaction) &&
        Objects.equals(this.reactionValue, socialCommentReactionDto.reactionValue) &&
        Objects.equals(this.socialProfileId, socialCommentReactionDto.socialProfileId) &&
        Objects.equals(this.socialProfileName, socialCommentReactionDto.socialProfileName) &&
        Objects.equals(this.socialProfileAvatarUrl, socialCommentReactionDto.socialProfileAvatarUrl) &&
        Objects.equals(this.socialProfileType, socialCommentReactionDto.socialProfileType) &&
        Objects.equals(this.socialCommentId, socialCommentReactionDto.socialCommentId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, reaction, reactionValue, socialProfileId, socialProfileName, socialProfileAvatarUrl, socialProfileType, socialCommentId);
  }
  ...
  public String toString() {
    ...
    sb.append("class SocialCommentReactionDto {\n");
    ...
    sb.append("    socialCommentId: ").append(toIndentedString(socialCommentId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("socialCommentId");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SocialCommentReactionDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SocialCommentReactionDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SocialCommentReactionDto is not found in the empty JSON string", SocialCommentReactionDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SocialCommentReactionDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SocialCommentReactionDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("socialCommentId") != null && !jsonObj.get("socialCommentId").isJsonNull()) && !jsonObj.get("socialCommentId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `socialCommentId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("socialCommentId").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SocialCommentReactionDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SocialCommentReactionDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SocialCommentReactionDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SocialCommentReactionDto.class));

       return (TypeAdapter<T>) new TypeAdapter<SocialCommentReactionDto>() {
           @Override
           public void write(JsonWriter out, SocialCommentReactionDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SocialCommentReactionDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SocialCommentReactionDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SocialCommentReactionDto
   * @throws IOException if the JSON string is invalid with respect to SocialCommentReactionDto
   */
  public static SocialCommentReactionDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SocialCommentReactionDto.class);
  }

  /**
   * Convert an instance of SocialCommentReactionDto to an JSON string
   *
   * @return JSON string
   */
