...
public class SocialProfilesApi {
    ...
    /**
     * Build call for getNotificationByIdAsync
     * @param socialProfileId  (required)
     ...
     */
    public okhttp3.Call getNotificationByIdAsyncCall(UUID socialProfileId, UUID notificationId, String apiVersion, String xApiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v2/SocialService/SocialProfiles/{socialProfileId}/Notifications/{notificationId}"
            .replace("{" + "socialProfileId" + "}", localVarApiClient.escapeString(socialProfileId.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getNotificationByIdAsyncValidateBeforeCall(UUID socialProfileId, UUID notificationId, String apiVersion, String xApiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'socialProfileId' is set
        if (socialProfileId == null) {
            throw new ApiException("Missing the required parameter 'socialProfileId' when calling getNotificationByIdAsync(Async)");
        }

        // verify the required parameter 'notificationId' is set
        if (notificationId == null) {
            throw new ApiException("Missing the required parameter 'notificationId' when calling getNotificationByIdAsync(Async)");
        }

        return getNotificationByIdAsyncCall(socialProfileId, notificationId, apiVersion, xApiVersion, _callback);
     ...
     */
    public NotificationDtoEnvelope getNotificationByIdAsync(UUID socialProfileId, UUID notificationId, String apiVersion, String xApiVersion) throws ApiException {
        ApiResponse<NotificationDtoEnvelope> localVarResp = getNotificationByIdAsyncWithHttpInfo(socialProfileId, notificationId, apiVersion, xApiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<NotificationDtoEnvelope> getNotificationByIdAsyncWithHttpInfo(UUID socialProfileId, UUID notificationId, String apiVersion, String xApiVersion) throws ApiException {
        okhttp3.Call localVarCall = getNotificationByIdAsyncValidateBeforeCall(socialProfileId, notificationId, apiVersion, xApiVersion, null);
        Type localVarReturnType = new TypeToken<NotificationDtoEnvelope>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getNotificationByIdAsyncAsync(UUID socialProfileId, UUID notificationId, String apiVersion, String xApiVersion, final ApiCallback<NotificationDtoEnvelope> _callback) throws ApiException {

        okhttp3.Call localVarCall = getNotificationByIdAsyncValidateBeforeCall(socialProfileId, notificationId, apiVersion, xApiVersion, _callback);
        Type localVarReturnType = new TypeToken<NotificationDtoEnvelope>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
