...
public class SocialPostCommentDto {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, message, parentCommentId, socialProfileId, socialFeedPostId, socialProfileName, socialProfileAvatarUrl, bodyHtml, bodyFormat, socialPostId);
  }
