...
public class SocialReactionDto {
  ...
  public SocialReactionDto id(String id) {
    this.id = id;
    return this;
  }
  ...
  public SocialReactionDto timestamp(OffsetDateTime timestamp) {
  ...
  public SocialReactionDto reaction(ReactionEnum reaction) {
  ...
  public SocialReactionDto reactionValue(String reactionValue) {
  ...
  public SocialReactionDto socialProfileId(String socialProfileId) {
  ...
  public SocialReactionDto socialProfileName(String socialProfileName) {
  ...
  public SocialReactionDto socialProfileAvatarUrl(String socialProfileAvatarUrl) {
  ...
  public boolean equals(Object o) {
    ...
    SocialReactionDto socialReactionDto = (SocialReactionDto) o;
    return Objects.equals(this.id, socialReactionDto.id) &&
        Objects.equals(this.timestamp, socialReactionDto.timestamp) &&
        Objects.equals(this.reaction, socialReactionDto.reaction) &&
  ...
  public String toString() {
    ...
    sb.append("class SocialReactionDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SocialReactionDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SocialReactionDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SocialReactionDto is not found in the empty JSON string", SocialReactionDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SocialReactionDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SocialReactionDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SocialReactionDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SocialReactionDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SocialReactionDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SocialReactionDto.class));

       return (TypeAdapter<T>) new TypeAdapter<SocialReactionDto>() {
           @Override
           public void write(JsonWriter out, SocialReactionDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SocialReactionDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SocialReactionDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SocialReactionDto
   * @throws IOException if the JSON string is invalid with respect to SocialReactionDto
   */
  public static SocialReactionDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SocialReactionDto.class);
  }

  /**
   * Convert an instance of SocialReactionDto to an JSON string
   *
   * @return JSON string
   */
