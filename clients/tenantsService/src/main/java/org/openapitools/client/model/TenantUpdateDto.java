...
public class TenantUpdateDto {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, legalName, email, phone, webUrl, about, slogan, handler, currencyId, duns, taxId, avatarUrl, twitterUsername, facebookUrl, twitterUrl, gitHubUrl, linkedInUrl, instagramUrl, youTubeUrl, whatsAppNumber, supportPhoneNumber, countryId, timezoneId, languageId, stateId, cityId);
  }
