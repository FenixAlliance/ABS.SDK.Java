...
public class ExtendedTenantDto {
  ...
  public ExtendedTenantDto id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ExtendedTenantDto timestamp(OffsetDateTime timestamp) {
  ...
  public ExtendedTenantDto kind(KindEnum kind) {
    this.kind = kind;
    return this;
  }
  ...
  public ExtendedTenantDto taxId(String taxId) {
    this.taxId = taxId;
    return this;
  }
  ...
  public ExtendedTenantDto about(String about) {
    this.about = about;
    return this;
  }
  ...
  public ExtendedTenantDto walletId(String walletId) {
  ...
  public ExtendedTenantDto socialFeedId(String socialFeedId) {
  ...
  public ExtendedTenantDto businessIndustryId(String businessIndustryId) {
  ...
  public ExtendedTenantDto businessSegmentId(String businessSegmentId) {
  ...
  public ExtendedTenantDto socialProfileId(String socialProfileId) {
  ...
  public ExtendedTenantDto languageId(String languageId) {
  ...
  public ExtendedTenantDto name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ExtendedTenantDto duns(String duns) {
    this.duns = duns;
    return this;
  }
  ...
  public ExtendedTenantDto slogan(String slogan) {
    this.slogan = slogan;
    return this;
  }
  ...
  public ExtendedTenantDto legalName(String legalName) {
  ...
  public ExtendedTenantDto coverUrl(String coverUrl) {
  ...
  public ExtendedTenantDto avatarUrl(String avatarUrl) {
  ...
  public ExtendedTenantDto cartId(String cartId) {
    this.cartId = cartId;
    return this;
  }
  ...
  public ExtendedTenantDto currencyId(String currencyId) {
  ...
  public ExtendedTenantDto timezoneId(String timezoneId) {
  ...
  public ExtendedTenantDto countryId(String countryId) {
  ...
  public ExtendedTenantDto stateId(String stateId) {
  ...
  public ExtendedTenantDto cityId(String cityId) {
    this.cityId = cityId;
    return this;
  }
  ...
  public ExtendedTenantDto email(String email) {
    this.email = email;
    return this;
  }
  ...
  public ExtendedTenantDto phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public ExtendedTenantDto webUrl(String webUrl) {
    this.webUrl = webUrl;
    return this;
  }
  ...
  public ExtendedTenantDto facebookUrl(String facebookUrl) {
  ...
  public ExtendedTenantDto twitterUrl(String twitterUrl) {
  ...
  public ExtendedTenantDto gitHubUrl(String gitHubUrl) {
  ...
  public ExtendedTenantDto linkedInUrl(String linkedInUrl) {
  ...
  public ExtendedTenantDto instagramUrl(String instagramUrl) {
  ...
  public ExtendedTenantDto youTubeUrl(String youTubeUrl) {
  ...
  public ExtendedTenantDto whatsAppNumber(String whatsAppNumber) {
  ...
  public ExtendedTenantDto supportPhoneNumber(String supportPhoneNumber) {
  ...
  public ExtendedTenantDto verified(Boolean verified) {
  ...
  public ExtendedTenantDto twitterUsername(String twitterUsername) {
  ...
  public ExtendedTenantDto cart(CartDto cart) {
    this.cart = cart;
    return this;
  }
  ...
  public ExtendedTenantDto wallet(WalletDto wallet) {
    this.wallet = wallet;
    return this;
  }
  ...
  public ExtendedTenantDto socialProfile(SocialProfileDto socialProfile) {
  ...
  public boolean equals(Object o) {
    ...
    ExtendedTenantDto extendedTenantDto = (ExtendedTenantDto) o;
    return Objects.equals(this.id, extendedTenantDto.id) &&
        Objects.equals(this.timestamp, extendedTenantDto.timestamp) &&
        Objects.equals(this.qualifiedName, extendedTenantDto.qualifiedName) &&
        Objects.equals(this.kind, extendedTenantDto.kind) &&
        Objects.equals(this.taxId, extendedTenantDto.taxId) &&
        Objects.equals(this.about, extendedTenantDto.about) &&
        Objects.equals(this.walletId, extendedTenantDto.walletId) &&
        Objects.equals(this.socialFeedId, extendedTenantDto.socialFeedId) &&
        Objects.equals(this.businessIndustryId, extendedTenantDto.businessIndustryId) &&
        Objects.equals(this.businessSegmentId, extendedTenantDto.businessSegmentId) &&
        Objects.equals(this.socialProfileId, extendedTenantDto.socialProfileId) &&
        Objects.equals(this.languageId, extendedTenantDto.languageId) &&
        Objects.equals(this.name, extendedTenantDto.name) &&
        Objects.equals(this.duns, extendedTenantDto.duns) &&
        Objects.equals(this.slogan, extendedTenantDto.slogan) &&
        Objects.equals(this.legalName, extendedTenantDto.legalName) &&
        Objects.equals(this.coverUrl, extendedTenantDto.coverUrl) &&
        Objects.equals(this.avatarUrl, extendedTenantDto.avatarUrl) &&
        Objects.equals(this.cartId, extendedTenantDto.cartId) &&
        Objects.equals(this.currencyId, extendedTenantDto.currencyId) &&
        Objects.equals(this.timezoneId, extendedTenantDto.timezoneId) &&
        Objects.equals(this.countryId, extendedTenantDto.countryId) &&
        Objects.equals(this.stateId, extendedTenantDto.stateId) &&
        Objects.equals(this.cityId, extendedTenantDto.cityId) &&
        Objects.equals(this.email, extendedTenantDto.email) &&
        Objects.equals(this.phone, extendedTenantDto.phone) &&
        Objects.equals(this.webUrl, extendedTenantDto.webUrl) &&
        Objects.equals(this.facebookUrl, extendedTenantDto.facebookUrl) &&
        Objects.equals(this.twitterUrl, extendedTenantDto.twitterUrl) &&
        Objects.equals(this.gitHubUrl, extendedTenantDto.gitHubUrl) &&
        Objects.equals(this.linkedInUrl, extendedTenantDto.linkedInUrl) &&
        Objects.equals(this.instagramUrl, extendedTenantDto.instagramUrl) &&
        Objects.equals(this.youTubeUrl, extendedTenantDto.youTubeUrl) &&
        Objects.equals(this.whatsAppNumber, extendedTenantDto.whatsAppNumber) &&
        Objects.equals(this.supportPhoneNumber, extendedTenantDto.supportPhoneNumber) &&
        Objects.equals(this.verified, extendedTenantDto.verified) &&
        Objects.equals(this.businessName, extendedTenantDto.businessName) &&
        Objects.equals(this.businessLegalName, extendedTenantDto.businessLegalName) &&
        Objects.equals(this.twitterUsername, extendedTenantDto.twitterUsername) &&
        Objects.equals(this.cart, extendedTenantDto.cart) &&
        Objects.equals(this.wallet, extendedTenantDto.wallet) &&
        Objects.equals(this.socialProfile, extendedTenantDto.socialProfile);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, qualifiedName, kind, taxId, about, walletId, socialFeedId, businessIndustryId, businessSegmentId, socialProfileId, languageId, name, duns, slogan, legalName, coverUrl, avatarUrl, cartId, currencyId, timezoneId, countryId, stateId, cityId, email, phone, webUrl, facebookUrl, twitterUrl, gitHubUrl, linkedInUrl, instagramUrl, youTubeUrl, whatsAppNumber, supportPhoneNumber, verified, businessName, businessLegalName, twitterUsername, cart, wallet, socialProfile);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExtendedTenantDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExtendedTenantDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExtendedTenantDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExtendedTenantDto is not found in the empty JSON string", ExtendedTenantDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExtendedTenantDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExtendedTenantDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExtendedTenantDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExtendedTenantDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExtendedTenantDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExtendedTenantDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ExtendedTenantDto>() {
           @Override
           public void write(JsonWriter out, ExtendedTenantDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExtendedTenantDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExtendedTenantDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExtendedTenantDto
   * @throws IOException if the JSON string is invalid with respect to ExtendedTenantDto
   */
  public static ExtendedTenantDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExtendedTenantDto.class);
  }

  /**
   * Convert an instance of ExtendedTenantDto to an JSON string
   *
   * @return JSON string
   */
