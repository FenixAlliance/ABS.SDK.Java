...
public class MarketingCampaignCreateDto {
  ...
  public MarketingCampaignCreateDto id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public MarketingCampaignCreateDto timestamp(OffsetDateTime timestamp) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, name, offer, active, proposedStart, proposedEnd, actualStart, actualEnd, code, allocatedBudget, activityCost, miscCost, expectedResponsePercent, marketingAreaId, currencyId);
  }
