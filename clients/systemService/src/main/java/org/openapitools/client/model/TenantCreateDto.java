...
public class TenantCreateDto {
  ...
  public TenantCreateDto kind(KindEnum kind) {
    this.kind = kind;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, tenantCreateDto.id) &&
        ...
        Objects.equals(this.kind, tenantCreateDto.kind) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, kind, name, legalName, email, phone, webUrl, handler, about, slogan, currencyId, duns, taxId, avatarUrl, countryId, stateId, cityId, languageId, timezoneId, businessTypeId, businessSegmentId, businessIndustryId, businessSizeId);
  }
