...
public class AdditionalAttribute {
  ...
  public AdditionalAttribute key(String key) {
    this.key = key;
    return this;
  }
  ...
  public AdditionalAttribute value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, additionalAttribute.key) &&
        Objects.equals(this.value, additionalAttribute.value);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdditionalAttribute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdditionalAttribute is not found in the empty JSON string", AdditionalAttribute.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdditionalAttribute.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdditionalAttribute` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
