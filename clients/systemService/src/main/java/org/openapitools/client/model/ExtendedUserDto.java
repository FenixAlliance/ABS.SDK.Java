...
public class ExtendedUserDto {
  ...
  public enum SiteThemeEnum {
    ...
    public static SiteThemeEnum fromValue(String value) {
  ...
  public ExtendedUserDto handler(String handler) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, extendedUserDto.id) &&
        ...
        Objects.equals(this.handler, extendedUserDto.handler) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("siteTheme") != null && !jsonObj.get("siteTheme").isJsonNull()) && !jsonObj.get("siteTheme").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `siteTheme` to be a primitive type in the JSON string but got `%s`", jsonObj.get("siteTheme").toString()));
      }
