...
public class TenantUpdateDto {
  ...
  public TenantUpdateDto kind(KindEnum kind) {
    this.kind = kind;
    return this;
  }
  ...
  public TenantUpdateDto webUrl(URI webUrl) {
    this.webUrl = webUrl;
    return this;
  }
  ...
  public TenantUpdateDto handler(String handler) {
  ...
  public TenantUpdateDto avatarUrl(URI avatarUrl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.kind, tenantUpdateDto.kind) &&
        Objects.equals(this.name, tenantUpdateDto.name) &&
        ...
        Objects.equals(this.handler, tenantUpdateDto.handler) &&
        ...
        Objects.equals(this.avatarUrl, tenantUpdateDto.avatarUrl) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(kind, name, legalName, email, phone, webUrl, about, slogan, handler, currencyId, duns, taxId, avatarUrl, twitterUsername, facebookUrl, twitterUrl, gitHubUrl, linkedInUrl, instagramUrl, youTubeUrl, whatsAppNumber, supportPhoneNumber, countryId, timezoneId, languageId, stateId, cityId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : TenantUpdateDto.openapiRequiredFields) {
