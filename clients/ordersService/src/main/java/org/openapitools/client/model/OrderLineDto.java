 ...
 * OrderLineDto
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-04-24T21:02:31.807658100-05:00[America/Bogota]", comments = "Generator version: 7.9.0")
public class OrderLineDto {
  ...
  public OrderLineDto id(String id) {
    this.id = id;
    return this;
  }
  ...
  public OrderLineDto timestamp(OffsetDateTime timestamp) {
  ...
  public OrderLineDto closed(Boolean closed) {
    this.closed = closed;
    return this;
  }
  ...
  public OrderLineDto itemId(String itemId) {
    this.itemId = itemId;
    return this;
  }
  ...
  public OrderLineDto itemTitle(String itemTitle) {
  ...
  public OrderLineDto itemShortDescription(String itemShortDescription) {
  ...
  public OrderLineDto itemPrimaryImageUrl(String itemPrimaryImageUrl) {
  ...
  public OrderLineDto shippingPolicyId(String shippingPolicyId) {
  ...
  public OrderLineDto tenantId(String tenantId) {
  ...
  public OrderLineDto enrollmentId(String enrollmentId) {
  ...
  public OrderLineDto currencyId(String currencyId) {
  ...
  public OrderLineDto description(String description) {
  ...
  public OrderLineDto quantity(Double quantity) {
  ...
  public OrderLineDto free(Boolean free) {
    this.free = free;
    return this;
  }
  ...
  public OrderLineDto freeReason(String freeReason) {
  ...
  public OrderLineDto freeReasonCode(String freeReasonCode) {
  ...
  public OrderLineDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public OrderLineDto dataLabel(String dataLabel) {
  ...
  public OrderLineDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public OrderLineDto data1Label(String data1Label) {
  ...
  public OrderLineDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public OrderLineDto data2Label(String data2Label) {
  ...
  public OrderLineDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public OrderLineDto data3Label(String data3Label) {
  ...
  public OrderLineDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public OrderLineDto data4Label(String data4Label) {
  ...
  public OrderLineDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public OrderLineDto data5Label(String data5Label) {
  ...
  public OrderLineDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public OrderLineDto data6Label(String data6Label) {
  ...
  public OrderLineDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public OrderLineDto data7Label(String data7Label) {
  ...
  public OrderLineDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public OrderLineDto data8Label(String data8Label) {
  ...
  public OrderLineDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public OrderLineDto data9Label(String data9Label) {
  ...
  public OrderLineDto itemPriceId(String itemPriceId) {
  ...
  public OrderLineDto priceListItemId(String priceListItemId) {
  ...
  public OrderLineDto unitId(String unitId) {
    this.unitId = unitId;
    return this;
  }
  ...
  public OrderLineDto unitGroupId(String unitGroupId) {
  ...
  public OrderLineDto taxCalculationMethod(TaxCalculationMethodEnum taxCalculationMethod) {
  ...
  public OrderLineDto costCalculationMethod(CostCalculationMethodEnum costCalculationMethod) {
  ...
  public OrderLineDto forexRates(ForexRates forexRates) {
  ...
  public OrderLineDto forexRate(Double forexRate) {
  ...
  public OrderLineDto totalDetailInUsd(Double totalDetailInUsd) {
  ...
  public OrderLineDto totalProfitInUsd(Double totalProfitInUsd) {
  ...
  public OrderLineDto totalDiscountsInUsd(Double totalDiscountsInUsd) {
  ...
  public OrderLineDto totalSurchargesInUsd(Double totalSurchargesInUsd) {
  ...
  public OrderLineDto totalTaxBaseInUsd(Double totalTaxBaseInUsd) {
  ...
  public OrderLineDto totalTaxesInUsd(Double totalTaxesInUsd) {
  ...
  public OrderLineDto totalWithheldTaxesInUsd(Double totalWithheldTaxesInUsd) {
  ...
  public OrderLineDto totalShippingCostInUsd(Double totalShippingCostInUsd) {
  ...
  public OrderLineDto totalShippingTaxesInUsd(Double totalShippingTaxesInUsd) {
  ...
  public OrderLineDto totalWarrantyCostInUsd(Double totalWarrantyCostInUsd) {
  ...
  public OrderLineDto totalReturnCostInUsd(Double totalReturnCostInUsd) {
  ...
  public OrderLineDto totalRefundCostInUsd(Double totalRefundCostInUsd) {
  ...
  public OrderLineDto totalInUsd(Double totalInUsd) {
  ...
  public OrderLineDto totalGlobalDiscountsInUsd(Double totalGlobalDiscountsInUsd) {
  ...
  public OrderLineDto totalGlobalSurchargesInUsd(Double totalGlobalSurchargesInUsd) {
  ...
  public OrderLineDto customGlobalSurchargesAmount(Double customGlobalSurchargesAmount) {
  ...
  public OrderLineDto customGlobalDiscountsAmount(Double customGlobalDiscountsAmount) {
  ...
  public OrderLineDto returnPolicyId(String returnPolicyId) {
  ...
  public OrderLineDto refundPolicyId(String refundPolicyId) {
  ...
  public OrderLineDto warrantyPolicyId(String warrantyPolicyId) {
  ...
  public OrderLineDto shipmentPolicyId(String shipmentPolicyId) {
  ...
  public OrderLineDto shippingLocationId(String shippingLocationId) {
  ...
  public OrderLineDto locationId(String locationId) {
  ...
  public OrderLineDto quoteItemRecordId(String quoteItemRecordId) {
  ...
  public OrderLineDto businessProfileRecordId(String businessProfileRecordId) {
  ...
  public OrderLineDto parentBillingItemRecordId(String parentBillingItemRecordId) {
  ...
  public OrderLineDto currency(CurrencyId currency) {
  ...
  public OrderLineDto totalDetail(Double totalDetail) {
  ...
  public OrderLineDto totalDetailCurrencyId(String totalDetailCurrencyId) {
  ...
  public OrderLineDto totalDetailAmount(Money totalDetailAmount) {
  ...
  public OrderLineDto totalProfit(Double totalProfit) {
  ...
  public OrderLineDto totalProfitCurrencyId(String totalProfitCurrencyId) {
  ...
  public OrderLineDto totalProfitAmount(Money totalProfitAmount) {
  ...
  public OrderLineDto totalDiscounts(Double totalDiscounts) {
  ...
  public OrderLineDto totalDiscountsCurrencyId(String totalDiscountsCurrencyId) {
  ...
  public OrderLineDto totalDiscountsAmount(Money totalDiscountsAmount) {
  ...
  public OrderLineDto totalSurcharges(Double totalSurcharges) {
  ...
  public OrderLineDto totalSurchargesCurrencyId(String totalSurchargesCurrencyId) {
  ...
  public OrderLineDto totalSurchargesAmount(Money totalSurchargesAmount) {
  ...
  public OrderLineDto totalTaxBase(Double totalTaxBase) {
  ...
  public OrderLineDto totalTaxBaseCurrencyId(String totalTaxBaseCurrencyId) {
  ...
  public OrderLineDto totalTaxBaseAmount(Money totalTaxBaseAmount) {
  ...
  public OrderLineDto totalTaxes(Double totalTaxes) {
  ...
  public OrderLineDto totalTaxesCurrencyId(String totalTaxesCurrencyId) {
  ...
  public OrderLineDto totalTaxesAmount(Money totalTaxesAmount) {
  ...
  public OrderLineDto totalShippingCost(Double totalShippingCost) {
  ...
  public OrderLineDto totalShippingCostCurrencyId(String totalShippingCostCurrencyId) {
  ...
  public OrderLineDto totalShippingCostAmount(Money totalShippingCostAmount) {
  ...
  public OrderLineDto totalShippingTax(Double totalShippingTax) {
  ...
  public OrderLineDto totalShippingTaxCurrencyId(String totalShippingTaxCurrencyId) {
  ...
  public OrderLineDto totalShippingTaxAmount(Money totalShippingTaxAmount) {
  ...
  public OrderLineDto totalWithheldTax(Double totalWithheldTax) {
  ...
  public OrderLineDto totalWithheldTaxCurrencyId(String totalWithheldTaxCurrencyId) {
  ...
  public OrderLineDto totalWithheldTaxAmount(Money totalWithheldTaxAmount) {
  ...
  public OrderLineDto totalGlobalDiscounts(Double totalGlobalDiscounts) {
  ...
  public OrderLineDto totalGlobalDiscountsCurrencyId(String totalGlobalDiscountsCurrencyId) {
  ...
  public OrderLineDto totalGlobalDiscountsAmount(Money totalGlobalDiscountsAmount) {
  ...
  public OrderLineDto totalGlobalSurcharges(Double totalGlobalSurcharges) {
  ...
  public OrderLineDto totalGlobalSurchargesCurrencyId(String totalGlobalSurchargesCurrencyId) {
  ...
  public OrderLineDto totalGlobalSurchargesAmount(Money totalGlobalSurchargesAmount) {
  ...
  public OrderLineDto totalCurrencyId(String totalCurrencyId) {
  ...
  public OrderLineDto totalAmount(Money totalAmount) {
  ...
  public OrderLineDto orderId(String orderId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, orderLineDto.id) &&
        Objects.equals(this.timestamp, orderLineDto.timestamp) &&
        Objects.equals(this.closed, orderLineDto.closed) &&
        Objects.equals(this.itemId, orderLineDto.itemId) &&
        Objects.equals(this.itemTitle, orderLineDto.itemTitle) &&
        Objects.equals(this.itemShortDescription, orderLineDto.itemShortDescription) &&
        Objects.equals(this.itemPrimaryImageUrl, orderLineDto.itemPrimaryImageUrl) &&
        Objects.equals(this.shippingPolicyId, orderLineDto.shippingPolicyId) &&
        Objects.equals(this.tenantId, orderLineDto.tenantId) &&
        Objects.equals(this.enrollmentId, orderLineDto.enrollmentId) &&
        Objects.equals(this.currencyId, orderLineDto.currencyId) &&
        Objects.equals(this.description, orderLineDto.description) &&
        Objects.equals(this.quantity, orderLineDto.quantity) &&
        Objects.equals(this.free, orderLineDto.free) &&
        Objects.equals(this.freeReason, orderLineDto.freeReason) &&
        Objects.equals(this.freeReasonCode, orderLineDto.freeReasonCode) &&
        Objects.equals(this.data, orderLineDto.data) &&
        Objects.equals(this.dataLabel, orderLineDto.dataLabel) &&
        Objects.equals(this.data1, orderLineDto.data1) &&
        Objects.equals(this.data1Label, orderLineDto.data1Label) &&
        Objects.equals(this.data2, orderLineDto.data2) &&
        Objects.equals(this.data2Label, orderLineDto.data2Label) &&
        Objects.equals(this.data3, orderLineDto.data3) &&
        Objects.equals(this.data3Label, orderLineDto.data3Label) &&
        Objects.equals(this.data4, orderLineDto.data4) &&
        Objects.equals(this.data4Label, orderLineDto.data4Label) &&
        Objects.equals(this.data5, orderLineDto.data5) &&
        Objects.equals(this.data5Label, orderLineDto.data5Label) &&
        Objects.equals(this.data6, orderLineDto.data6) &&
        Objects.equals(this.data6Label, orderLineDto.data6Label) &&
        Objects.equals(this.data7, orderLineDto.data7) &&
        Objects.equals(this.data7Label, orderLineDto.data7Label) &&
        Objects.equals(this.data8, orderLineDto.data8) &&
        Objects.equals(this.data8Label, orderLineDto.data8Label) &&
        Objects.equals(this.data9, orderLineDto.data9) &&
        Objects.equals(this.data9Label, orderLineDto.data9Label) &&
        Objects.equals(this.itemPriceId, orderLineDto.itemPriceId) &&
        Objects.equals(this.priceListItemId, orderLineDto.priceListItemId) &&
        Objects.equals(this.unitId, orderLineDto.unitId) &&
        Objects.equals(this.unitGroupId, orderLineDto.unitGroupId) &&
        Objects.equals(this.taxCalculationMethod, orderLineDto.taxCalculationMethod) &&
        Objects.equals(this.costCalculationMethod, orderLineDto.costCalculationMethod) &&
        Objects.equals(this.forexRates, orderLineDto.forexRates) &&
        Objects.equals(this.forexRate, orderLineDto.forexRate) &&
        Objects.equals(this.totalDetailInUsd, orderLineDto.totalDetailInUsd) &&
        Objects.equals(this.totalProfitInUsd, orderLineDto.totalProfitInUsd) &&
        Objects.equals(this.totalDiscountsInUsd, orderLineDto.totalDiscountsInUsd) &&
        Objects.equals(this.totalSurchargesInUsd, orderLineDto.totalSurchargesInUsd) &&
        Objects.equals(this.totalTaxBaseInUsd, orderLineDto.totalTaxBaseInUsd) &&
        Objects.equals(this.totalTaxesInUsd, orderLineDto.totalTaxesInUsd) &&
        Objects.equals(this.totalWithheldTaxesInUsd, orderLineDto.totalWithheldTaxesInUsd) &&
        Objects.equals(this.totalShippingCostInUsd, orderLineDto.totalShippingCostInUsd) &&
        Objects.equals(this.totalShippingTaxesInUsd, orderLineDto.totalShippingTaxesInUsd) &&
        Objects.equals(this.totalWarrantyCostInUsd, orderLineDto.totalWarrantyCostInUsd) &&
        Objects.equals(this.totalReturnCostInUsd, orderLineDto.totalReturnCostInUsd) &&
        Objects.equals(this.totalRefundCostInUsd, orderLineDto.totalRefundCostInUsd) &&
        Objects.equals(this.totalInUsd, orderLineDto.totalInUsd) &&
        Objects.equals(this.totalGlobalDiscountsInUsd, orderLineDto.totalGlobalDiscountsInUsd) &&
        Objects.equals(this.totalGlobalSurchargesInUsd, orderLineDto.totalGlobalSurchargesInUsd) &&
        Objects.equals(this.customGlobalSurchargesAmount, orderLineDto.customGlobalSurchargesAmount) &&
        Objects.equals(this.customGlobalDiscountsAmount, orderLineDto.customGlobalDiscountsAmount) &&
        Objects.equals(this.returnPolicyId, orderLineDto.returnPolicyId) &&
        Objects.equals(this.refundPolicyId, orderLineDto.refundPolicyId) &&
        Objects.equals(this.warrantyPolicyId, orderLineDto.warrantyPolicyId) &&
        Objects.equals(this.shipmentPolicyId, orderLineDto.shipmentPolicyId) &&
        Objects.equals(this.shippingLocationId, orderLineDto.shippingLocationId) &&
        Objects.equals(this.locationId, orderLineDto.locationId) &&
        Objects.equals(this.quoteItemRecordId, orderLineDto.quoteItemRecordId) &&
        Objects.equals(this.businessProfileRecordId, orderLineDto.businessProfileRecordId) &&
        Objects.equals(this.parentBillingItemRecordId, orderLineDto.parentBillingItemRecordId) &&
        Objects.equals(this.currency, orderLineDto.currency) &&
        Objects.equals(this.totalDetail, orderLineDto.totalDetail) &&
        Objects.equals(this.totalDetailCurrencyId, orderLineDto.totalDetailCurrencyId) &&
        Objects.equals(this.totalDetailAmount, orderLineDto.totalDetailAmount) &&
        Objects.equals(this.totalProfit, orderLineDto.totalProfit) &&
        Objects.equals(this.totalProfitCurrencyId, orderLineDto.totalProfitCurrencyId) &&
        Objects.equals(this.totalProfitAmount, orderLineDto.totalProfitAmount) &&
        Objects.equals(this.totalDiscounts, orderLineDto.totalDiscounts) &&
        Objects.equals(this.totalDiscountsCurrencyId, orderLineDto.totalDiscountsCurrencyId) &&
        Objects.equals(this.totalDiscountsAmount, orderLineDto.totalDiscountsAmount) &&
        Objects.equals(this.totalSurcharges, orderLineDto.totalSurcharges) &&
        Objects.equals(this.totalSurchargesCurrencyId, orderLineDto.totalSurchargesCurrencyId) &&
        Objects.equals(this.totalSurchargesAmount, orderLineDto.totalSurchargesAmount) &&
        Objects.equals(this.totalTaxBase, orderLineDto.totalTaxBase) &&
        Objects.equals(this.totalTaxBaseCurrencyId, orderLineDto.totalTaxBaseCurrencyId) &&
        Objects.equals(this.totalTaxBaseAmount, orderLineDto.totalTaxBaseAmount) &&
        Objects.equals(this.totalTaxes, orderLineDto.totalTaxes) &&
        Objects.equals(this.totalTaxesCurrencyId, orderLineDto.totalTaxesCurrencyId) &&
        Objects.equals(this.totalTaxesAmount, orderLineDto.totalTaxesAmount) &&
        Objects.equals(this.totalShippingCost, orderLineDto.totalShippingCost) &&
        Objects.equals(this.totalShippingCostCurrencyId, orderLineDto.totalShippingCostCurrencyId) &&
        Objects.equals(this.totalShippingCostAmount, orderLineDto.totalShippingCostAmount) &&
        Objects.equals(this.totalShippingTax, orderLineDto.totalShippingTax) &&
        Objects.equals(this.totalShippingTaxCurrencyId, orderLineDto.totalShippingTaxCurrencyId) &&
        Objects.equals(this.totalShippingTaxAmount, orderLineDto.totalShippingTaxAmount) &&
        Objects.equals(this.totalWithheldTax, orderLineDto.totalWithheldTax) &&
        Objects.equals(this.totalWithheldTaxCurrencyId, orderLineDto.totalWithheldTaxCurrencyId) &&
        Objects.equals(this.totalWithheldTaxAmount, orderLineDto.totalWithheldTaxAmount) &&
        Objects.equals(this.totalGlobalDiscounts, orderLineDto.totalGlobalDiscounts) &&
        Objects.equals(this.totalGlobalDiscountsCurrencyId, orderLineDto.totalGlobalDiscountsCurrencyId) &&
        Objects.equals(this.totalGlobalDiscountsAmount, orderLineDto.totalGlobalDiscountsAmount) &&
        Objects.equals(this.totalGlobalSurcharges, orderLineDto.totalGlobalSurcharges) &&
        Objects.equals(this.totalGlobalSurchargesCurrencyId, orderLineDto.totalGlobalSurchargesCurrencyId) &&
        Objects.equals(this.totalGlobalSurchargesAmount, orderLineDto.totalGlobalSurchargesAmount) &&
        Objects.equals(this.total, orderLineDto.total) &&
        Objects.equals(this.totalCurrencyId, orderLineDto.totalCurrencyId) &&
        Objects.equals(this.totalAmount, orderLineDto.totalAmount) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderLineDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderLineDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderLineDto is not found in the empty JSON string", OrderLineDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderLineDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderLineDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderLineDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderLineDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderLineDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderLineDto.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderLineDto>() {
           @Override
           public void write(JsonWriter out, OrderLineDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderLineDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderLineDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderLineDto
   * @throws IOException if the JSON string is invalid with respect to OrderLineDto
   */
  public static OrderLineDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderLineDto.class);
  }

  /**
   * Convert an instance of OrderLineDto to an JSON string
   *
   * @return JSON string
   */
