...
public class OrderLineUpdateDto {
  ...
  public OrderLineUpdateDto closed(Boolean closed) {
    this.closed = closed;
    return this;
  }
  ...
  public OrderLineUpdateDto title(String title) {
    this.title = title;
    return this;
  }
  ...
  public OrderLineUpdateDto userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public OrderLineUpdateDto priceListId(String priceListId) {
  ...
  public OrderLineUpdateDto description(String description) {
  ...
  public OrderLineUpdateDto individualId(String individualId) {
  ...
  public OrderLineUpdateDto paymentTermId(String paymentTermId) {
  ...
  public OrderLineUpdateDto organizationId(String organizationId) {
  ...
  public OrderLineUpdateDto receiverTenantId(String receiverTenantId) {
  ...
  public OrderLineUpdateDto firstName(String firstName) {
  ...
  public OrderLineUpdateDto lastName(String lastName) {
  ...
  public OrderLineUpdateDto companyName(String companyName) {
  ...
  public OrderLineUpdateDto billingEmail(String billingEmail) {
  ...
  public OrderLineUpdateDto addressLine1(String addressLine1) {
  ...
  public OrderLineUpdateDto addressLine2(String addressLine2) {
  ...
  public OrderLineUpdateDto postalCode(String postalCode) {
  ...
  public OrderLineUpdateDto countryId(String countryId) {
  ...
  public OrderLineUpdateDto stateId(String stateId) {
  ...
  public OrderLineUpdateDto cityId(String cityId) {
    this.cityId = cityId;
    return this;
  }
  ...
  public OrderLineUpdateDto billingLocationId(String billingLocationId) {
  ...
  public OrderLineUpdateDto shippingLocationId(String shippingLocationId) {
  ...
  public OrderLineUpdateDto shippingMethodId(String shippingMethodId) {
  ...
  public OrderLineUpdateDto forexRate(Double forexRate) {
  ...
  public OrderLineUpdateDto currencyId(String currencyId) {
  ...
  public OrderLineUpdateDto totalDetail(Double totalDetail) {
  ...
  public OrderLineUpdateDto totalDetailCurrencyId(String totalDetailCurrencyId) {
  ...
  public OrderLineUpdateDto totalProfit(Double totalProfit) {
  ...
  public OrderLineUpdateDto totalProfitCurrencyId(String totalProfitCurrencyId) {
  ...
  public OrderLineUpdateDto totalDiscounts(Double totalDiscounts) {
  ...
  public OrderLineUpdateDto totalDiscountsCurrencyId(String totalDiscountsCurrencyId) {
  ...
  public OrderLineUpdateDto totalSurcharges(Double totalSurcharges) {
  ...
  public OrderLineUpdateDto totalSurchargesCurrencyId(String totalSurchargesCurrencyId) {
  ...
  public OrderLineUpdateDto totalShippingTax(Double totalShippingTax) {
  ...
  public OrderLineUpdateDto totalShippingTaxCurrencyId(String totalShippingTaxCurrencyId) {
  ...
  public OrderLineUpdateDto totalShippingCost(Double totalShippingCost) {
  ...
  public OrderLineUpdateDto totalShippingCostCurrencyId(String totalShippingCostCurrencyId) {
  ...
  public OrderLineUpdateDto totalGlobalDiscounts(Double totalGlobalDiscounts) {
  ...
  public OrderLineUpdateDto totalGlobalDiscountsCurrencyId(String totalGlobalDiscountsCurrencyId) {
  ...
  public OrderLineUpdateDto totalGlobalSurcharges(Double totalGlobalSurcharges) {
  ...
  public OrderLineUpdateDto totalGlobalSurchargesCurrencyId(String totalGlobalSurchargesCurrencyId) {
  ...
  public OrderLineUpdateDto totalWithheldTax(Double totalWithheldTax) {
  ...
  public OrderLineUpdateDto totalWithheldTaxCurrencyId(String totalWithheldTaxCurrencyId) {
  ...
  public OrderLineUpdateDto totalTaxBase(Double totalTaxBase) {
  ...
  public OrderLineUpdateDto totalTaxBaseCurrencyId(String totalTaxBaseCurrencyId) {
  ...
  public OrderLineUpdateDto totalTaxes(Double totalTaxes) {
  ...
  public OrderLineUpdateDto totalTaxesCurrencyId(String totalTaxesCurrencyId) {
  ...
  public OrderLineUpdateDto total(Double total) {
    this.total = total;
    return this;
  }
  ...
  public OrderLineUpdateDto totalCurrencyId(String totalCurrencyId) {
  ...
  public OrderLineUpdateDto costCalculationMethod(CostCalculationMethodEnum costCalculationMethod) {
  ...
  public OrderLineUpdateDto taxCalculationMethod(TaxCalculationMethodEnum taxCalculationMethod) {
  ...
  public OrderLineUpdateDto itemId(String itemId) {
    this.itemId = itemId;
    return this;
  }
  ...
  public OrderLineUpdateDto itemTitle(String itemTitle) {
  ...
  public OrderLineUpdateDto itemShortDescription(String itemShortDescription) {
  ...
  public OrderLineUpdateDto itemPrimaryImageUrl(String itemPrimaryImageUrl) {
  ...
  public OrderLineUpdateDto shippingPolicyId(String shippingPolicyId) {
  ...
  public OrderLineUpdateDto quantity(Double quantity) {
  ...
  public OrderLineUpdateDto free(Boolean free) {
    this.free = free;
    return this;
  }
  ...
  public OrderLineUpdateDto freeReason(String freeReason) {
  ...
  public OrderLineUpdateDto freeReasonCode(String freeReasonCode) {
  ...
  public OrderLineUpdateDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public OrderLineUpdateDto dataLabel(String dataLabel) {
  ...
  public OrderLineUpdateDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public OrderLineUpdateDto data1Label(String data1Label) {
  ...
  public OrderLineUpdateDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public OrderLineUpdateDto data2Label(String data2Label) {
  ...
  public OrderLineUpdateDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public OrderLineUpdateDto data3Label(String data3Label) {
  ...
  public OrderLineUpdateDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public OrderLineUpdateDto data4Label(String data4Label) {
  ...
  public OrderLineUpdateDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public OrderLineUpdateDto data5Label(String data5Label) {
  ...
  public OrderLineUpdateDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public OrderLineUpdateDto data6Label(String data6Label) {
  ...
  public OrderLineUpdateDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public OrderLineUpdateDto data7Label(String data7Label) {
  ...
  public OrderLineUpdateDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public OrderLineUpdateDto data8Label(String data8Label) {
  ...
  public OrderLineUpdateDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public OrderLineUpdateDto data9Label(String data9Label) {
  ...
  public OrderLineUpdateDto itemPriceId(String itemPriceId) {
  ...
  public OrderLineUpdateDto priceListItemId(String priceListItemId) {
  ...
  public OrderLineUpdateDto unitId(String unitId) {
    this.unitId = unitId;
    return this;
  }
  ...
  public OrderLineUpdateDto unitGroupId(String unitGroupId) {
  ...
  public OrderLineUpdateDto totalProfitInUsd(Double totalProfitInUsd) {
  ...
  public OrderLineUpdateDto totalDetailAmountInUsd(Double totalDetailAmountInUsd) {
  ...
  public OrderLineUpdateDto totalTaxBaseInUsd(Double totalTaxBaseInUsd) {
  ...
  public OrderLineUpdateDto totalDiscountsInUsd(Double totalDiscountsInUsd) {
  ...
  public OrderLineUpdateDto totalTaxesInUsd(Double totalTaxesInUsd) {
  ...
  public OrderLineUpdateDto totalWithheldTaxesInUsd(Double totalWithheldTaxesInUsd) {
  ...
  public OrderLineUpdateDto totalShippingCostInUsd(Double totalShippingCostInUsd) {
  ...
  public OrderLineUpdateDto totalShippingTaxesInUsd(Double totalShippingTaxesInUsd) {
  ...
  public OrderLineUpdateDto totalWarrantyCostInUsd(Double totalWarrantyCostInUsd) {
  ...
  public OrderLineUpdateDto totalReturnCostInUsd(Double totalReturnCostInUsd) {
  ...
  public OrderLineUpdateDto totalRefundCostInUsd(Double totalRefundCostInUsd) {
  ...
  public OrderLineUpdateDto totalSurchargesInUsd(Double totalSurchargesInUsd) {
  ...
  public OrderLineUpdateDto totalAmountInUsd(Double totalAmountInUsd) {
  ...
  public OrderLineUpdateDto totalGlobalDiscountsInUsd(Double totalGlobalDiscountsInUsd) {
  ...
  public OrderLineUpdateDto totalGlobalSurchargesInUsd(Double totalGlobalSurchargesInUsd) {
  ...
  public OrderLineUpdateDto customGlobalSurchargesAmount(Double customGlobalSurchargesAmount) {
  ...
  public OrderLineUpdateDto customGlobalSurchargesAmountCurrencyId(String customGlobalSurchargesAmountCurrencyId) {
  ...
  public OrderLineUpdateDto customGlobalDiscountsAmount(Double customGlobalDiscountsAmount) {
  ...
  public OrderLineUpdateDto customGlobalDiscountsAmountCurrencyId(String customGlobalDiscountsAmountCurrencyId) {
  ...
  public OrderLineUpdateDto returnPolicyId(String returnPolicyId) {
  ...
  public OrderLineUpdateDto refundPolicyId(String refundPolicyId) {
  ...
  public OrderLineUpdateDto warrantyPolicyId(String warrantyPolicyId) {
  ...
  public OrderLineUpdateDto shipmentPolicyId(String shipmentPolicyId) {
  ...
  public OrderLineUpdateDto locationId(String locationId) {
  ...
  public OrderLineUpdateDto quoteItemRecordId(String quoteItemRecordId) {
  ...
  public OrderLineUpdateDto parentBillingItemRecordId(String parentBillingItemRecordId) {
  ...
  public boolean equals(Object o) {
    ...
    OrderLineUpdateDto orderLineUpdateDto = (OrderLineUpdateDto) o;
    return Objects.equals(this.closed, orderLineUpdateDto.closed) &&
        Objects.equals(this.title, orderLineUpdateDto.title) &&
        Objects.equals(this.userId, orderLineUpdateDto.userId) &&
        Objects.equals(this.priceListId, orderLineUpdateDto.priceListId) &&
        Objects.equals(this.description, orderLineUpdateDto.description) &&
        Objects.equals(this.individualId, orderLineUpdateDto.individualId) &&
        Objects.equals(this.paymentTermId, orderLineUpdateDto.paymentTermId) &&
        Objects.equals(this.organizationId, orderLineUpdateDto.organizationId) &&
        Objects.equals(this.receiverTenantId, orderLineUpdateDto.receiverTenantId) &&
        Objects.equals(this.firstName, orderLineUpdateDto.firstName) &&
        Objects.equals(this.lastName, orderLineUpdateDto.lastName) &&
        Objects.equals(this.companyName, orderLineUpdateDto.companyName) &&
        Objects.equals(this.billingEmail, orderLineUpdateDto.billingEmail) &&
        Objects.equals(this.addressLine1, orderLineUpdateDto.addressLine1) &&
        Objects.equals(this.addressLine2, orderLineUpdateDto.addressLine2) &&
        Objects.equals(this.postalCode, orderLineUpdateDto.postalCode) &&
        Objects.equals(this.countryId, orderLineUpdateDto.countryId) &&
        Objects.equals(this.stateId, orderLineUpdateDto.stateId) &&
        Objects.equals(this.cityId, orderLineUpdateDto.cityId) &&
        Objects.equals(this.billingLocationId, orderLineUpdateDto.billingLocationId) &&
        Objects.equals(this.shippingLocationId, orderLineUpdateDto.shippingLocationId) &&
        Objects.equals(this.shippingMethodId, orderLineUpdateDto.shippingMethodId) &&
        Objects.equals(this.forexRate, orderLineUpdateDto.forexRate) &&
        Objects.equals(this.currencyId, orderLineUpdateDto.currencyId) &&
        Objects.equals(this.totalDetail, orderLineUpdateDto.totalDetail) &&
        Objects.equals(this.totalDetailCurrencyId, orderLineUpdateDto.totalDetailCurrencyId) &&
        Objects.equals(this.totalProfit, orderLineUpdateDto.totalProfit) &&
        Objects.equals(this.totalProfitCurrencyId, orderLineUpdateDto.totalProfitCurrencyId) &&
        Objects.equals(this.totalDiscounts, orderLineUpdateDto.totalDiscounts) &&
        Objects.equals(this.totalDiscountsCurrencyId, orderLineUpdateDto.totalDiscountsCurrencyId) &&
        Objects.equals(this.totalSurcharges, orderLineUpdateDto.totalSurcharges) &&
        Objects.equals(this.totalSurchargesCurrencyId, orderLineUpdateDto.totalSurchargesCurrencyId) &&
        Objects.equals(this.totalShippingTax, orderLineUpdateDto.totalShippingTax) &&
        Objects.equals(this.totalShippingTaxCurrencyId, orderLineUpdateDto.totalShippingTaxCurrencyId) &&
        Objects.equals(this.totalShippingCost, orderLineUpdateDto.totalShippingCost) &&
        Objects.equals(this.totalShippingCostCurrencyId, orderLineUpdateDto.totalShippingCostCurrencyId) &&
        Objects.equals(this.totalGlobalDiscounts, orderLineUpdateDto.totalGlobalDiscounts) &&
        Objects.equals(this.totalGlobalDiscountsCurrencyId, orderLineUpdateDto.totalGlobalDiscountsCurrencyId) &&
        Objects.equals(this.totalGlobalSurcharges, orderLineUpdateDto.totalGlobalSurcharges) &&
        Objects.equals(this.totalGlobalSurchargesCurrencyId, orderLineUpdateDto.totalGlobalSurchargesCurrencyId) &&
        Objects.equals(this.totalWithheldTax, orderLineUpdateDto.totalWithheldTax) &&
        Objects.equals(this.totalWithheldTaxCurrencyId, orderLineUpdateDto.totalWithheldTaxCurrencyId) &&
        Objects.equals(this.totalTaxBase, orderLineUpdateDto.totalTaxBase) &&
        Objects.equals(this.totalTaxBaseCurrencyId, orderLineUpdateDto.totalTaxBaseCurrencyId) &&
        Objects.equals(this.totalTaxes, orderLineUpdateDto.totalTaxes) &&
        Objects.equals(this.totalTaxesCurrencyId, orderLineUpdateDto.totalTaxesCurrencyId) &&
        Objects.equals(this.total, orderLineUpdateDto.total) &&
        Objects.equals(this.totalCurrencyId, orderLineUpdateDto.totalCurrencyId) &&
        Objects.equals(this.costCalculationMethod, orderLineUpdateDto.costCalculationMethod) &&
        Objects.equals(this.taxCalculationMethod, orderLineUpdateDto.taxCalculationMethod) &&
        Objects.equals(this.itemId, orderLineUpdateDto.itemId) &&
        Objects.equals(this.itemTitle, orderLineUpdateDto.itemTitle) &&
        Objects.equals(this.itemShortDescription, orderLineUpdateDto.itemShortDescription) &&
        Objects.equals(this.itemPrimaryImageUrl, orderLineUpdateDto.itemPrimaryImageUrl) &&
        Objects.equals(this.shippingPolicyId, orderLineUpdateDto.shippingPolicyId) &&
        Objects.equals(this.quantity, orderLineUpdateDto.quantity) &&
        Objects.equals(this.free, orderLineUpdateDto.free) &&
        Objects.equals(this.freeReason, orderLineUpdateDto.freeReason) &&
        Objects.equals(this.freeReasonCode, orderLineUpdateDto.freeReasonCode) &&
        Objects.equals(this.data, orderLineUpdateDto.data) &&
        Objects.equals(this.dataLabel, orderLineUpdateDto.dataLabel) &&
        Objects.equals(this.data1, orderLineUpdateDto.data1) &&
        Objects.equals(this.data1Label, orderLineUpdateDto.data1Label) &&
        Objects.equals(this.data2, orderLineUpdateDto.data2) &&
        Objects.equals(this.data2Label, orderLineUpdateDto.data2Label) &&
        Objects.equals(this.data3, orderLineUpdateDto.data3) &&
        Objects.equals(this.data3Label, orderLineUpdateDto.data3Label) &&
        Objects.equals(this.data4, orderLineUpdateDto.data4) &&
        Objects.equals(this.data4Label, orderLineUpdateDto.data4Label) &&
        Objects.equals(this.data5, orderLineUpdateDto.data5) &&
        Objects.equals(this.data5Label, orderLineUpdateDto.data5Label) &&
        Objects.equals(this.data6, orderLineUpdateDto.data6) &&
        Objects.equals(this.data6Label, orderLineUpdateDto.data6Label) &&
        Objects.equals(this.data7, orderLineUpdateDto.data7) &&
        Objects.equals(this.data7Label, orderLineUpdateDto.data7Label) &&
        Objects.equals(this.data8, orderLineUpdateDto.data8) &&
        Objects.equals(this.data8Label, orderLineUpdateDto.data8Label) &&
        Objects.equals(this.data9, orderLineUpdateDto.data9) &&
        Objects.equals(this.data9Label, orderLineUpdateDto.data9Label) &&
        Objects.equals(this.itemPriceId, orderLineUpdateDto.itemPriceId) &&
        ...
        Objects.equals(this.totalTaxBaseInUsd, orderLineUpdateDto.totalTaxBaseInUsd) &&
        Objects.equals(this.totalDiscountsInUsd, orderLineUpdateDto.totalDiscountsInUsd) &&
        Objects.equals(this.totalTaxesInUsd, orderLineUpdateDto.totalTaxesInUsd) &&
        Objects.equals(this.totalWithheldTaxesInUsd, orderLineUpdateDto.totalWithheldTaxesInUsd) &&
        Objects.equals(this.totalShippingCostInUsd, orderLineUpdateDto.totalShippingCostInUsd) &&
        Objects.equals(this.totalShippingTaxesInUsd, orderLineUpdateDto.totalShippingTaxesInUsd) &&
        Objects.equals(this.totalWarrantyCostInUsd, orderLineUpdateDto.totalWarrantyCostInUsd) &&
        Objects.equals(this.totalReturnCostInUsd, orderLineUpdateDto.totalReturnCostInUsd) &&
        Objects.equals(this.totalRefundCostInUsd, orderLineUpdateDto.totalRefundCostInUsd) &&
        Objects.equals(this.totalSurchargesInUsd, orderLineUpdateDto.totalSurchargesInUsd) &&
        Objects.equals(this.totalAmountInUsd, orderLineUpdateDto.totalAmountInUsd) &&
        Objects.equals(this.totalGlobalDiscountsInUsd, orderLineUpdateDto.totalGlobalDiscountsInUsd) &&
        Objects.equals(this.totalGlobalSurchargesInUsd, orderLineUpdateDto.totalGlobalSurchargesInUsd) &&
        Objects.equals(this.customGlobalSurchargesAmount, orderLineUpdateDto.customGlobalSurchargesAmount) &&
        Objects.equals(this.customGlobalSurchargesAmountCurrencyId, orderLineUpdateDto.customGlobalSurchargesAmountCurrencyId) &&
        Objects.equals(this.customGlobalDiscountsAmount, orderLineUpdateDto.customGlobalDiscountsAmount) &&
        Objects.equals(this.customGlobalDiscountsAmountCurrencyId, orderLineUpdateDto.customGlobalDiscountsAmountCurrencyId) &&
        Objects.equals(this.returnPolicyId, orderLineUpdateDto.returnPolicyId) &&
        Objects.equals(this.refundPolicyId, orderLineUpdateDto.refundPolicyId) &&
        Objects.equals(this.warrantyPolicyId, orderLineUpdateDto.warrantyPolicyId) &&
        Objects.equals(this.shipmentPolicyId, orderLineUpdateDto.shipmentPolicyId) &&
        Objects.equals(this.locationId, orderLineUpdateDto.locationId) &&
        Objects.equals(this.quoteItemRecordId, orderLineUpdateDto.quoteItemRecordId) &&
        Objects.equals(this.parentBillingItemRecordId, orderLineUpdateDto.parentBillingItemRecordId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderLineUpdateDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderLineUpdateDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderLineUpdateDto is not found in the empty JSON string", OrderLineUpdateDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderLineUpdateDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderLineUpdateDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderLineUpdateDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderLineUpdateDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderLineUpdateDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderLineUpdateDto.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderLineUpdateDto>() {
           @Override
           public void write(JsonWriter out, OrderLineUpdateDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderLineUpdateDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderLineUpdateDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderLineUpdateDto
   * @throws IOException if the JSON string is invalid with respect to OrderLineUpdateDto
   */
  public static OrderLineUpdateDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderLineUpdateDto.class);
  }

  /**
   * Convert an instance of OrderLineUpdateDto to an JSON string
   *
   * @return JSON string
   */
