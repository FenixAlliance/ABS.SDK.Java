...
public class BudgetAccountEntryUpdateDto {
  ...
  public BudgetAccountEntryUpdateDto amount(Double amount) {
    this.amount = amount;
    return this;
  }
  ...
  public BudgetAccountEntryUpdateDto date(OffsetDateTime date) {
    this.date = date;
    return this;
  }
  ...
  public BudgetAccountEntryUpdateDto currencyId(String currencyId) {
  ...
  public BudgetAccountEntryUpdateDto debitAccountId(String debitAccountId) {
  ...
  public BudgetAccountEntryUpdateDto creditAccountId(String creditAccountId) {
  ...
  public BudgetAccountEntryUpdateDto journalEntryId(String journalEntryId) {
  ...
  public BudgetAccountEntryUpdateDto accountingEntryType(AccountingEntryTypeEnum accountingEntryType) {
  ...
  public BudgetAccountEntryUpdateDto budgetId(String budgetId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, budgetAccountEntryUpdateDto.description) &&
        ...
        Objects.equals(this.debitAccountId, budgetAccountEntryUpdateDto.debitAccountId) &&
        Objects.equals(this.creditAccountId, budgetAccountEntryUpdateDto.creditAccountId) &&
        Objects.equals(this.journalEntryId, budgetAccountEntryUpdateDto.journalEntryId) &&
        Objects.equals(this.accountingEntryType, budgetAccountEntryUpdateDto.accountingEntryType) &&
        Objects.equals(this.budgetId, budgetAccountEntryUpdateDto.budgetId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BudgetAccountEntryUpdateDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BudgetAccountEntryUpdateDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BudgetAccountEntryUpdateDto is not found in the empty JSON string", BudgetAccountEntryUpdateDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BudgetAccountEntryUpdateDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BudgetAccountEntryUpdateDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BudgetAccountEntryUpdateDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BudgetAccountEntryUpdateDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BudgetAccountEntryUpdateDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BudgetAccountEntryUpdateDto.class));

       return (TypeAdapter<T>) new TypeAdapter<BudgetAccountEntryUpdateDto>() {
           @Override
           public void write(JsonWriter out, BudgetAccountEntryUpdateDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BudgetAccountEntryUpdateDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BudgetAccountEntryUpdateDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BudgetAccountEntryUpdateDto
   * @throws IOException if the JSON string is invalid with respect to BudgetAccountEntryUpdateDto
   */
  public static BudgetAccountEntryUpdateDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BudgetAccountEntryUpdateDto.class);
  }

  /**
   * Convert an instance of BudgetAccountEntryUpdateDto to an JSON string
   *
   * @return JSON string
   */
