...
public class BillingProfileDto {
  ...
  public static final String SERIALIZED_NAME_VERIFICATION_DIGIT = "verificationDigit";
  @SerializedName(SERIALIZED_NAME_VERIFICATION_DIGIT)
  private String verificationDigit;

  public static final String SERIALIZED_NAME_ECONOMIC_ACTIVITY_CODE = "economicActivityCode";
  @SerializedName(SERIALIZED_NAME_ECONOMIC_ACTIVITY_CODE)
  private String economicActivityCode;

  public static final String SERIALIZED_NAME_ECONOMIC_ACTIVITY_SCHEME = "economicActivityScheme";
  @SerializedName(SERIALIZED_NAME_ECONOMIC_ACTIVITY_SCHEME)
  private String economicActivityScheme;

  public static final String SERIALIZED_NAME_IS_PRIMARY = "isPrimary";
  @SerializedName(SERIALIZED_NAME_IS_PRIMARY)
  private Boolean isPrimary;

  public static final String SERIALIZED_NAME_ESTABLISHMENT_CODE = "establishmentCode";
  @SerializedName(SERIALIZED_NAME_ESTABLISHMENT_CODE)
  ...
  public BillingProfileDto type(String type) {
    this.type = type;
    return this;
  }
  ...
  public BillingProfileDto contact(ContactDto contact) {
  ...
  public BillingProfileDto verificationDigit(String verificationDigit) {
  ...
  public BillingProfileDto economicActivityCode(String economicActivityCode) {
    this.economicActivityCode = economicActivityCode;
    return this;
  }

  /**
   * Get economicActivityCode
  ...
  public BillingProfileDto economicActivityScheme(String economicActivityScheme) {
    this.economicActivityScheme = economicActivityScheme;
    return this;
  }

  /**
   * Get economicActivityScheme
   * @return economicActivityScheme
   */
  @javax.annotation.Nullable
  public String getEconomicActivityScheme() {
    return economicActivityScheme;
  }

  public void setEconomicActivityScheme(String economicActivityScheme) {
    this.economicActivityScheme = economicActivityScheme;
  }


  public BillingProfileDto isPrimary(Boolean isPrimary) {
  ...
  public BillingProfileDto establishmentCode(String establishmentCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, billingProfileDto.id) &&
        ...
        Objects.equals(this.type, billingProfileDto.type) &&
        ...
        Objects.equals(this.contact, billingProfileDto.contact) &&
        ...
        Objects.equals(this.verificationDigit, billingProfileDto.verificationDigit) &&
        Objects.equals(this.economicActivityCode, billingProfileDto.economicActivityCode) &&
        Objects.equals(this.economicActivityScheme, billingProfileDto.economicActivityScheme) &&
        Objects.equals(this.isPrimary, billingProfileDto.isPrimary) &&
        Objects.equals(this.establishmentCode, billingProfileDto.establishmentCode) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, contactId, tenantId, type, enrollmentId, about, verified, submitted, avatarUrl, contact, qualifiedName, verificationTimestamp, data, dataLabel, data1, data1Label, data2, data2Label, data3, data3Label, data4, data4Label, data5, data5Label, data6, data6Label, data7, data7Label, data8, data8Label, data9, data9Label, taxId, email, phone, address, address1, address2, postalCode, businessName, commercialName, verificationDigit, economicActivityCode, economicActivityScheme, isPrimary, establishmentCode, ticker, duns, isPublicCompany, isFactaCustomer, taxPayerType, countryId, stateId, cityId, fiscalIdentificationTypeId, fiscalAuthorityId, fiscalRegimeId, contactName, fiscalAuthorityName, countryName);
  }
  ...
  public String toString() {
    ...
    sb.append("    economicActivityCode: ").append(toIndentedString(economicActivityCode)).append("\n");
    sb.append("    economicActivityScheme: ").append(toIndentedString(economicActivityScheme)).append("\n");
    sb.append("    isPrimary: ").append(toIndentedString(isPrimary)).append("\n");
    sb.append("    establishmentCode: ").append(toIndentedString(establishmentCode)).append("\n");
  ...
  static {
    ...
    openapiFields.add("verificationDigit");
    openapiFields.add("economicActivityCode");
    openapiFields.add("economicActivityScheme");
    openapiFields.add("isPrimary");
    openapiFields.add("establishmentCode");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("verificationDigit") != null && !jsonObj.get("verificationDigit").isJsonNull()) && !jsonObj.get("verificationDigit").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `verificationDigit` to be a primitive type in the JSON string but got `%s`", jsonObj.get("verificationDigit").toString()));
      }
      if ((jsonObj.get("economicActivityCode") != null && !jsonObj.get("economicActivityCode").isJsonNull()) && !jsonObj.get("economicActivityCode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `economicActivityCode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("economicActivityCode").toString()));
      }
      if ((jsonObj.get("economicActivityScheme") != null && !jsonObj.get("economicActivityScheme").isJsonNull()) && !jsonObj.get("economicActivityScheme").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `economicActivityScheme` to be a primitive type in the JSON string but got `%s`", jsonObj.get("economicActivityScheme").toString()));
      }
      if ((jsonObj.get("establishmentCode") != null && !jsonObj.get("establishmentCode").isJsonNull()) && !jsonObj.get("establishmentCode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `establishmentCode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("establishmentCode").toString()));
      }
