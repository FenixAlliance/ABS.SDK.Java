...
public class BankProfileDto {
  ...
  public BankProfileDto id(String id) {
    this.id = id;
    return this;
  }
  ...
  public BankProfileDto timestamp(OffsetDateTime timestamp) {
  ...
  public BankProfileDto contactId(String contactId) {
  ...
  public BankProfileDto tenantId(String tenantId) {
  ...
  public BankProfileDto type(String type) {
    this.type = type;
    return this;
  }
  ...
  public BankProfileDto enrollmentId(String enrollmentId) {
  ...
  public BankProfileDto about(String about) {
    this.about = about;
    return this;
  }
  ...
  public BankProfileDto verified(Boolean verified) {
  ...
  public BankProfileDto submitted(Boolean submitted) {
  ...
  public BankProfileDto avatarUrl(String avatarUrl) {
  ...
  public BankProfileDto contact(ContactDto contact) {
  ...
  public BankProfileDto verificationTimestamp(OffsetDateTime verificationTimestamp) {
  ...
  public BankProfileDto data(String data) {
    this.data = data;
    return this;
  }
  ...
  public BankProfileDto dataLabel(String dataLabel) {
  ...
  public BankProfileDto data1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public BankProfileDto data1Label(String data1Label) {
  ...
  public BankProfileDto data2(String data2) {
    this.data2 = data2;
    return this;
  }
  ...
  public BankProfileDto data2Label(String data2Label) {
  ...
  public BankProfileDto data3(String data3) {
    this.data3 = data3;
    return this;
  }
  ...
  public BankProfileDto data3Label(String data3Label) {
  ...
  public BankProfileDto data4(String data4) {
    this.data4 = data4;
    return this;
  }
  ...
  public BankProfileDto data4Label(String data4Label) {
  ...
  public BankProfileDto data5(String data5) {
    this.data5 = data5;
    return this;
  }
  ...
  public BankProfileDto data5Label(String data5Label) {
  ...
  public BankProfileDto data6(String data6) {
    this.data6 = data6;
    return this;
  }
  ...
  public BankProfileDto data6Label(String data6Label) {
  ...
  public BankProfileDto data7(String data7) {
    this.data7 = data7;
    return this;
  }
  ...
  public BankProfileDto data7Label(String data7Label) {
  ...
  public BankProfileDto data8(String data8) {
    this.data8 = data8;
    return this;
  }
  ...
  public BankProfileDto data8Label(String data8Label) {
  ...
  public BankProfileDto data9(String data9) {
    this.data9 = data9;
    return this;
  }
  ...
  public BankProfileDto data9Label(String data9Label) {
  ...
  public BankProfileDto bankId(String bankId) {
    this.bankId = bankId;
    return this;
  }
  ...
  public BankProfileDto bankName(String bankName) {
  ...
  public boolean equals(Object o) {
    ...
    BankProfileDto bankProfileDto = (BankProfileDto) o;
    return Objects.equals(this.id, bankProfileDto.id) &&
        Objects.equals(this.timestamp, bankProfileDto.timestamp) &&
        Objects.equals(this.contactId, bankProfileDto.contactId) &&
        Objects.equals(this.tenantId, bankProfileDto.tenantId) &&
        Objects.equals(this.type, bankProfileDto.type) &&
        Objects.equals(this.enrollmentId, bankProfileDto.enrollmentId) &&
        Objects.equals(this.about, bankProfileDto.about) &&
        Objects.equals(this.verified, bankProfileDto.verified) &&
        Objects.equals(this.submitted, bankProfileDto.submitted) &&
        Objects.equals(this.avatarUrl, bankProfileDto.avatarUrl) &&
        Objects.equals(this.contact, bankProfileDto.contact) &&
        Objects.equals(this.qualifiedName, bankProfileDto.qualifiedName) &&
        Objects.equals(this.verificationTimestamp, bankProfileDto.verificationTimestamp) &&
        Objects.equals(this.data, bankProfileDto.data) &&
        Objects.equals(this.dataLabel, bankProfileDto.dataLabel) &&
        Objects.equals(this.data1, bankProfileDto.data1) &&
        Objects.equals(this.data1Label, bankProfileDto.data1Label) &&
        Objects.equals(this.data2, bankProfileDto.data2) &&
        Objects.equals(this.data2Label, bankProfileDto.data2Label) &&
        Objects.equals(this.data3, bankProfileDto.data3) &&
        Objects.equals(this.data3Label, bankProfileDto.data3Label) &&
        Objects.equals(this.data4, bankProfileDto.data4) &&
        Objects.equals(this.data4Label, bankProfileDto.data4Label) &&
        Objects.equals(this.data5, bankProfileDto.data5) &&
        Objects.equals(this.data5Label, bankProfileDto.data5Label) &&
        Objects.equals(this.data6, bankProfileDto.data6) &&
        Objects.equals(this.data6Label, bankProfileDto.data6Label) &&
        Objects.equals(this.data7, bankProfileDto.data7) &&
        Objects.equals(this.data7Label, bankProfileDto.data7Label) &&
        Objects.equals(this.data8, bankProfileDto.data8) &&
        Objects.equals(this.data8Label, bankProfileDto.data8Label) &&
        Objects.equals(this.data9, bankProfileDto.data9) &&
        Objects.equals(this.data9Label, bankProfileDto.data9Label) &&
        Objects.equals(this.bankId, bankProfileDto.bankId) &&
        Objects.equals(this.bankName, bankProfileDto.bankName);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, contactId, tenantId, type, enrollmentId, about, verified, submitted, avatarUrl, contact, qualifiedName, verificationTimestamp, data, dataLabel, data1, data1Label, data2, data2Label, data3, data3Label, data4, data4Label, data5, data5Label, data6, data6Label, data7, data7Label, data8, data8Label, data9, data9Label, bankId, bankName);
  }
  ...
  public String toString() {
    ...
    sb.append("class BankProfileDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BankProfileDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BankProfileDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BankProfileDto is not found in the empty JSON string", BankProfileDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BankProfileDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BankProfileDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BankProfileDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BankProfileDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BankProfileDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BankProfileDto.class));

       return (TypeAdapter<T>) new TypeAdapter<BankProfileDto>() {
           @Override
           public void write(JsonWriter out, BankProfileDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BankProfileDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BankProfileDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BankProfileDto
   * @throws IOException if the JSON string is invalid with respect to BankProfileDto
   */
  public static BankProfileDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BankProfileDto.class);
  }

  /**
   * Convert an instance of BankProfileDto to an JSON string
   *
   * @return JSON string
   */
