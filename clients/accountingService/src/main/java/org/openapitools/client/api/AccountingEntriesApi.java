...
public class AccountingEntriesApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public AccountingEntriesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public AccountingEntriesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getCreditsSumAsync
    ...
    public okhttp3.Call getCreditsSumAsyncCall(UUID tenantId, String apiVersion, String xApiVersion, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v2/AccountingService/AccountingEntries/Credits/Sum";
    ...
    /**
     * Sum tenant accounting-entry credits (asynchronously)
     * Returns SUM(AccountingEntry.Credit) for the tenant, filtered by the supplied OData date range.
     * @param tenantId  (required)
     * @param apiVersion  (optional)
     * @param xApiVersion  (optional)
    ...
    /**
     * Build call for getDebitsSumAsync
     * @param tenantId  (required)
     * @param apiVersion  (optional)
     * @param xApiVersion  (optional)
     * @param _callback Callback for upload/download progress
    ...
    public okhttp3.Call getDebitsSumAsyncCall(UUID tenantId, String apiVersion, String xApiVersion, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v2/AccountingService/AccountingEntries/Debits/Sum";
    ...
    /**
     * Sum tenant accounting-entry debits (asynchronously)
     * Returns SUM(AccountingEntry.Debit) for the tenant, filtered by the supplied OData date range.
     * @param tenantId  (required)
     * @param apiVersion  (optional)
     * @param xApiVersion  (optional)
